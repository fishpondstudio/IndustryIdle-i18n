export const NL = {
    ...
    Tips2:
        "Transport van gebouwen houd op als er al genoeg is voor productie tenzij je de opslagmodus aanzet",
    ...
    Tips7: "Als je goederen aankoopt, zal je de prijs opdrijven. Als je goederen verkoopt zal je de prijs drukken",
    ...
    LeaderboardOptOutDesc:
        "Dit zal niet langer scorebord scores versturen. LET OP: als je het scorebord later wil activeren, moet je data een reset ondergaan",
    ...
    FPS30Desc:
        "De energie besparingsmode activeren zal het spel laten draaien op 30 FPS in plaats van 60FPS. Dit laat je batterij langer meegaan",
    ...
    ExtraAdjacentBonusDesc: "Extra bonus capaciteit voor elke aanliggend gebouw van hetzelfde typoe",
    OfflineEarningMultiplier: "Offline Verdienste Vermedigvuldiger",
    OfflineEarningMultiplierDesc: "Een vermedigvuldiger die slaat op je offline verdiensten",
    ...
    CashInDesc:
        "Je zal dit bedrag in je Zwitserse bankrekening ontvangen als je in een nieuwe stad start. Het is gebaseerd op je bedrijfs markt capaciteit en het moet %{amount} bereiken voordat je Zwitsers geld kan verdienen",
    ...
    StPetersburgBonus:
        "<li>Uranium mijnen hebben 2x uitvoer</li><li>Uranium verrijkingscentrales hebben 2x capaciteit</li><li>Uranium transport kost 50% minder brandstof</li><li>Gratis wapen transport</li><li>Ballistische raket fabrieken gebruiken verrijkt uranium in de plaats van titanium en uranium</li>",
    Hamburg: "Hamburg",
    HamburgBonus:
    ...
    Detroit: "Detroit",
    DetroitBonus:
        "<li>Motor fabrieken zijn ontgrendelt</li><li>Motor fabrieken hebben 2x productiviteit</li><li>Auto fabrieken hebben 2x capaciteit</li><li>Auto fabrieken hebben geen batterijen nodig</li><li>Treinen fabrieken hebben 2x capaciteit</li>",
    Boston: "Boston",
    BostonBonus:
        "<li>Start met niveau 5 Onderzoeks Laboratorium</li><li>Polytechnisch is ontgrendelt</li><li>universiteit heeft 2x capaciteit</li><li>Scholen hebben 2x capaciteit</li><li>Universiteiten hebben 2x productiviteit</li>",
    ...
    ClaimTradeFail: "Handel claimen is gefaald, probeer later opnieuw",
    ClaimTradeSuccess: "Jou handel is succesvol opgeclaimt: $%{cash} is toegevoegd aan je account",
    ...
    RefundTradeFail: "Refund gefaald, probeer later",
    CancelActiveTradeFirst: "Je hebt actieve handelsoffers uitstaan, annuleer deze of claim ze eerst",
    FailedToCheckActiveTrade: "Actieve speler handsoffers check gefaald, probeer later",
    PlayerTradePriceNotValid: "Hnadelsprijs moet tussen %{min} en %{max} liggen (2 x Laatste Mark Waarde)",
    PlayerTradeQuotaExceed: "Deze Handelsoffer valt boven je maximale quota",
    PlayerTradeAmountNotValid: "Handels offer moet groter zijn dan 0",
    PlayerTradeValidRange: "Bereik: %{min} ~ %{max}",
    PlayerTradeFilterPrice: "onder minimale marktwaarde",
