export const NL = {
  ...
  "BuildingPermitDesc": "Je hebt een vergunning voor %{amount} gebouwen, je hebt er al %{amountBuilt} gebouwd en hebt er  %{amountLeft} over",
  ...
  "AlwaysTransportInputTradeCenterDesc": "Altijd transporteren naar het handelscentrum, ook al is de automatische verkoop niet geactiveerd voor dit product",
  ...
  "ProductionCycleLengthDesc": "De duur van één productie cyclus, gemeten in seconden. De cyclus verlengen zal de invoer/uitvoer per cyclus verhogen, dus als bijgevolg de prioriteit verlagen bij het ophalen van invoergoederen",
  "MaxInputDistance": "Maximale Invoer Afstand",
  "MaxInputDistanceDesc": "De maximale afstand van waar dit gebouw invoer van goederen kan krijgen, gemeten in aantal tegels",
  ...
  "MaxAutoSellConcurrencyReached": "Je hebt het maximum automatische verkopen gelijktijdig bereikt, deactiveer een andere automatische verkoop om deze te activeren",
  ...
  "StockRatingDesc": "Aandeel beoordeling van Wall Street analysten, die je markt kapitalisatie beïnvloeden en wordt geüpdate samen met de markt",
  ...
  "TurnOffProductionDesc": "Schakel het gebouw uit. Het gebouw zal niet langer goederen ontvangen en energie verbruiken",
  ...
  "FuelCostSaveDesc": "Opslagplaatsen besparen een bepaald percentage van de brandstof voor binnekomende goederen ten opzichte van andere gebouwen. Hoe hoger het niveau, hoe meer je bespaart",
  ...
  "FillOrder": "Vervul",
  "RejectOrder": "Afslaan",
  "WholesaleCenterLocked": "Je hebt minstens %{required} verschillende goederen nodig om de groothandel te ontgrendelen. Je hebt slechts %{current} goederen",
  ...
  "StickyInputDesc": "Gebouwen zullen transport van voorgaande bron prefereren, in plaats van te zoeken naar de beste bron elke cyclus (GRATIS BELEID)",
  ...
  "CostSaverBuildingDesc": "Kosten bespaarder beleid is actief, productie zal automatisch aan/uit gezet worden naargelang z'n winstgevendheid",
  ...
  "AdjacentBonusOnlyOutputDesc": "Aangrenzingsbonus vereist geen invoer meer, maar verbruikt meer energie en is maar 50% effectief",
  ...
  "ShoppingSpreeDesc": "Als product zijn capaciteit tekort komt, pas het tekort dan automatisch bij door aankopen in het handelscentrum (Als de goederen een auto verkoop op hebben staan, zal het dit negeren)",
  "ShoppingSpreeTradeCenterDesc": "💡 Volop Shoppen Beleid is geactiveerd, handelscentrum zal automatisch het tekort aan goederen kopen",
  ...
  "OfflineModeDesc": "Kan niet met de server connecteren: Offline verdiensten worden niet gegenereerd. Gelieve je internet connectie na te kijken",
  "OptOut": "Deactiveer",
  ...
  "FPS30Desc": "De energie besparingsmode activeren zal het spel laten draaien op 30 FPS in plaats van 60 FPS. Dit laat je batterij langer meegaan",
  ...
  "FuelRunOutWarning": "💡 Je brandstof consumptie is groter dan je productie. Wanneer brandstof op is, valt je transport stil",
  "InAmount": "In: %{number}",
  ...
  "HideRewardAdDesc": "Alle advertenties in het spel zijn optionele belonings advertenties. Dit verbergt alle beloningsopties in het spel.",
  ...
  "ProductionMultiplierDesc": "Een boost aan al je gebouwen productie capaciteiten (inclusief mijnen, fabrieken, energie centrales, wetenschap en cultuur gebouwen)",
  ...
  "AutoSellCapacityMultiplierDesc": "Een vermedigvuldiger die toegepast wordt op je automatische verkoopscapaciteit, ongacht de huidige capaciteit",
  ...
  "PrestigeAlertContent": "Je bedrijf zal geliquideerd worden. Je ontvangt %{amount} Zwitsers geld en start een nieuw bedrijf in %{city}",
  "PrestigeCurrencyDesc": "Dit is het geld in je geheime Zwitserse bankrekening, Je kan dit meedragen als je in een nieuwe stad start",
  "Prestige": "Uitbetalen",
  "Cancel": "Annuleren",
  ...
  "ExpansionPackIncompatible": "Je probeert een save file te importeren met uitbreidingspakketten, maar je spel heeft niet de nodige uitbreindingspakketten",
  "CashIn": "Uitbetalen",
  "CurrentCity": "Huidige Stad",
  "CashInDesc": "Je zal dit bedrag in je Zwitserse bankrekening ontvangen als je in een nieuwe stad start. Het is gebaseerd op markt capaciteit van je bedrijf en het moet %{amount} bereiken voordat je Zwitsers geld kan verdienen",
  ...
  "Hamburg": "Hamburg",
  "HamburgBonus": "<li>Zeppelin fabrieken zijn vrijgespeeld</li><li>Halfgeleiderfabrieken hebben 2x productiviteit</li><li>Scheepswerven hebben 2x capaciteit</li><li>Autofabrieken hebben 2x capaciteit</li><li>Li-ion batterijfabrieken zijn vrijgespeeld</li>",
  "Toulouse": "Toulouse",
  "Rome": "Rome",
  "RomeBonus": "<li>Colosseums zijn vrijgespeeld</li><li>Colosseums hebben 2x productiviteit</li><li>Start met een niveau 5 beleidscentrum</li><li>Opera huizen hebben 2x capaciteit</li><li>Opnamestudios produceren ook cultuur</li>",
  "Detroit": "Detroit",
  "Boston": "Boston",
  "BostonBonus": "<li>Start met niveau 5 Onderzoeks Laboratorium</li><li>Technische school is vrijgespeeld</li><li>Universiteient hebben 2x capaciteit</li><li>Scholen hebben 2x capaciteit</li><li>Universiteiten hebben 2x productiviteit</li>",
  ...
  "PlayerTradeUnavailable": "Je hebt minstens één product in productie en in opslag nodig voor je kan handelen met spelers",
  ...
  "SiliconMine2xOutputDesc": "Silicon mines produce 2x silicon but use 50% more power and silicon transport costs 50% more fuel",
  ...
  "ImportSaveVersionTooNew": "You are importing a save from %{saveVersion} but your game is %{gameVersion}. Please upgrade your game first",
  ...
  "PlayerTradeBid": "Bid",
  "PlayerTradeAsk": "Ask",
  "CancelTradeConfirmDialogDescV2": "Cancelling this trade will refund %{percent} of the resource/cash. Resources will be refunded to Trade Center warehouse",
  ...
  "SteamLoginDialogDesc": "Your local save has Expansion Pack enabled, you need to sign in through Steam to continue. Or you can ERASE YOUR LOCAL SAVE and start over",
  ...
  "FreeTransportToTradeCenterDesc": "Transportation to the trade center does not cost fuel but transportation from the trade center cost 50% more fuel",
  ...
  "SaveAndExitDesc": "Save and exit game. This is only available on Steam version and does the same as the close button on the window bar",
  "AutoSellResourceWarningShortLabel": "💡Auto Sell",
  "AutoSellResourceWarningDesc": "You are auto selling this resource, the amount stored in Trade Center cannot be used here",
  "PlayerTradeLocalPrice": "Local Price: %{price}",
  "ChatForceScroll": "Force Scroll",
  "ChatForceScrollDesc": "If force scroll is on, the chat will scroll whenever there's a new message. Otherwise it will only scroll when you are already at the bottom",
  ...
  "PolicyBlueprintDesc": "Construction of a building will not automatically start - it has to be started manually (FREE POLICY)",
  ...
  "SellRefundPercentageDesc": "If you sell or downgrade a building, this is the percentage of cash and resources you are refunded",
  "SellBuildingDescV2": "Selling a building will refund you %{percent} of your investment and %{percent} of the resources will be transported to Trade Center",
  ...
  "AchievementSoftwareGiantDesc": "Build a level 10 Software Company, level 10 Operating System Inc, level 10 Database Company and level 10 Web Browser on the same map",
  "AchievementSpaceRace": "Space Race",
  "AchievementSpaceRaceDesc": "Build a level 10 Rocket Factory, level 10 Satellite Factory, level 10 Spaceship Factory and level 10 Space Station Factory on the same map",
  "AchievementToTheMoon": "To The Moon",
  "AchievementToTheMoonDesc": "Build a level 40 Bitcoin Farm and level 40 Dogecoin Farm. Own 1B Bitcoin and 1B Dogecoin",
  ...
  "LogoutDescV2": "You have logged in on another device, this device is logged out. You can log back in but the other device will be logged out",
  ...
  "ServerDisconnected": "You are disconnected from the server, please check your internet connection and restart the game",
  ...
  "BlockUserChatDesc": "The block will be in effect during this game session and you cannot undo this unless you restart the game",
  ...
  "SteamAutoCloudBackupDescV2": "Your latest progress is saved to Steam Cloud and synced across devices. The game also backs up your save every 10 minutes automatically to Steam Cloud. You can force a backup at any time",
  ...
  "ResourceBoosterSquareDesc": "Resource boosters provide 25% more boost but their science input and power usage also increase by 25%",
  ...
  "StPetersburgBonusV2": "<li>Uranium mines have 2x output</li><li>Uranium enrichment plants have 2x capacity</li><li>Uranium transportation costs 50% less fuel</li><li>Free gun transportation</li><li>Project Vostok has 2x capacity</li>",
  "ToulouseBonusV2": "<li>Titanium mines have 2x output</li><li>Uranium enrichment plants have 2x productivity</li><li>Jet engine factories have 2x capacity</li><li>Aircraft factories have 2x productivity</li><li>Rocket factories have 2x capacity</li>",
  ...
  "GPUIsBusyDesc": "Your operating system has paused the game's graphics because the GPU is busy with other tasks. You can reload the game to resume. If it doesn't work, try restarting the game",
  ...
  "Vancouver": "Vancouver",
  "VancouverBonus": "<li>Every 4 different types of buildings give 1 free building permit</li><li>Unique policy: Production Diversification</li><li>Unique building: Maple Syrup Factory</li><li>Free maple syrup transport</li><li>Unique fuel type: Maple Syrup</li><li>2x player trade quota when trading Uranium and Enriched Uranium</li><li>Unique free policy: Syrup Plastic</li><li>Toy factories have 2x productivity</li><li>Game studios have 2x capacity</li>",
  "MapExtraPermitDesc": "You get %{number} free building permits from the map's unique bonus",
  "OsloBonusV3": "<li>Oil refineries are unlocked</li><li>Oil refineries have 2x capacity</li><li>Electric oil transport policy is free</li><li>Gas processing plants have 2x capacity</li><li>Free level 4 wind turbine x1</li><li>Free level 8 oil well x1</li><li>Free level 2 oil refinery x1</li><li>Free level 2 natural gas pump x1</li>",
  ...
  "ResourceBoosterSupplyChainDesc": "Resource boosters use 2x power and science, but for each working mine a resource booster is boosting, it also provides capacity boost to adjacent factories that consume the mine's output (the factory should only consume deposits)",
  ...
  "ResourceExplorer2DescV2": "Resource explorers produce 2x output but use 2x power. Resource explorers can be boosted by resource boosters if Supply Chain Booster policy is active and the booster has an adjacent mine of the same output",
  "NoTileModifier": "Earth Is Flat",
  "NoTileModifierDesc": "All tile modifiers are zero. This policy will deactivate Nature's Power and Tile Modifier Plus policies",
  "DoubleTileModifierDescV2": "All tile modifiers' effect x2 - both positive and negative. This policy will deactivate Earth Is Flat policy",
  "TileModifierOutputOnlyDescV2": "Tile modifiers only affect output instead of both input and output but are only 50% effective. This policy will deactivate Earth Is Flat policy",
  ...
  "TotalPledgedValueDesc": "Your first pledge counts towards the crowdfunding goal. Subsequent pledges increase total pledged value but do not count towards the goal",
  ...
  "CrowdfundingAlreadyPledgedDesc": "You can pledge more resources, which will increase your total pledged value (and potential return), but won't count towards crowdfunding goal",
  "WholesaleCenterProducingOnly": "Groothandelspartners",
  "WholesaleCenterProducingOnlyDesc": "Groothandelsbestellingen bevatten enkel goederen die momenteel geproduceert worden ( Je moet ook het aantal vereiste goederen produceren om de groothandel vrij te spelen)",
  ...
  "ResourceMovementDesc": "You can choose when to show the resource movement (dots). Hiding it can improvement performance",
  "CrowdfundingCashInWarning": "You have pending crowdfunding pledges - starting in a new city will forfeit them",
  "ResourceBoosterBannerDescV2": "💡 You currently have %{number} resource boosters - the science input of each is scaled to the number of resource boosters you currently have",
  ...
  "IndustryZoneNotWorkingDesc": "All of its adjacent buildings should form a supply chain and are not part of other industry zones",
  ...
  "RotterdamBonusV2": "<li>Steel Mills have 2x capacity</li><li>Stainless Steel Plants have 2x capacity</li><li>Free iron transportation</li><li>Steel transportation costs 50% less fuel</li><li>Start with 2x auto sell capacity</li><li>Earth Is Flat policy is free</li>",
