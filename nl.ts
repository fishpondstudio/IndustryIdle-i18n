export const NL = {
  ...
  NoLiquidityTurnOffAutoSell:
    "Er is niet genoeg liquiditeit in de markt voor %{res}, auto verkopen is stil gezet",
  ...
  ScienceFromPowerDesc:
    "Energiecentrale produceert een klein aantal wetenschap bij het aanmaken van energie",
  Culture: "Cultuur",
  School: "School",
  ...
  BuildingLocked:
    "Bouwen is nog niet beschikbaar, Je moet dit eerst vrijspelen in het Onderzoekslaboratorium",
  ...
  SolarPanelDesc:
    "💡 Zonnepanelen werken maar 5 van elke 10 seconden - alle cyclussen zijn synchroon",
  WindTurbineDesc:
    "💡 Wind turbines werken maar 8 van elke 10 seconden - cyclussen zijn niet synchroon",
  Movie: "Film",
  ...
  AdjacentBonusDesc:
    "Je krijgt %{bonus}% extra capaciteit voor elk aangrenzend werkend gebouw van hetzelfde type",
  ...
  AutoSellCapacityDesc:
    "Max aantal goederen die de automatische verkoop kan verwerken per seconde, per goed",
  ...
  MarketCapDesc:
    "Totale markt kapitalisatie (i.e. markt waarde) van je bedrijf",
  BuildingValuation: "Gebouw waarde",
  BuildingValuationDesc:
    "Totale waarde van je gebouwen, inclusief gebouwvergunningen en uitbreidingen",
  ...
  OfflineEarningTimeDesc:
    "Gedurende deze tijd kan je inkomsten verdienen terwijl je offline bent",
  ...
  Icons: "Icoontjes",
  MisplacedBuilding:
    "⛔ Dit %{building} gebouw is niet op een correcte goederen opslag gebouwd",
  ...
  HighlightMaxInputDistanceNotDefault:
    "...die een max invoer afstand hebben < ∞",
  ...
  InputStrategyCloseDesc:
    "Prefereer de dichtste opslagplaats die genoeg goederen heeft",
  InputStrategyFar: "Verder",
  InputStrategyFarDesc:
    "Prefereer de verste opslagplaats die genoeg goederen heeft",
  InputStrategyAmount: "Hoeveelheid",
  InputStrategyAmountDesc:
    "Prefereer de opslagplaats met grootste aantal goederen, ongeacht de afstand",
  ...
  Screen: "Scherm",
  JoinDiscord:
    "Bezoek onze Discord server voor de laatste updates, tips en discussies",
  ...
  EffectiveTimeDesc:
    "Je effectieve offline verdienste tijd is gelimiteerd tot %{time}min.",
  BuildSearchPlaceholder: "Type gebouw of goederen om te zoeken",
  MineOverlayWarning:
    "%{building} is niet onder invloed van de tegel modificator",
  ...
  PolicyPointDesc:
    "💡 Hoe meer actieve beleiden, des te hoger de kost per beleid",
  ...
  NewOrder:
    "Een nieuwe bestelling van %{from} is toegekomen, controleer dit aub in je groothandel",
  Policies: "Beleid",
  ...
  PolicyOilWellPowerx2Desc:
    "Oliebronnen produceren 2x olie and gebruiken 2x energie",
  HalfTransportSpeed: "Vertraag om te sparen",
  HalfTransportSpeedDesc:
    "transport snelheid is vertraagd met 25% en de brandstof prijs is gereduceerd met 25%",
  RefineryMoreOil: "Meer brandstof, meer problemen",
  RefineryMoreOilDesc:
    "Olie raffinaderijen produceren 50% meer brandstof en 50% minder plastic",
  RefineryMorePlastic: "Meer Plastic Meer Problemen",
  RefineryMorePlasticDesc:
    "Olie Raffinaderijen produceren 50% minder brandstof and 50% meer plastic",
  FreeOilTransportDesc:
    "Olie transport kost geen brandstof meer maar oliebronnen verbruiken 2x meer energie",
  SuperSteelMill: "Harten van Ijzer",
  SuperSteelMillDesc:
    "Staalfabrieken verbruiken 50% minder steenkool en 25% meer ijzer en 25% meer energie",
  AlSemiconductor: "Al geleiders",
  AlSemiconductorDesc:
    "Halfgeleidersfabrieken gebruiken aluminium in plaats van koper",
  CostSaver: "Kosten bespaarder",
  CostSaverDesc:
    "Als een gebouw zijn invoer meer kost dan z'n eindproduct, schakel dan de productie uit",
  ...
  CostSaverBuildingWarning:
    "Kosten bespaarder beleid is actief, je kan de productie niet manueel aanpassen",
  GlassUseCoal: "Zwart glas",
  GlassUseCoalDesc:
    "Glasfabrieken verbruiken 50% meer kolen en 50% minder silicium",
  ...
  IronMine2xOutputDesc:
    "Ijzermijnen produceren 2x meer ijzer maar ijzer transport kost 2x meer brandstof",
  SolarPanelAlwaysWork: "De Zon Gaat Nooit Onder",
  SolarPanelAlwaysWorkDesc:
    "Zonnepanelen werken 100% van de tijd, maar produceren maar 60% energie",
  SteelScience: "Kennis Door Staal",
  SteelScienceDesc:
    "Staalfabrieken gebruiken 2x invoer en produceren extra wetenschap",
  ...
  CrAlloyUseFeDesc:
    "Chroom legeringsfabrieken gebruiken geen Lithium maar 2 ijzer ter vervanging",
  DoubleTileModifier: "Kracht Van De Natuur",
  TileModifierOutputOnly: "Tegel Modificator Plus",
  GasPlantPetrol: "Gas Liquisatie",
  GasPlantPetrolDesc:
    "Aardgas energiecentrales gebruiken extra aardgas om petroleum te produceren",
  CoalPlantFuel: "Kolen Liquisatie",
  CoalPlantFuelDesc:
    "Steenkool energiecentrales verbruiken extra steenkool om brandstof te produceren",
  Welcome: "Welkom",
  ...
  RestoreFromBackupFail:
    "Backup herstel gefaald uit de Steam Cloud. Ben je zeker dat er een backup is?",
  ...
  SaveName: "Opslaan",
  NameValidationRule:
    "Je naam mag enkel letters en nummers bevatten en moet tussen 5 en 15 karakters lang zijn",
  ...
  Name: "Naam",
  Tips1:
    "Aandelen beoordelingen hebben 5 niveau's: Kopen, Over Presteren, Stagnatie, Onder Presteren en Verkopen",
  Tips2:
  ...
  Tips3:
    "Brandstof kosten voor goederen transport worden bepaald door afstand en hoeveelheid goederen",
  Tips4:
  ...
  Tips6:
    "Je kan de brandstofkosten voor goederen bekijken onder de bijbehorende invoer capaciteits sectie",
  Tips7:
    "Als je goederen aankoopt, zal de prijs stijgen. Als je goederen verkoopt zal de prijs dalen",
  Tips8:
    "Je kan de grafiek voor een goed's aantal en het aanpassen over tijd in het Statistieken Bureau",
  Tips9:
    "Onderzoekspunten voor een gebouw worden bepaald door de marktprijs en door zijn invoersgoederen",
  Tips10:
  ...
  LeaderboardOptInDesc:
    "Je data moet een RESET ondergaan voor je het scorebord terug kan activeren, ben je zeker?",
  ...
  RequireExpansionPack1Desc:
    "Dit is enkel beschikbaar voor Uitbreidings Pakket 1",
  RequireAnyExpansionPack: "Uitbreidingspakket Exclusief",
  RequireAnyExpansionPackDesc:
    "Om dit te gebruiken heb je minstens 1 uitbreidingspakket nodig",
  ...
  HideDiscordBannerDesc:
    "Verberg Discord en de winkelbanner in het hoofdkwartier",
  ...
  FuelCostDiscountDesc:
    "Geeft een korting op de brandstof kosten wanneer je goederen transporteert",
  AutoSellCapacityMultiplier:
    "Automatische Verkoopscapaciteit vermedigvuldiger",
  ...
  BuildingPermitCostDividerDesc:
    "Deel de prijs van Bouwvergunningen door deze factor",
  ExtraAdjacentBonus: "Extra Aangrenzingsbonus",
  ExtraAdjacentBonusDesc:
    "Extra bonus capaciteit voor elke aanliggend gebouw van hetzelfde type",
  ...
  FailedToImportSaveDesc:
    "je opgeslagen bestand is incompatibel or gecorrumpteerd: %{error}",
  SaveCopiedToClipboard: "Je opgeslagen data is gekopieerd naar je klembord",
  CancelActiveTradeFirst:
    "Je hebt actieve speler transacties, annuleer of eis ze aub eerst op",
  ...
  PlayerTradeToClaim:
    "Je hebt %{num} nieuwe transactie(s) om te claimen in Speler transacties",
  PowerBank: "Power Bank",
  PowerBankBuildDesc:
    "Store surplus power and provide power supply during shortage",
  WarehouseBuildDesc:
    "Transporteer en sla mijn goederen op en met lagere brandstof kosten",
  ...
  PowerBankMoreCapacityDesc:
    "Power banks laden op met 50% snelheid maar hebben 50% meer capaciteit",
  PowerBankNotWorking: "⛔ Power banks werken enkel naast een energiecentrale",
  ColorTheme: "Spel kleurenthema",
  ColorThemeDesc:
    "Kleurenthema voor spelicoontjes, markeringen, grid en achtergrond. VEREIST HERSTART",
