export const ES = {
  ...
  TranslatorName:
    "Juan Manuel Jaén Cabrera (Leunal17), Dishito, Daniel Padilla Rodríguez (danpad01)",
  Language: "Idioma",
  ...
  ScienceFromPowerDesc:
    "Las plantas de energía producen una pequeña cantidad de ciencia cuando generan energía",
  Culture: "Cultura",
  School: "Escuela",
  ...
  AutoSellCapacityDesc:
    "Cantidad máxima de recursos que la venta automática puede manejar por segundo, por recurso",
  ...
  AutoSellConcurrencyDesc:
    "Número máximo de recursos que la venta automática puede manejar al mismo tiempo",
  ...
  MarketCapDesc:
    "Capitalización de mercado total (i.e. valor de mercado) de tu corporación",
  BuildingValuation: "Valoración de edificios",
  BuildingValuationDesc:
    "Valor total de sus edificios, incluyendo permisos de construcción y mejoras",
  ...
  AutoHighlightDesc:
    "Resalte automáticamente edificios del mismo tipo cuando seleccione un edificio",
  MusicDesc:
    "Enciende la música: It's Not Over 'Til The Bossa Nova de Shane Ivers (https://www.silvermansound.com)",
  Credits: "Creditos",
  Icons: "Iconos",
  MisplacedBuilding:
    "⛔ Este %{building} no se coloca encima del depósito de recursos correcto",
  ...
  HighlightMaxInputDistanceNotDefault:
    "...que tienen una distancia máxima de entrada < ∞",
  ...
  InputStrategyCloseDesc:
    "Prefiera el almacén más cercano que tenga suficientes recursos",
  InputStrategyFar: "Más lejos",
  InputStrategyFarDesc:
    "Prefiere el almacén más lejano que tenga suficientes recursos.",
  ...
  Screen: "Pantalla",
  JoinDiscord:
    "Únase a nuestro servidor de Discord para obtener las últimas actualizaciones, consejos y discusiones",
  ...
  EffectiveTimeDesc:
    "Su tiempo efectivo de ganancia fuera de línea está limitado a %{time}mínimo.",
  BuildSearchPlaceholder: "Escriba edificio o recurso para buscar",
  MineOverlayWarning:
    "%{building} No se ve afectado por el modificador de mosaico",
  ...
  PolicyPointDesc:
    "💡 Cuantas más políticas activas, más costo tiene cada política",
  ...
  NewOrder:
    "Un nuevo pedido de %{from} ha llegado, por favor verifique en el Centro Mayorista",
  Policies: "Políticas",
  PolicyNotEnoughTime:
    "No tiene suficientes puntos de política para esta política",
  ...
  PolicyOilWellPowerx2Desc:
    "Los pozos de petróleo producen el doble de petróleo y usan el doble de energía",
  ...
  RefineryMoreOilDesc:
    "Las refinerías de petróleo producen un 50% más de gasolina y un 50% menos de plástico",
  RefineryMorePlastic: "Mo Plásticos Mo Problemas",
  RefineryMorePlasticDesc:
    "Las refinerías de petróleo producen un 50% menos de gasolina y un 50% más de plástico",
  ...
  SuperSteelMillDesc:
    "Las acerías utilizan un 50% menos de carbón y un 25% más de hierro y un 25% más de energía.",
  AlSemiconductor: "Al circuito",
  AlSemiconductorDesc:
    "Las fundiciones de circuitos utilizan aluminio en lugar de cobre",
  CostSaver: "Ahorro de costos",
  CostSaverDesc:
    "Si los insumos de un edificio cuestan más que su producción, cierre la producción",
  ...
  CostSaverBuildingWarning:
    "La política de ahorro de costos está activa, no puede cambiar la producción manualmente",
  GlassUseCoal: "Vidrio negro",
  GlassUseCoalDesc:
    "Las fábricas de vidrio utilizan un 50% más de carbón y un 50% menos de silicio",
  ...
  SolarPanelAlwaysWorkDesc:
    "El panel solar funciona el 100% del tiempo pero produce un 60% menos de energía",
  SteelScience: "Conocimiento a través del acero",
  SteelScienceDesc:
    "Las acerías utilizan el doble de insumos y producen ciencia adicional",
  ...
  CrAlloyUseFe: "Cromo",
  CrAlloyUseFeDesc:
    "Las plantas de aleación de cromo no usan litio, sino que usan 2x hierro en su lugar",
  DoubleTileModifier: "Poder de la naturaleza",
  TileModifierOutputOnly: "Editar mosaico plus",
  GasPlantPetrol: "Licuadora de gas",
  GasPlantPetrolDesc:
    "Las centrales eléctricas de gas utilizan gas extra para producir gasolina",
  CoalPlantFuel: "Licuadora de carbón",
  CoalPlantFuelDesc:
    "Las centrales eléctricas de carbón utilizan carbón adicional para producir gasolina",
  Welcome: "Bienvenido",
  ...
  SaveName: "Ahorrar",
  NameValidationRule:
    "Su nombre solo debe contener letras y números y tener entre 5 y 15 caracteres",
  NameValidationRuleProfanity: "Tu nombre no debe contener blasfemias",
  ChatMessageRateLimit:
    "Solo puedes enviar un nuevo mensaje de chat cada 10 segundos",
  ...
  Tips5:
    "Los edificios solo transportarán un recurso desde el Centro Comercial si la venta automática está desactivada para ese recurso",
  Tips6:
    "Puede ver el costo de combustible de un recurso en la sección de capacidad de entrada correspondiente",
  Tips7:
    "Si compra un recurso, aumentará el precio. Si vende un recurso, bajará el precio",
  Tips8:
  ...
  RequireAnyExpansionPackDesc:
    "Esta función requiere que tengas al menos uno de los paquetes de expansión.",
  ...
  RestartDesc:
    "💡 Solo quiero reiniciar? Puede tocar Comenzar en una nueva ciudad arriba y elegir su ciudad actual",
  ...
  FuelCostDiscountDesc:
    "Ofrece un descuento en el costo del combustible al transportar recursos.",
  ...
  BuildingPermitCostDividerDesc:
    "Divida el costo del permiso de construcción por este divisor",
  ExtraAdjacentBonus: "Bono adicional adyacente",
  ExtraAdjacentBonusDesc:
    "Capacidad adicional adicional para cada edificio de trabajo adyacente del mismo tipo",
  ...
  LoadGameErrorDesc:
    "Por favor revise su conexion a internet. Si el problema persiste, comuníquese con el soporte",
  ...
  FailedToImportSaveDesc:
    "Tu partida es incompatible o esta corrompida: %{error}",
  ...
  WarehouseBuildDesc:
    "Transport and store any resources and with lower fuel cost",
  ...
  AlMine2xOutputDesc:
    "Las minas de aluminio producen 2x de aluminio y usan 2x de energía",
  ...
  AcceptTradeFailRateLimit:
    "Solo puedes aceptar un intercambio cada %{time} segundos",
  ...
  WarehouseAddRouteFail:
    "Error al añadir ruta: la casilla seleccionada no es una fuente válida",
  LevelN: "Nivel %{level}",
  Surplus: "Superávit",
  ...
  ChatMessageTooLong:
    "Tu mensaje de chat supera el máximo de caracteres permitidos",
  ...
  ChangeNameCooldown:
    "Sólo puedes cambiar tu nombre una vez cada %{hour} horas",
