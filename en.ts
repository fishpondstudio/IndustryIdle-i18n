export const EN = {
    ...
    MarketNewsFilterInput: "Buildings that input %{res} ",
    MarketNewsFilterOutput: "Buildings that output %{res} ",
    MarketNewsFilterBoth: "Buildings that input or output %{res} ",
    MarketNewsIncrease: "increase the amount by %{percent}",
    MarketNewsDecrease: "decrease the amount by %{percent}",
