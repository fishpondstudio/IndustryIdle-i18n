export const PT_BR = {
  ...
  "BuildingPermitDesc": "Você tem permissão para %{amount} construções,você já construiu %{amountBuilt} e tem %{amountLeft} sobrando",
  ...
  "ProductionCycleLengthDesc": "Duração de um ciclo de produção,mensurado em segundos. Prolongar o clico irá aumentar a entrada/saída por ciclo consequentemente diminuindo sua prioridade ao buscar recursos de entrada",
  "MaxInputDistance": "Distância máxima de entrada",
  "MaxInputDistanceDesc": "A distância máxima a partir da qual este edifício pode buscar recursos de entrada,medida em número de blocos",
  ...
  "MaxAutoSellConcurrencyReached": "Você atingiu o máximo de vendas automáticas simultâneas,desativa uma venda automática para habilitar esta",
  ...
  "StockRatingDesc": "Consenso de classificação de ações de analistas de Wall Street,que afeta sua capitalização de mercado e é atualizado junto com o mercado",
  ...
  "TurnOffProductionDesc": "Desligue a produção da construção. A construção não transportará mais recursos nem usará energia",
  ...
  "FuelCostSaveDescV2": "Os armazéns economizam uma certa porcentagem de combustível para transportar recursos em comparação à outros edifícios,quanto maior o nível,Maior a economia",
  ...
  "RejectOrder": "Passar",
  "WholesaleCenterLocked": "Você precisa de pelo menos %{required} recursos diferentes para desbloquear o Centro de atacado. Você tem apenas %{current} recursos",
  ...
  "CostSaverBuildingDesc": "A política de redução de custos está ativa,a produção será ligada / desligada automaticamente com base em sua lucratividade",
  ...
  "ShoppingSpreeDesc": "Se a capacidade de produção de um recurso for insuficiente,compre a quantidade em falta do Centro Comercial automaticamente (se o recurso tiver venda automática,ele será ignorado)",
  "ShoppingSpreeTradeCenterDesc": "💡 A política da Maratona de Compras está ativada,o Centro Comercial comprará automaticamente os recursos em falta",
  ...
  "Tutorial1": "Industry Idle é um <em> jogo </em> de gestão de recursos em que você constrói fábricas🏭,produz bens📦 e faz dinheiro💸.<br><br>Vamos repassar alguns conceitos básicos para você começar - não vai demorar muito,eu prometo.",
  "Tutorial2": "Todas as construções precisam de energia⚡,você tem a <em>turbina eólica</em> que gera energia. Você pode ver sua produção de energia atual no lado esquerdo da barra superior.<br><br>Você deve ter notado que as turbinas eólicas só funcionam <em>80%</em> do tempo. Você pode considerar a construção de outros tipos de usinas de energia que geram energia estável.",
  "Tutorial3": "Você tem um monte de <em>depósitos de recursos</em> no mapa. Para extrair recursos,você deve construir minas ⛏️ <em>em cima</em> do depósito correspondente.<br><br>Por exemplo,você tem um <em>poço de petróleo 🛢️</em> que extrai <em>petróleo</em> de um depósito.<br></br>Os depósitos de recursos são ilimitados - não há necessidade de se preocupar com o esgotamento. Além das minas,outros edifícios podem ser construídos em qualquer bloco vazio.",
  "Tutorial5": "Para ganhar dinheiro,você precisa exportar seus recursos através do centro de comércio. Para fazer isso,basta ligar <em>Venda Automática</em> para este recurso.<br></br>Você também pode comprar recursos do centro comercial. Lembre-se,<em>se você compra um recurso,você vai aumentar o preço</em> e se você vender um recurso,você vai baixar o preço.<br><br>O mercado é <em>volátil</em> e o preço📈 muda regularmente.",
  "Tutorial6": "Para construir novos edifícios,você precisa primeiro de desbloquear ele no <em>centro de pesquisa🧪</em>. O laboratório de pesquisa também converte ciência em pontos de pesquisa.<br><br>Sua turbina eólica (e outras plantas de energia) produzem uma pequena quantidade de ciência enquanto funcionam. E você também pode construir escolas🏫 e outros edifícios dedicados para impulsionar a ciência mais tarde.<br><br>Agora que você aprendeu o básico,comece a construir sua economia! Aqui está um pouco de <em>dinheiro💸</em> e <em>petróleo⛽</em> para te dar um salto inicial.",
  "WelcomePlay": "Tocar",
  ...
  "RestoreFromBackupDesc": "Normalmente,você não precisa restaurar do backup em nuvem,a menos que seu salvamento local seja perdido. O backup na nuvem é um pouco mais antigo que o seu save local",
  "ChangeName": "Trocar",
  "SaveName": "Salvar",
  ...
  "OfflineModeDesc": "Não é possível conectar ao servidor: ganhos offline não serão gerados. Por favor,verifique sua conexão à internet",
  "OptOut": "OptOut",
  "OptIn": "OptIn",
  ...
  "FPS30Desc": "Ativar o modo de economia de energia executará o jogo a 30FPS em vez de 60FPS. Isso fará com que sua bateria dure mais ou seu PC consuma menos energia",
  ...
  "HideRewardAdDesc": "Todos os anúncios no jogo são anúncios premiados opcionais. Isso ocultará todas as opções de anúncios premiados do jogo.",
  ...
  "RestartDesc": "💡Quer apenas reiniciar? Você pode apertar em Começar em uma nova cidade acima e escolher sua cidade atual",
  "PrestigeGoBack": "Voltar",
  "ProductionMultiplier": "Multiplicador de Produção",
  "ProductionMultiplierDesc": "Um aumento na capacidade de produção de todos os seus edifícios (incluindo minas,fábricas,usinas de energia,edifícios científicos e culturais)",
  ...
  "PrestigeAlertContent": "Sua empresa será liquidada. Você sacará %{amount} dinheiro suíço e iniciará uma nova empresa em %{city}",
  "PrestigeCurrencyDesc": "Este é o dinheiro em sua conta bancária secreta na Suíça,você pode aumentar quando começar em uma nova cidade",
  "Prestige": "Receber",
  "Cancel": "Cancelar",
  ...
  "ExpansionPackIncompatible": "Você está importando um save com pacotes de expansão,mas seu jogo não tem os pacotes de expansão necessários",
  "CashIn": "Dinheiro em caixa",
  "CurrentCity": "Cidade atual",
  "CashInDesc": "Você receberá esse valor em sua conta bancária na Suíça se começar em uma nova cidade. É baseado na capitalização de mercado da sua empresa e deve atingir %{amount} antes de você ganhar dinheiro suíço",
  ...
  "Hamburg": "Hamburgo",
  "HamburgBonus": "<li>Fábricas de Zepelim são desbloqueadas de início</li><li>Fábricas de Semicondutor têm 2x de produtividade</li><li>Estaleiros têm 2x de capacidade</li><li>Fábrica de Carro têm 2x de capacidade</li><li>Fábrica de bateria Li-ion são desbloqueadas de início</li>",
  "Toulouse": "Toulouse",
  "Rome": "Roma",
  "RomeBonus": "<li>Coliseus são desbloqueados de início</li><li>Coliseus têm 2x de produtividade</li><li>Começa com o Centro Político no nível 5</li><li>Casas de Ópera têm 2x de capacidade</li><li>Estúdios de Gravação também produzem cultura</li>",
  "Detroit": "Detroit",
  "Boston": "Boston",
  "BostonBonus": "<li>Começa com o Laboratório de Pesquisa no nível 5</li><li>Escolas politécnicas são desbloqueadas de início</li><li>Escolas politécnicas têm 2x de capacidade</li><li>Escolas têm 2x de capacidade</li><li>Universidade têm 2x de produtividade</li>",
  ...
  "AddTradeExceedMaximumTrade": "Você só pode ter no máximo %{number} negociações ativas,reivindique ou cancele uma delas primeiro",
  ...
  "PlayerTradeUnavailable": "Você precisa ter pelo menos um recurso em produção e em armazenamento antes de poder negociar com jogadores",
  ...
  "SiliconMine2xOutputDesc": "As minas de silício produzem 2x mais,porem usam 50% mais energia e o transporte de silício custa 50% mais combustível",
  ...
  "SteamLoginDialogDesc": "Seu salvamento local tem o Pacote de Expansão ativado,você precisa entrar no Steam para continuar. Ou você pode APAGAR SEU SALVAR LOCAL e começar de novo",
  ...
  "FreeTransportToTradeCenterDesc": "O transporte para o centro comercial não custa combustível,mas o transporte do centro comercial custa 50% mais combustível",
  ...
  "AutoSellResourceWarningDesc": "Você está vendendo automaticamente este recurso,o valor armazenado no Trade Center não pode ser usado aqui",
  "PlayerTradeLocalPrice": "Preço local: %{price}",
  "ChatForceScroll": "Forçar Rolagem",
  "ChatForceScrollDesc": "Se a rolagem forçada estiver ativada,o bate-papo rolará sempre que houver uma nova mensagem. Caso contrário,ele só rolará quando você já estiver na parte inferior",
  "ResourceExplorer2": "Explorador de recursos 2.0",
  "ConstructionCancel": "Cancelar",
  "PolicyBlueprint": "Blueprint",
  "PolicyBlueprintDesc": "A construção de um edifício não começará automaticamente - terá que ser iniciada manualmente (Política Gratuita)",
  ...
  "SellRefundPercentageDesc": "Se você vender ou rebaixar um edifício,esta é a porcentagem de dinheiro e recursos que será reembolsado",
  "SellBuildingDescV2": "A venda de um edifício reembolsará %{percent} do seu investimento e %{percent} dos recursos serão transportados para o Trade Center",
  ...
  "AchievementSoftwareGiantDesc": "Construa uma Companhia de Software nível 10,Indústria de Sistemas Operacionais nível 10,Companhia de Banco de Dados nível 10 e um Navegado de Internet nível 10 no mesmo mapa",
  "AchievementSpaceRace": "Corrida espacial",
  "AchievementSpaceRaceDesc": "Construa uma fábrica de foguetes nível 10,fábrica de satélite nível 10,fábrica de nave estelar nível 10 e uma fábrica de Estação Espacial nível 10 no mesmo mapa",
  "AchievementToTheMoon": "Para a Lua",
  "AchievementToTheMoonDesc": "Construa uma Fazenda de Bitcoin nível 40 e uma Fazenda de Dogecoin nível 40. Tenha 1B em Bitcoin e 1B em Dogecoin",
  ...
  "LogoutDescV2": "Você entrou em outro dispositivo,este dispositivo está desconectado. Você pode entrar novamente,mas o outro dispositivo será desconectado",
  "LogBackIn": "Entrar novamente",
  "ServerDisconnected": "Você está desconectado do servidor,por favor,verifique sua conexão com a internet e reinicie o jogo",
  ...
  "BlockUserChatDesc": "O bloqueio estará em vigor durante esta sessão de jogo e você não poderá desfazer isso a menos que reinicie o jogo",
  ...
  "ResourceBoosterSquareDesc": "Os impulsionadores de recursos fornecem 25% a mais de impulso,mas sua entrada científica e uso de energia também aumentam em 25%",
  ...
  "StPetersburgBonusV2": "<li>Minas de urânio têm 2x de saída</li><li>Plantas de enriquecimento de urânio têm 2x de capacidade</li><li>Transportar urânio utiliza 50% menos combustível</li><li>Armas são transportadas gratuitamente</li><li>Projeto Vostok têm 2x de capacidade</li>",
  "ToulouseBonusV2": "<li>Minas de titânio têm 2x de saída</li><li>Plantas de enriquecimento de urânio têm 2x de produtividade</li><li>Fábricas de motor de jato têm 2x de capacidade</li><li>Fábricas de aeronave têm 2x de produtividade</li><li>Fábricas de foguete têm 2x de capacidade</li>",
  ...
  "GPUIsBusyDesc": "Seu sistema operacional pausou os gráficos do jogo porque a GPU (Placa de vídeo) está ocupada com outras tarefas. Você pode recarregar o jogo para continuar. Se não funcionar,tente reiniciar o jogo",
  ...
  "ResourceBoosterSupplyChainDesc": "Os boosters de recursos usam 2x de poder e ciência,mas para cada mina em funcionamento um booster de recursos está aumentando,ele também fornece aumento de capacidade para fábricas adjacentes que consomem a produção da mina (a fábrica deve consumir apenas depósitos)",
  ...
  "ResourceExplorer2DescV2": "Exploradores de recursos produzem 2x de saída,mas usam 2x de potência. Os exploradores de recursos podem ser impulsionados por impulsionadores de recursos se a política do Impulsionador da Cadeia de Suprimentos estiver ativa e o impulsionador tiver uma mina adjacente com a mesma saída",
  "NoTileModifier": "A Terra é Plana",
  "NoTileModifierDesc": "Todos os modificadores de tile são zero. Esta política desativará as políticas *Poder da Natureza* e *Modificador de Blocos Plus*",
  "DoubleTileModifierDescV2": "Efeito de todos os modificadores de tile x2 - tanto positivo quanto negativo. Esta política desativará a política da Terra é plana",
  "TileModifierOutputOnlyDescV2": "Os modificadores de bloco afetam apenas a saída em vez de entrada e saída,mas são apenas 50% eficazes. Esta política desativará a política da Terra é plana",
  ...
  "TotalPledgedValueDesc": "Sua primeira promessa conta para a meta de financiamento coletivo. As promessas subsequentes aumentam o valor total prometido,mas não contam para a meta",
  ...
  "CrowdfundingAlreadyPledgedDesc": "Você pode comprometer mais recursos,o que aumentará seu valor total prometido (e retorno potencial),mas não contará para a meta de financiamento coletivo",
  "WholesaleCenterProducingOnly": "Parceiros de Atacado",
  "WholesaleCenterProducingOnlyDesc": "Os pedidos do centro de atacado contêm apenas recursos que estão sendo produzidos no momento (você também precisa estar produzindo o número de recursos necessários para desbloquear o centro de atacado)",
  ...
  "ResourceMovementDesc": "Você pode escolher quando mostrar o movimento do recurso (pontos). Escondê-lo pode melhorar o desempenho",
  ...
  "ResourceBoosterBannerDescV2": "💡 Atualmente você tem %{number} impulsionadores de recursos - a entrada científica de cada um é dimensionada para o número de impulsionadores de recursos que você possui atualmente",
  ...
  "IndustryZoneNotWorkingDesc": "Todos os seus edifícios adjacentes devem formar uma cadeia de suprimentos e não fazer parte de outras zonas industriais",
  ...
  "DotComTycoonDesc": "Construa um nível 10 Rede Social INK.,nível 10 Empresa de motores de busca,nível 10 SkyNet INK e nível 10 Musify INK no mesmo mapa",
  ...
  "HighSpeedWarehouseDesc": "Os armazéns têm capacidade 2x e velocidade de transporte interna e externa 50% mais rápida,mas usam potência 2x",
  ...
  "OfflineResearchSwissBoostDesc": "Os pontos de pesquisa são gerados enquanto você está offline (de acordo com seu nível de Laboratório de Pesquisa,Ciência em seu depósito e tempo de ganho offline)",
  "SanJose": "São José",
  "SanJoseBonus": "<li>Edifício exclusivo: fabricante de chips</li><li>Edifício exclusivo: FaceApp INK</li><li>Edifício exclusivo: Bitcoin Miner</li><li>Todos os edifícios que consomem silício têm modificador máximo de ladrilhos</li><li>Os painéis solares geram 2x de energia</li><li>As minas de silício têm 2x de potência</li>",
  "RotterdamBonusV2": "<li>Aciarias têm 2x capacidade</li><li>Aciarias têm 2x capacidade</li><li>Transporte gratuito de ferro</li><li>Transporte de aço custa 50% menos combustível</li><li>Comece com 2x a capacidade de venda automática</li><li>A política da Terra Plana é gratuita</li>",
  ...
  "IndustryZoneMultiplierSwissBoostDescV2": "Cada camada da cadeia de produção dentro de uma zona industrial fornece esse aumento de capacidade para todos os edifícios na mesma zona",
  "IndustryZoneBuildingPermitDesc": "Se uma zona industrial tiver N níveis de produção,fornecerá licenças de construção N-2 gratuitamente",
  ...
  "ReturnOnPledgeDescV2": "Seu retorno total é igual ao valor total prometido multiplicado pelas taxas de retorno de todos os recursos. Mais apoiadores de um recurso melhorarão seu retorno",
  ...
  "ResourceExplorerAllDesc": "Exploradores de recursos podem produzir todos os recursos,incluindo os que não estão no mapa (isso NÃO desbloqueia as tecnologias relevantes)",
  "ShowResourceInTopBar": "Mostrar na barra superior",
  "LeaderboardOptOutDescV2": "Você não aparecerá mais na tabela de classificação. Isso também desativará a troca de jogadores. OBSERVAÇÃO: se você quiser habilitar a tabela de classificação mais tarde,seus dados precisam ser redefinidos",
  "PolicyPointNoCopperDesc": "💡 Este mapa não possui depósitos de cobre,você pode ativar a política Circuito IA para desbloquear mais tecnologias",
  "Pumpkin": "Abóbora",
  ...
  "SantaClauseIsComingDesc": "As fábricas de Papai Noel consomem renas e brinquedos e produzem Papai Noel,ciência e cultura. As fábricas de Papai Noel têm modificador máximo de peças. Fábricas de brinquedos produzem renas além de brinquedos (POLÍTICA GRATUITA)",
  "MetaRebranding": "MetaVerso",
  "MetaRebrandingDesc": "A Rede social INK é renomeada para Meta INK e consome internet,jogo,supercomputador,bitcoin e dogecoin.",
  "MetaInc": "Meta INK",
  ...
  "CrowdfundingTotalPledgdeValueTooLarge": "Seu valor total prometido para um financiamento coletivo não pode exceder seu valor de mercado atual",
  ...
  "BuildingSourceFallbackDesc": "Como o prédio deve transportar sua entrada se a fonte manual não tiver o suficiente? Pular - não transportar; Drenar - transportar o que resta; Novo - use a fonte automática para encontrar uma nova fonte",
  ...
  "RandomIslandBonus": "<li>O mapa é randomizado toda vez que você inicia</li><li>Tamanho do mapa,tipo de grade,depósitos de recursos e bônus exclusivos são todos rolados aleatoriamente</li><li>Há um tempo de espera de 5 minutos - o reroll só acontece com um intervalo mínimo de 5 minutos</li>",
  ...
  "AdjacentExplorerDesc": "Um explorador de recursos produz uma saída 2x se for adjacente ao recurso que está produzindo (POLÍTICA GRATUITA)",
  "FactoryMining": "Mineração de fábrica",
  "FactoryMiningDesc": "Uma fábrica pode minerar o depósito diretamente do ladrilho se consumir o mesmo depósito (POLÍTICA DE GRAÇA)",
  ...
  "MultipleSourcesDesc": "Permitir que o edifício transporte potencialmente recursos de várias fontes durante um ciclo de produção",
  "Water": "Água",
  ...
  "FarmlandOfflineFarmingDesc": "Terras agrícolas construídas em cima de fontes naturais de água produzem enquanto você está offline. Sujeito a tempo de ganho offline e afetado por atualizações suíças",
  ...
  "WaterEntityLevelTooHighDesc": "Seu nível de construção é mais alto que o nível da barragem hidrelétrica adjacente. Por favor,atualize sua barragem hidrelétrica",
  ...
  "ShowSupplyChainDesc": "Ao destacar um edifício,mostre toda a cadeia de suprimentos de todos os edifícios a montante e a jusante",
  "Cake": "Bolo",
  ...
  "StandbyModeDesc": "O jogo continuará sendo executado em segundo plano,mas não renderizará nenhum gráfico. Isso reduzirá significativamente o uso da GPU (Placa de vídeo) e o uso da CPU(Processador) também",
  ...
  "StreamingMakeMeDiscoverableDesc": "Permita que outros jogadores assistam ao seu jogo. A conexão é ponto a ponto e apenas o seu jogo é transmitido. Microfone ou webcam não serão acessados",
  ...
  "StreamingConnectionFailed": "Falha ao estabelecer uma conexão Ponto-a-Ponto. é muito provável que sua rede não suporte conexão P2P",
  "Pizza": "Pizza",
  "StreamingStartRecord": "Começar a gravar",
  "StreamingRecordCamera": "Gravar um corte do diretor",
  "StreamingRecordCameraDesc": "Grave uma sequência pré-dirigida de 10s - A câmera definirá o zoom máximo e diminuirá o zoom lentamente",
  ...
  "LunarNewYear22Desc": "Todos os prédios que consomem papel usarão Lanterna e terão 2x a capacidade. Fábricas de papel se tornam Academia do Papel e produzem cultura em vez disso",
  ...
  "BatteryFuelDesc": "💡 Depois que as baterias forem usadas como combustível,elas se tornarão Baterias velhas. Você pode construir recicladores de baterias para reciclá-los ou recarregá-las",
  ...
  "KansasCityBonus": "<li>Plantas e estufas produzem 2x mais milho</li><li>Transporte gratuito de milho</li><li>Para cada nível,as hidrelétricas aumentam em 5% as terras agrícolas adjacentes</li><li>A cada 2 terras agrícolas conceda 1 licença de construção gratuita</li><li>A política O sol nunca se põe também faz com que as terras agrícolas trabalhem 100% do tempo (incluindo off-line)</li><li>2x cota de troca de jogadores ao negociar colheitas</li><li>Fábricas de processamento de alimentos são desbloqueadas</li>",
  ...
  "PerthGeothermalPowerPlantBoost": "Bônus exclusivo de Perth: esta Fabrica geotérmica fornece %{boost} impulso para edifícios adjacentes que produzem aço",
  "PerthBonus": "<li>Os spinners do edifício giram no sentido horário,o que é oposto a outras cidades</li><li>Depósito exclusivo: chaminé geotérmica</li><li>Edifício exclusivo: Fabrica geotérmica</li><li>Políticas exclusivas: adjacente Explorer (GRÁTIS),Mineração de Fábrica (GRÁTIS)</li>",
  "Biofuel": "Biocombustível",
  "RioDeJaneiro": "Rio de Janeiro",
  "RioDeJaneiroBonus": "<li>Combustível único: Biocombustível</li><li>Grupos de porcos,vacas e galinhas produzem biocombustível extra</li><li>Prédio único: Usina de Biocombustível</li><li>Prédio único: Cristo Redentor< /li><li>Os reforços de recursos podem aumentar as fazendas de porcos,vacas e galinhas</li><li>Os campos de extração de madeira produzem 2x madeira</li><li>As serrarias têm 2x a capacidade</li><li>Frango congelado,carne de porco congelada e carne bovina enlatada têm 2x cota de negociação</li>",
  "BiofuelPowerPlant": "Fabrica de Biocombustível",
  "CristoRedentor": "Cristo Redentor",
  "CristoRedentorBanner": "O Cristo Redentor fornece bônus adjacente a qualquer edifício que tenha nível inferior ou igual. Seu consumo de cultura cresce exponencialmente se você construir mais",
  ...
  "PathBlocked": "Você não pode construir neste bloco,pois ele bloqueará todos os caminhos possíveis de buracos de minhoca até sua sede",
  "WaveInProgressBuildRemoveDisabled": "Você não pode construir edifícios no caminho ou vender edifícios quando uma onda de invasão estiver em andamento",
  "ExportSaveForTransfer": "Transferir save",
  "ExportSaveForTransferDesc": "Escolha esta opção se quiser transferir seu salvamento entre dispositivos. Isso exportará seu direito de negociar para seu arquivo salvo - você pode continuar a negociar após importar o arquivo salvo. Seu dispositivo atual não poderá negociar sem aguardar um período de espera",
  "ExportSaveForBackup": "Fazer Backup do save",
  "ExportSaveForBackupDesc": "Escolha esta opção se você deseja simplesmente fazer um backup do seu progresso. Isso deixará seu direito de negociar em seu dispositivo atual - importar o arquivo salvo de backup não restaurará o direito de negociar sem aguardar um período de espera",
  "RightToTradeValid": "Direito de negociar",
  "RightToTradeInvalid": "Sem direito de negociar",
  "RightToTradeInvalidDesc": "Isso ocorre porque seu direito de negociar foi exportado para outro arquivo salvo - você deve importar esse arquivo salvo para restaurar seu direito de negociar. Se você perdeu esse arquivo salvo,você pode forçar a restauração do seu direito de negociar neste salvamento,mas você estará sujeito a um tempo de espera e seu outro salvamento perderá o direito de negociar",
  ...
  "PathTemporarilyBlocked": "Você não pode construir neste bloco,pois há uma onda em andamento. Verifique novamente depois que a onda terminar",
  ...
  "SteamAutoCloudBackupDescV3": "Seu progresso mais recente é salvo no Steam Cloud. O jogo também faz backup a cada 10 minutos - você pode forçar um backup a qualquer momento. Carregar um backup perderá o direito de negociar e exigirá uma restauração de força (sujeito a Tempo de espera!)",
  ...
  "PanelPositionDescV2": "Mostrar painel lateral à esquerda, direita ou automático (depende do bloco selecionado atualmente). Só funciona no modo paisagem",
  ...
  "AllowPortraitModeDesc": "Isso ativará o modo retrato (experimental), a tela girará com base no sensor e nas configurações do seu telefone",
  "IndustryZoneProductivityBoostDesc": "Cada nível ou cada 10 níveis de uma Zona da Indústria fornecem 10% de aumento de produção para edifícios nela",
  "Auckland": "Auckland",
  "AucklandBonus": "<li>Todos os depósitos são encontrados em uma área em forma de Nova Zelândia no centro do mapa</li><li>Edifício único: Usina Hidrelétrica</li><li>Política exclusiva: Mine Booster</li><li>Política Única: Lagoa de Peixes Elétrico</li><li>Os tanques de peixes podem ser construídos em qualquer ladrilho</li>",
  "MineBooster": "Intensificador de Mina",
  "MineBoosterDesc": "Uma mina em funcionamento fornece 100% de aumento de capacidade para minas ou fábricas adjacentes que consomem o depósito",
