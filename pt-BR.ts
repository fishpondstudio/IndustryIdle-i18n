export const PT_BR = {
    ...
    PanelPositionDesc: "Exibe o painel lateral na esquerda, direita ou automático (dependendo do bloco atualmente selecionado)",
    ...
    RecommendedBuilding: "💡 Este bloco contém %{resource} de recursos",
