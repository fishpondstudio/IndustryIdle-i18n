export const PT_BR = {
  ...
  NoLiquidityTurnOffAutoSell:
    "Não há liquidez no mercado suficiente por %{res}, venda automática desativada",
  ...
  ScienceFromPowerDesc:
    "Usinas Elétricas geram uma pequena quantidade de Ciência quando estão gerando energia",
  Culture: "Cultura",
  School: "Escola",
  ...
  BuildingLocked:
    "Construção ainda não disponível, você precisa desbloquear no Centro de Pesquisa primeiro",
  ...
  WindTurbineDesc:
    "💡 Turbinas eólicas trabalham apenas 8 segundos em cada 10 segundos - ciclos não estão alinhados",
  Movie: "Filme",
  ...
  AdjacentBonusDesc:
    "Você ganha %{bonus}% de capacidade extra para cada construção adjacente de mesmo tipo operando",
  ...
  AutoSellConcurrencyDesc:
    "Número máximo de recursos que a venda automática pode gerenciar ao mesmo tempo",
  ...
  MarketCapDesc:
    "Capitalização total (i.e. valor de mercado) de sua corporação",
  BuildingValuation: "Estimativa da construção",
  BuildingValuationDesc:
    "Valor total de suas construções, incluindo licenças de construção e atualizações",
  ...
  AutoHighlightDesc:
    "Destacar edifícios do mesmo tipo automaticamente ao selecionar um edifício",
  MusicDesc:
    "Ligue a música: It's Not Over 'Til The Bossa Nova de Shane Ivers (https://www.silvermansound.com)",
  Credits: "Créditos",
  Icons: "Ícones",
  MisplacedBuilding:
    "⛔ Esta %{building} não está colocada em cima do depósito de recursos correto",
  ...
  HighlightMaxInputDistanceNotDefault:
    "...que têm distância máxima de entrada < ∞",
  ...
  InputStrategyCloseDesc:
    "Prefira o armazém mais próximo que tenha recursos suficientes",
  InputStrategyFar: "Mais distante",
  InputStrategyFarDesc:
    "Prefira o armazém mais distante que tenha recursos suficientes",
  InputStrategyAmount: "Quantidade",
  InputStrategyAmountDesc:
    "Prefira o armazém com maior quantidade de recursos, independente da distância",
  ...
  Screen: "Tela",
  JoinDiscord:
    "Junte-se ao nosso servidor Discord para novidades, dicas e discussões",
  ...
  EffectiveTimeDesc:
    "Seu tempo efetivo de ganho offline é limitado a %{time}min.",
  ...
  PolicyPointDesc:
    "💡 Quanto mais políticas ativas, mais custo para cada política",
  ...
  NewOrder:
    "Um novo pedido de %{from} chegou, por favor, verifique no Centro de atacado",
  Policies: "Políticas",
  PolicyNotEnoughTime:
    "Você não tem pontos de política suficientes para esta política",
  ...
  PolicyOilWellPowerx2Desc:
    "Poços de petróleo produzem 2x mais óleo e usam 2x mais energia",
  HalfTransportSpeed: "Diminua A Velocidade Para Economizar",
  HalfTransportSpeedDesc:
    "A velocidade de transporte é reduzida em 25% e o custo do combustível é reduzido em 25%",
  RefineryMoreOil: "Mais Petróleo Mais Problemas",
  RefineryMoreOilDesc:
    "Refinarias de petróleo produzem 50% mais gasolina e 50% menos plástico",
  RefineryMorePlastic: "Mais Plásticos Mais Problemas",
  RefineryMorePlasticDesc:
    "Refinarias de petróleo produzem 50% menos gasolina e 50% mais plástico",
  ...
  SuperSteelMillDesc:
    "As siderúrgicas usam 50% menos carvão, 25% mais ferro e 25% mais energia",
  ...
  CostSaverDesc:
    "Se a entrada de um edifício custar mais do que sua produção, desligue a produção",
  ...
  GlassUseCoalDesc:
    "As fábricas de vidro usam 50% mais carvão e 50% menos silício",
  ...
  IronMine2xOutputDesc:
    "As minas de ferro produzem 2x o ferro, mas o transporte de ferro custa 2x o combustível",
  SolarPanelAlwaysWork: "O Sol Nunca Se Põe",
  SolarPanelAlwaysWorkDesc:
    "Os painéis solares funcionam 100% do tempo, mas produzem 60% menos energia",
  SteelScience: "Conhecimento através do aço",
  SteelScienceDesc:
    "As usinas siderúrgicas usam 2x mais insumos e produzem ciência extra",
  ...
  CrAlloyUseFeDesc:
    "As fábricas de liga de cromo não usam lítio, mas usam 2x ferro em vez disso",
  ...
  CoalPlantFuelDesc:
    "Usinas de carvão usam carvão extra para produzir gasolina",
  Welcome: "Bem-vindo",
  ...
  RestoreFromBackupFail:
    "Falha ao restaurar o backup do Steam Cloud: você tem certeza que há um backup?",
  ...
  SaveName: "Salvar",
  NameValidationRule:
    "Seu nome só pode conter letras e números e ter entre 5-15 caracteres",
  NameValidationRuleProfanity: "Seu nome não deve conter profanidade",
  ChatMessageRateLimit:
    "Você só pode enviar uma nova mensagem de bate-papo a cada 10 segundos",
  ...
  RequireAnyExpansionPackDesc:
    "Este recurso requer que você tenha pelo menos um dos pacotes de expansão",
  ...
  LoadGameErrorDesc:
    "Por favor, verifique sua conexão com a internet. Se o problema persistir, contate o suporte",
  ...
  ClaimTradeFail:
    "Falha em reinvindicar essa oferta, por favor, tente novamente mais tarde",
  CancelTradeSuccess: "Sua oferta foi cancelada com sucesso",
  CancelTradeFail:
    "Falha em cancelar essa oferta, por favor, tente novamente mais tarde",
  AcceptTradeFail:
    "Falha em aceitar essa oferta, por favor, tente novamente mais tarde",
  ...
  WarehouseAddRouteFail:
    "Falha ao adicionar rota: o bloco selecionado não é uma fonte válida",
  LevelN: "Nível %{level}",
  Surplus: "Surplus",
  Production: "Produção",
  Consumption: "Consumo",
  ...
  BookPublisherScienceDesc:
    "Editoras de livros produzem ciência em vez de cultura",
  ...
  ClaimTradeSuccessV2:
    "Sua negociação foi reivindicada com sucesso: %{cashOrResource}",
  ...
  AchievementsRewardToast:
    "Você reivindicou a recompensa: dinheiro suiço +%{swiss}",
  ...
  BuildWarningTitleDesc:
    "%{reason}. Tem certeza que deseja construir nesse bloco?",
  BuildWarningBuildAnyway: "Construir de qualquer maneira",
  ResourceBoosterNotWorking:
    "⛔ Impulsionadores de recursos apenas funcionam próximos a minas",
  ...
  UseScientificNotationDesc:
    "Use notação científica para números maiores que 999.9T",
  LogoutDescV2:
  ...
  BuildingUpgradeCostDividerDescV2:
    "Divide o custo da melhoria de construção por este divisor",
  ...
  SwissUpgradeDesc:
    "As atualizações suíças são permanentes e serão aplicadas se você começar em uma nova cidade",
