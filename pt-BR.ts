export const PT_BR = {
  ...
  "AlwaysTransportInputTradeCenterDesc": "Sempre transportar recursos ao centro comercial, mesmo se a venda automática estiver desabiltada para este recurso",
  ...
  "FuelCostSaveDesc": "Os armazéns economizam uma certa porcentagem de combustível para o transporte de recursos para dentro em comparação com outros edifícios, quanto mais alto o nível, mais economia",
  ...
  "StickyInputDesc": "Os edifícios irão preferir o transporte da fonte anterior, em vez de procurar a melhor fonte a cada ciclo (POLÍTICA GRATUITA)",
  ...
  "SortedByDeficit": "Classificado por déficit",
  ...
  "CancelTradeConfirmDialogDescV2": "Cancelar esta negociação irá reembolsar %{percent} do recurso / dinheiro. Os recursos serão devolvidos ao armazém do Trade Center",
  ...
  "SaveAndExitDesc": "Salvar e Sair do Jogo. Só está disponível na versão da Steam and does the same as the close button on the window bar",
  ...
  "AchievementSoftwareGiantDesc": "Construa uma Compania de Software nível 10, Indústria de Sistemas Operacionais nível 10, Compania de Banco de Dados nível 10 e um Navegado de Internet nível 10 no mesmo mapa",
  ...
  "PlayerTradeNowAllowedV2": "Trocas com jogadores não estão disponíveis por  %{hour} horas após restaurar/importar o jogo",
