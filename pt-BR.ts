export const PT_BR = {
    ...
    TradeAmount: "Quantidade de troca",
    SortBy: "Ordenar por",
    SortByPrice: "Preço",
    SortByAmount: "Quantidade",
    NotEnoughResourcesForTrade: "Não há recurso(s) suficientes no Centro Comercial para essa troca",
    ...
    Science: "Ciência",
    ScienceFromPowerDesc: "Usinas elétricas produzem uma pequena quantidade de Ciência enquanto geram energia",
    Culture: "Cultura",
    School: "Escola",
    ...
    PetrolPowerPlant: "Usina Elétrica à Petóleo",
    Copper: "Cobre",
    Gas: "Gás Natural",
    ...
    NotEnoughFuel: "%{fuel} é insuficiente para essa operação",
    ...
    TopN: "Top %{n}",
    Warehouse: "Armazém",
    TradeWarehouse: "Estoque de Mercadoria",
    Coal: "Carvão",
    Video: "Video",
    ...
    SolarPanelDesc: "💡 Painéis Solares funcionam apenas por 5 segundos a cada 10 segundos - todos os ciclos são alinhados",
    WindTurbineDesc: "💡 Turbina Eólica funcionam apenas 8 segundos a cada 10 segundos - ciclos não são alinhados",
    Movie: "Filme",
    MovieStudio: "Estúdio de filmes",
    Sitcom: "Sitcom",
    ...
    ResourceStorage: "Armazenamento",
    ResourceChange: "Alterar",
    ResourceInOutDesc: "💡 Toque nos números de Entrada-Saída acima para destacar a construção de entrada e saída correspondente",
    ...
    CoalGasificationPlant: "Planta de Gasificação de Carvão",
    ...
    NuclearPowerPlant: "Planta de Energia Nuclear",
    ...
    PanelPositionDesc: "Exibe o painel lateral na esquerda, direita ou automático (dependendo do ladrilho atualmente selecionado)",
    InputCapacity: "Capacidade de entrada",
    InputCapacityPerCycle: "Capacidade de entrada / Ciclo",
    Output: "Saída",
    OutputCapacity: "Capacidade de saída",
    OutputCapacityPerCycle: "Capacidade de saída / Ciclo",
    ResourceDeposit: "Depósito de recursos",
    RecommendedBuilding: "💡 Este ladrilho contém %{resource} de recursos",
    AdjacentBonus: "Bônus adjacente",
    AdjacentBonusDesc: "Você recebe %{bonus}% de capacidade extra para cada construção adjacente de mesmo tipo funcionando ",
    ConsiderIncreaseProduction: "💡 Considera aumentar %{resource} a procução",
    AlwaysTransportInput: "Modo acumular",
    AlwaysTransportInputTradeCenter: "Sempre exportar",
    AlwaysTransportInputTradeCenterDesc:
        "Sempre transporte recurso para o Centro Comercial, mesmo se a venda automatica estiver desabilitada para aquele recurso",
    AlwaysTransportInputDesc: "Sempre transporte recursos de entrada, mesmo se eles estiverem acima do requisito mínimo de procução",
    ProductionCycleLength: "Ciclo de Produção",
    ProductionCycleLengthDesc:
        "Duração de um ciclo de produção, medido em segundos. Alongar o ciclo irá aumentar a entrada/saída por ciclo, portanto reduzirá sua prioridade ao buscar recursos de entrada",
    MaxInputDistance: "Distância máxima de entrada",
    MaxInputDistanceDesc:
        "A distância máxima da qual esta construção irá buscar recursos de entrada, medido pelo número de ladrilhos",
    AutoSellCapacity: "Capacidade de venda automática",
    AutoSellCapacityDesc: "Quantidade máxima de recursos que a venda automática pode lidar por segundo, por recurso",
    CurrentAutoSellCapacityMultiplier: "Multiplicador atual: x%{n}",
    AutoSellConcurrency: "Venda automática simultânea",
    AutoSellConcurrencyDesc: "Número máximo de recursos que a venda automática pode lidar ao mesmo tempo",
    MaxAutoSellConcurrencyReached:
        "Você atingiu o máximo de vendas automáticas simultâneas, desative outra venda automática para ativar esta",
    CannotSellBuilding: "Não é possível vender esta construção no momento",
    WallStreet: "Wall Street",
    MarketCap: "Valor de mercado",
    MarketCapDesc: "Total de capitalização de mercado (ex: valor de mercado) de sua corporação",
    BuildingValuation: "Avaliação de Contrução",
    BuildingValuationDesc: "Valor total de suas construções, incluindo licenças e melhorias",
    ResourcesValuation: "Avaliação de Recursos",
    ResourcesValuationDesc: "Valor total de recursos em seu inventário",
    Battery: "Bateria",
