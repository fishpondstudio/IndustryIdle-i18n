export const IT = {
  ...
  NoLiquidityTurnOffAutoSell: "Non c'è abbastanza liquidità nel mercato per %{res}, la vendita automatica è stata disattivata",
  Multiplier: "Moltiplicatore",
  MultiplierDesc: "Ogni 10 livelli, guadagni +1 moltiplicazione",
  SellBuilding: "Vendi Struttura",
  PowerGrid: "Rete Elettrca",
  TradeAmount: "Quantità Dello Scambio",
  SortBy: "Ordina Per",
  SortByPrice: "Prezzo",
  ...
  Science: "Scienza",
  ScienceFromPowerDesc: "Le centrali elettriche producono una piccola quantità di punti ricerca quando generano potenza",
  Culture: "Cultura",
  School: "Scuola",
  ...
  ResourceInOutDesc: "💡 Premi sui numeri Entrata e Uscita per evidenziare le strutture di entrata e uscita corrispondenti",
  ...
  PanelPositionDesc: "Visualizza il pannello laterale a sinistra, destra o automatico( dipene dal titolo selezionato)",
  Output: "Output",
  OutputCapacity: "Capacità Di Output",
  ResourceDeposit: "Deposito Di Risorse",
  AdjacentBonus: "Bonus adiacenza",
  AdjacentBonusDesc: "Ottieni %{bonus}% in più di capacità per ogni struttura adiacente funzionante dello stesso tipo",
  ...
  AlwaysTransportInputDesc: "Trasporta sempre le risorse di input, anche se sono sotto la prodizione minima richiesta",
  ...
  AutoSellConcurrencyDesc: "Numero massimo di tipi di risorse che la vendita automatica può vendere allo stesso tempo",
  ...
  WholesaleCenterOrderFasterDesc: "Il centro delle vendite all'ingrosso riceve gli ordini due volte più velocemente e gli ordini sono 2 volte più grandi",
  ...
  RefineryMorePlasticDesc: "Le raffinerie del petrolio producono il 50% di benzina in meno e il 50% di plastica in più",
  FreeOilTransportDesc: "Il trasporto del petrolio non costa carburante, ma i pozzi petrliferi utilizzeranno il doppio dell'energia",
  SuperSteelMill: "Cuore di ferro",
  SuperSteelMillDesc: "Le acciaierie usano il 50% di carbone in meno e il 25% di ferro in più e il 25% di elettricità in più",
  ...
  ChangeName: "Cambia",
  SaveName: "Salva",
  NameValidationRule: "Il tuo nome dovrebe contenere solo lettere e numeri, e dovrebbe contenere tra i 5 e i 15 caratteri",
  ...
  AddTradeExceedMaximumTrade:
    "Puoi avere solo %{number} Scambi attivi, per favore prima reclama o cancellane uno",
  ...
  PlayerTradeQuotaExceed: "Questo scambio ha ecceduto la tua quota",
  PlayerTradeValidRange: "Raggio: %{min} ~ %{max}",
  PlayerTradeQuota: "Quota rimasta: %{value}",
  ...
  CoalMine2xOutputDesc: "Le miniere di carbone producono il doppio, ma usano il 50% di energia in più e il trasporto del carbone costa il 50% in più",
  ...
  LoggingCamp2xOutputDesc: "Le aree di disboscamento producono il doppio del legno, e il trasporto el legno costa il doppio del carburante",
  ...
  HideChatDescV2: "Nascondi i messaggi della chat dalla barra degli strumenti in basso. Vedendo i messaggi della chat, accetti i nostri ",
  ...
  ResourceExplorerDescLong: "💡 L'esploratore di risorse non ha bonus adicenza. L'uso di elettricità dipende dal tipo di risorsa",
  ...
  SteamLoginDesc: "Se possiedi i pacchetti espansione su steam puoi giocare con i pacchetti espansione dopo aver fatto il login",
  ...
  ElectricCarDesc: "Le fabbriche di auto usano batterie al posto della benzina, e richiedono solo il 50% della quantità",
  HongKongBonusV2:
  ...
  PlayerTradeNowAllowedV2: "Gli scambi con altri giocatori non sono disponibili prima di %{hour} ore dal ripristino/importo di un salvataggio",
  ServerDisconnected:
  ...
  SteamAutoCloudBackupDescV2:
    "I tuoi ultimi progressi sono salvati sullo steam cloud, e verrà sincronizzato con altri dispositivi. Il gioco fa anche un backup del tuo salvataggio ongi 10 minuti automaticamente sul cloud di steam. Puoi forzare un backup quando vuoi",
  ...
  AdjacentBonusSquareDesc: "Il bonus adiacenza è il 50% più effettivamente, ma la scala del modificatore viene modificata dal -15% al +15%",
  ...
  SteelMillx2Desc: "Le acciaierie e fonderie del metallo inossidabile hanno il doppio della capacità, ma usano il doppio dell'elettricità",
  ...
  ResearchLabCultureInputDesc: "I laboratori di ricerca hanno il doppio della capacitàm ma accettano cultura come input aggiuntivo",
  ...
  ProductionDiversificationDesc: "Ogni tipo di struttura differente ti dà l'1% in più di cpacità a tutte le strutture.",
  ...
  CrowdfundingCashInWarning: "Hai pegni di raccolte fondi in sospeso - iniziare in una nuova città te li farà perdere",
  ...
  IndustryZoneDesc: "Combina le strutture adiacenti che formano una catena di montaggio e salva permessi di costruzione",
  ...
  IndustryZoneNoAdjacentBonus: "Questa struttura fa parte di una zona industriale e non ha bonus adiacenza",
  ...
  SwissBoostDesc: "I boost svizzeri hanno effetto solo sulla partita corrente - e verranno resettati appena inizi in una nuova città",
  ...
  SwissBoostCostDividerDesc: "Dividi il costo dei boost svizzeri per questo divisore - si applica solo su upgrade di moltiplicatori/divisore",
  ...
  GreenPeacekeeperDesc: "Fai esercito, marina, aviazione, o forze spaziali solo con centrali elettriche rinnovabili(Vento/solare)",
  ...
  PlayerTradeQuotaDescV2:
    "💡 La quota è la quantità di risorse che puoi scambiare. La quantità monetaria è uguale a %{percent} della tua capitalizzazione di mercato e si resetta quando il mercato si aggiorna. Più scambi deviano dal prezzo del centro degli scambi, più quota sarà necessaria",
  ...
  YAxisStartsFromZeroDesc: "Tutti i grafici dell'asse Y inizieranno sempre da 0 invece di essere aggiustati automaticamente",
  ...
  OfflineProductionDesc: "Trasportare capacitori in questa struttura le permettono di lavorare anche mentre sei offline",
  ...
  StreamAutoApproveDesc: "Permette agli altri giocatori di vedere la tua trasmissione senza il bisogno della tua approvazione",
  ...
  StreamingPlayerRejected: "%{player} ha declinato la tua richiesta",
    StreamingPlayerRequested: "%{player} ha rischiesto di guardare la tua trasmissione, vai al quartier generale per accettare o declinare la rischiesta",
  ...
  StreamingRecordingReadyDesc: "Puoi salvare le registrazioni, e vderle con un'applicazione apposita alla riproduzione dei video",
  ...
  ExportSaveWarning:
        "NON condividere il tuo salvataggio con altri eccetto gli sviluppatori - il tuo file di salvataggio contiene gli identificatori del tuo account e permetterà ad altri giocatori di prendere il tuo account",
  FontSizeScaling: "Scala della grandezza del font",
  FontSizeScalingDesc: "Cambia la grandezza del font nell'interfaccia del giocatore. Alcuni elementi dell'interfaccia del giocatore potrebbero sembrare spostati. RICHIEDE IL RIAVVIO",
  ...
  KansasCityHydroDamBoost: "Bonus unico di Kansas City: questa diga provvede %{boost} di boost ai terreni coltivabili adiacenti",
  ...
  SaoPauloBonus:
        "<li>Tipo di carburan unico: Bio carburante</li><li>le fattorie di maiali, le stalle delle mucche e il pollaio delle galline producono anche bio carburante</li><li>Struttura unica: centrale a bio carburante</li><li>Struttura unica: Cristo Redentore</li><li>I booster delle risorse possono dare un boost maiali, mucche e galline</li><li>Le aree di isboscamento producono il doppio del legno</li><li>Le segherie hanno il doppio ella capacità</li><li>Pollo surgelato, maiale surgelato e carne in scatola hanno il doppio della quota di scambio</li>",
