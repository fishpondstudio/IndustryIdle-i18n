export const JP = {
    ...
    OK: "OK",
    SteelMill: "製鋼所",
    StainlessSteelPlant: "ステンレス合金プラント",
    CircuitFoundry: "集積回路工場",
    ...
    MarketCap: "時価総額",
    MarketCapDesc: "資源(現金含む)と施設の合計価値",
    BuildingValuation: "建物の評価",
    BuildingValuationDesc: "建築許可証やアップグレードを含む、あなたの施設の総価値",
    ResourcesValuation: "資源評価",
    ResourcesValuationDesc: "インベントリ内の資源の合計値",
    Battery: "バッテリー",
    ...
    StockRatingDesc: "株式評価は、時価総額に影響し、市場価格とともに更新されます",
    InterestRate: "金利",
    ...
    MovingAverage: "移動平均",
    MovingAverageDesc: "資源の変化をリアルタイムではなく移動平均で表示するようにしました",
    AllowZoom: "ズーム",
    ...
    FuelCostSave: "燃料費節約",
    FuelCostSaveDesc: "倉庫は他の施設より安く資源を輸入できます。この節約率はレベルが高くなるほど上がります",
    ...
    ProductionMultiplier: "生産台数",
    ProductionMultiplierDesc: "すべての施設の生産能力が向上します",
    FuelCostDiscount: "燃料費割引",
    ...
    BuildingPermitCostDivider: "建築許可費分割払い",
    BuildingPermitCostDividerDesc: "建築許可証代がこの数値で割られます",
    ...
    Production: "生産",
    Consumption: "消費",
    WarehouseInputCapacityDescV2: "この倉庫への輸送量をすべてのルートで均等にする",
    ...
    PolicyBlueprintDesc: "施設の建築は自動的には開始されず、手動で開始する必要があります(無料ポリシー)",
    ...
    ResourceBoosterSquareDesc: "リソースブースターのブースト量は25%増加しますが、科学と電力の消費量も25%増加します",
    SteelMillx2: "鉄鋼炉の近代化",
    ...
    GasPumpx2OutputDesc: "天然ガスポンプの出力が2倍になるが、消費電力は2倍になる",
    ...
    BarbariansAtTheGateDesc: "プレイヤー間トレードの取引枠が1Tになります",
