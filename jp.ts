export const JP = {
    ...
    CrAlloyUseFe: "クロム鉄",
    CrAlloyUseFeDesc: "クロム合金工場が、鉄x2+アルミx1を素材にクロムを生産します",
    ...
    BatteryFuelEconomyDesc: "バッテリーの燃料効率が100%向上する（燃料消費が50%になる）",
    ...
    GasPumpx2OutputDesc: "天然ガスポンプの出力と消費電力が2倍になります",
    ...
    ResourceBoosterSupplyChainDesc:
        "リソースブースターの効果対象の採掘場に隣接していて、その採掘場から資源を受け取っている工場も入出力がブーストされます。ただしリソースブースターは2倍の電力と科学を消費します",
    ...
    RotterdamBonusV2:
        "<li>入出力2倍 : 製鋼所</li><li>入出力2倍 : クロム製鋼材プラント</li><li>輸送無料 : 鉄</li><li>輸送半額 : 鋼材</li><li>入出力2倍 : 自動売却</li><li>ポリシー無料化 : 地球は平ら</li>",
    QuickLinks: "クイックリンク",
    GetHelp: "ヘルプ",
