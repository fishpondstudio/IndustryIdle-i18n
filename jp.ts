export const JP = {
  ...
  "ShoppingSpreeTradeCenterDesc": "💡ポリシーの「買い物三昧」が有効なのでトレードセンターは不足している資源を自動的に購入します",
  ...
  "Tutorial3": "地図上にはたくさんの<em>資源の鉱脈</em>があります。<br><br>例えば、原油の鉱脈から<em>原油</em>を取り出す<em>油井</em>があります。<br></br>資源の鉱脈は無制限なので、なくなる心配はありません。採掘場以外の施設は、どのタイルにも建てることができます",
  "Tutorial5": "また、トレードセンターから資源を購入することもできます。<br><br>市場は<em>流動的</em>で、価格📈は定期的に変化します",
  "Tutorial6": "新しい施設を建てるには、まず<em>リサーチラボ🧪</em>でアンロックする必要があります。リサーチラボでは、科学をリサーチポイントに変換することもできます。<br><br>風力発電（およびその他の発電所）は、稼働すると少量の科学を生み出します。<br><br>風力発電(やその他の発電所)は、運転中に少量の科学を生成します。ここでは、<em>現金💸</em>と<em>ガソリン⛽</em>を使って、スタートダッシュを決めましょう",
  "WelcomePlay": "ゲーム開始",
  ...
  "SiliconMine2xOutputDesc": "シリコン採掘場の生産量が2倍になり、消費電力が1.5倍に、シリコンの輸送コストが1.5倍になります",
  ...
  "Osaka": "大阪",
  "OsakaBonus": "<li>資源タイルが塊になりやすい</li><li>倉庫で50%の燃料節約が可能</li><li>ユニーク施設 : 漫画出版社</li><li>ユニーク施設 : アニメスタジオ</li><li>出力2倍 : 半導体工場</li><li>入出力2倍 : リチウムイオンバッテリー工場</li><li>アンロック済み施設 : バッテリー工場</li><li>入出力2倍 : バッテリー工場</li><li>バッテリーの燃料効率が100％向上</li><li>バッテリー工場が石炭を要求しない</li><li>開始時に100Kのバッテリーを持っている</li>",
  ...
  "HongKongBonusV2": "<li>独自の市場価格 : 市場価格と株価は正規分布に従う</li><li>市場の更新と取引枠のリセットが2倍の頻度で行われる（1時間ごと）</li><li>リサーチは取引資源量が増えるとアンロックされる</li><li>ユニーク施設 : カンフー道場</li><li>ユニーク施設 : 太極拳道場</li><li>アクティブプレイヤーの最大トレード数を50％増加</li><li>自動売却枠が+1</li><li>ユニークポリシー : 国際輸出貿易</li><li>ユニークポリシー : Pearl of the Orient</li><li>卸売センターが4種のリソースでアンロック</li><li>開始時に100Mの現金を持っている</li>",
  ...
  "LastUpdatedAt": "最終更新日",
  "DetroitBonusV3": "<li>アンロック済み施設 : エンジン工場</li><li>出力2倍 : エンジン工場</li><li>入出力2倍 : 自動車工場</li><li>自動車工場がガソリンの代わりに天然ガスを使用</li><li>輸送無料 : 自動車</li><li>ポリシー無料化 : ニコラ・テスラ</li><li>入出力2倍 : 電車工場</li>",
  ...
  "StockholmBonusV2": "<li>ユニーク施設 : 音楽プロデューサー</li><li>アンロック済み施設 : 製紙工場</li><li>ポリシー無料化 : 科学出版</li><li>入出力2倍 : 製紙工場</li><li>出力2倍 : 伐採場</li><li>出力2倍 : 半導体製IC工場</li>",
  ...
  "AchievementSoftwareGiantDesc": "同じマップにレベル10のソフトウェアメーカー、OSメーカー、データベースメーカー、Web企業を建てる",
  ...
  "GPUIsBusyDesc": "GPUが他のタスクで忙しくなっているため、OSがゲームのグラフィックを一時停止しています。ゲームを再読み込みすると再開できます。うまくいかない場合は、ゲームを再起動してみてください",
  ...
  "OsloBonusV3": "<li>アンロック済み施設 : 製油所</li><li>入出力2倍 : 製油所</li><li>ポリシー無料化 : 電気で原油輸送</li><li>入出力2倍 : ガス処理プラント</li><li>Lv4の風力発電が1個設置済み</li><li>Lv8の油井が1個設置済み</li><li>Lv2の製油所が1個設置済み</li><li>Lv2の天然ガスポンプが1個設置済み</li>",
  ...
  "ResourceBoosterSupplyChainDesc": "リソースブースターの効果が、採掘場のサプライチェーンにも付与されます。リソースブースターの科学と電力消費が2倍になります",
  ...
  "ResourceExplorer2DescV2": "リソースエクスプローラの生産量と消費電力が2倍になります。ポリシー「サプライチェーンブースター」が有効な場合はそちらの効果が優先されます",
  "NoTileModifier": "地球は平ら",
  "NoTileModifierDesc": "すべてのタイル補正が0になります。このポリシーにより、「自然の力」と「タイル補正プラス」のポリシーが無効になります",
  "DoubleTileModifierDescV2": "すべてのタイル補正をプラスもマイナスも2倍にします。このポリシーは「地球は平ら」のポリシーを無効にします",
  "TileModifierOutputOnlyDescV2": "タイル補正が出力のみに影響を与えるようになります(最大50%)このポリシーは「地球は平ら」のポリシーを無効にします",
  "QuickLinks": "クイックリンク",
  "GetHelp": "ヘルプ",
  ...
  "TotalPledgedValueDesc": "最初の支援は、全体の支援物資量にカウントされます。その後の支援は、「あなたの支援額合計」だけを増やします",
  "ReturnOnPledge": "リターン",
  ...
  "CrowdfundingAlreadyPledgedDesc": "さらに支援を提供することができます。その場合、「あなたの支援額合計」とリターンは増加しますが、全体の支援物資目標は増えません",
  ...
  "ResourceBoosterBannerDescV2": "💡 %{number}個のリソースブースターを持っています。それぞれの科学消費は、現在持っているリソースブースターの数に比例します",
  ...
  "IndustryZoneNotWorkingDesc": "隣接するすべての建物がサプライチェーンを形成し、他の産業ゾーンに属していない必要があります",
  ...
  "OfflineResearchSwissBoostDesc": "オフライン収入でリサーチポイントも得られるようになります。(リサーチラボのレベル、科学所持量、オフライン時間に依存)",
  "SanJose": "San Jose",
  ...
  "RotterdamBonusV2": "<li>入出力2倍 : 製鋼所</li><li>入出力2倍 : クロム製鋼材プラント</li><li>輸送無料 : 鉄</li><li>輸送半額 : 鋼材</li><li>自動売却量が2倍</li><li>ポリシー無料化 : 地球は平ら</li>",
