export const VN = {
    ...
    Screen: "Màn hình",
    JoinDiscord: "Mời gia nhâp máy chủ Discord của chúng tôi để tham khảo thông tin mới nhất, hướng dẫn cũng như trao đổi",
    ...
    TileModifierOutputOnlyDesc:
        "Hiệu ứng trên ô chỉ tác động lên sản lượng thành phẩm, nhưng giảm 50% hiệu quả",
