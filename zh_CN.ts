export const ZH_CN = {
    ...
    PaperMill: "造纸厂",
    Book: "书",
    BookPublisher: "出版社", //图书出版社？
    OilRefinery: "炼油厂",
    Sell: "出售",
    Upgrade: "升级",
    Build: "建造",
    Inspect: "Inspect", //完全不知道在哪
    Buildings: "建筑",
    Iron: "铁",
    Actions: "Actions", //完全不知道在哪
    FuelType: "选择燃料",
    FuelCost: "Fuel Cost", //不大确定是燃料数量消耗还是指市值
    FuelConsumption: "%{fuel} Consumption", //不大理解
    FuelEconomy: "Fuel Economy", //不大理解
    FuelProduction: "%{fuel}产量",
    FuelInStorage: "%{fuel} In Storage", //不大理解
    Plastic: "塑料",
    FuelSurplus: "%{fuel} Surplus", //不大理解
    Petrol: "汽油",
    Buy: "购买",
    NoLiquidity: "No Liquidity", //完全不知道在哪
    NoLiquidityTurnOffAutoSell: "There's not enough liquidity in the market for %{res}, auto sell has been turned off", //完全不知道在哪
    Multiplier: "倍率",
    MultiplierDesc: "每升10级，你就能+1倍率",
    SellBuilding: "输出建筑",
    PowerGrid: "电网",
    TradeAmount: "交易数量",
    SortBy: "排序方式",
    SortByPrice: "价格",
    SortByAmount: "数量",
    NotEnoughResourcesForTrade: "交易中心没有足够的资源俩进行此交易",
    NotEnoughResources: "没有足够的资源来执行此操作",
    Transportation: "交通",
    Cash: "钞票",
    Aluminum: "铝",
    ResearchPoint: "研究点数",
    ...
    Science: "科学",
    ScienceFromPowerDesc: "发电站在发电时会产生少量科学", //对于 Science 的翻译
    Culture: "文化",
    School: "学校",
    University: "大学",
    Polytechnic: "理工学院",
    ...
    AircraftFactory: "飞机厂",
    Zeppelin: "齐柏林飞艇",
    ZeppelinFactory: "齐柏林飞艇厂",
    Tank: "坦克",
    TankFactory: "坦克厂",
    MinimumTradingAmount: "不能低于最低贸易数量",
    CoalPowerPlant: "燃煤发电站",
    PetrolPowerPlant: "汽油发电站",
    Copper: "铜",
    Gas: "天然气",
    GasPump: "天然气泵",
    GasPowerPlant: "燃气发电站",
    ...
    BuildingPermitDesc:
        "您拥有%{amount}个建筑许可证，你已经使用了%{amountBuilt}个，还剩余%{amountLeft}个。",
    BuildingLocked: "建筑还不可用，你需要先在研究所中解锁",
    BuildQueue: "建造队列",
    BuildQueueDesc: "当前在建造队列中的建筑数量",
    MaxBuilders: "最多工程队数量",
    MaxBuildersDesc: "可同时建造建筑的数量",
    Silicon: "硅",
    AluminumMine: "铝矿场",
    CopperMine: "铜矿场",
    SiliconMine: "硅矿场",
    ...
    TradeCenter: "交易中心",
    Resources: "资源",
    NotEnoughPower: "💡 没有足够的电力，需要增加发电功率",
    NotEnoughFuel: "💡 没有足够的%{fuel}来执行此操作",
    NotEnoughCash: "💡 没有足够的钞票来执行此操作",
    NotEnoughSwissMoney: "💡 没有足够的瑞士金钱来执行此操作",
    BuildingNotEnoughFuel: "💡 没有足够的%{fuel}",
    AutoSell: "自动出售",
    SellAll: "全部出售",
    Change: "更改",
    ...
    FashionFactory: "时装厂",
    VideoFarm: "视频农场",
    SantaFactory: "圣诞工厂", //对 Santa 的翻译
    Santa: "圣诞老人", //对 Santa 的翻译
    Car: "汽车",
    CarFactory: "汽车厂",
    Ship: "船",
    SolarPanel: "太阳能电池板",
    SolarPanelDesc: "💡 太阳能电池板每10秒只能工作5秒-所有循环都是对齐的",
    WindTurbineDesc: "💡 风力发电机每10秒只工作8秒-循环未对齐",
    Movie: "电影",
    MovieStudio: "电影工作室",
    Sitcom: "喜剧",
    TVStudio: "电视工作室",
    ...
    Shipyard: "造船厂",
    PowerUsage: "用电",
    PowerSupply: "Power Supply", //不大理解
    PowerSurplus: "Power Surplus", //不大理解
    Level: "等级",
    Power: "电力",
    CentralBank: "中央银行",
    ResourceInput: "输入",
    ...
    ResourceStorage: "存储",
    ResourceChange: "变化",
    ResourceInOutDesc: "💡 点击在Out-In上面的数字来突显输出和输入相应资源的建筑物", //对Out-In没有翻译？
    ResourceChart: "资源视图",
    MarketUpdateIn: "市场将在%{time}后更新",
    Income: "收入",
    Semiconductor: "半导体",
    SemiconductorFactory: "半导体厂", //半导体设计厂？还是去掉设计
    SemiconductorFab: "半导体制造厂", //没见过
    Steel: "钢",
    Bitcoin: "比特币",
    BitcoinFarm: "比特币农场",
    Dogecoin: "狗子币",
    ...
    Drum: "鼓",
    DrumFactory: "鼓厂",
    RecordingStudio: "录音工作室",
    OperaHouse: "歌剧院",
    CoalGasificationPlant: "煤气化厂",
    GasProcessingPlant: "天然气处理厂",
    Music: "音乐",
    Glass: "玻璃",
    PhoneFactory: "手机厂",
    Phone: "手机",
    ...
    Titanium: "钛",
    TitaniumMine: "钛矿场",
    TitaniumAlloyPlant: "钛合金厂",
    ChromiumAlloyPlant: "铬合金厂",
    Input: "输入",
    PanelPosition: "面板位置",
    PanelPositionDesc: "在左侧、右侧或自动（取决于当前选择的地块）显示侧边面板",
    InputCapacity: "输入数量", //对 Capacity 的翻译
    InputCapacityPerCycle: "输入数量每个周期", //对 Capacity 的翻译
    Output: "输出",
    OutputCapacity: "输出数量", //对 Capacity 的翻译
    OutputCapacityPerCycle: "输出数量每个周期", //对 Capacity 的翻译
    ResourceDeposit: "Resource Deposit", //完全不知道在哪
    RecommendedBuilding: "💡 This tile has %{resource} deposit", //完全不知道在哪
    AdjacentBonus: "相邻增益",
