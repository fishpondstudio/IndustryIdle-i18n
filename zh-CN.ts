export const ZH_CN = {
    ...
    SanJose: "圣何塞",
    SanJoseBonus:
        "<li>独有建筑：芯片制造厂</li><li>独有建筑：脸簿(FaceApp)公司</li><li>独有建筑：比特币矿场</li><li>所有消耗硅的建筑拥有最大效益的地块修正</li><li>太阳能发电站2x倍发电</li><li>硅矿场2x倍产能</li>",
    RotterdamBonusV2:
    ...
    IndustryZoneMultiplierSwissBoostDescV2:
        "工业园内的每一层生产链都为本工业园内的所有建筑提供了这个产能提升",
