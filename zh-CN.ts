export const ZH_CN = {
    ...
    StPetersburg: "圣彼得堡",
    StPetersburgBonus:
        "<li>铀矿场的产出量是原来的2倍</li><li>浓缩铀加工厂的生产能力是原来的2倍</li><li>铀运输的燃料成本降低50％</li><li>免费的枪械运输</li><li>导弹工厂使用浓缩铀替代钛和铀</li>",
    Hamburg: "汉堡",
    HamburgBonus:
    ...
    Osaka: "大阪",
    OsakaBonus:
        "<li>资源倾向于成簇地生成</li><li>仓库额外提供50%的燃料节省效果</li><li>独特建筑：漫画出版社</li><li>独特建筑：动漫工作室</li><li>半导体工厂的产出量是原来的2倍</li><li>锂离子电池工厂的生产能力是原来的2倍</li><li>电池工厂已预先解锁</li><li>电池工厂的生产能力的原来的2倍</li><li>电池的燃料效率提升100%</li><li>电池工厂不需要煤</li><li>开局即有100K电池</li>",
