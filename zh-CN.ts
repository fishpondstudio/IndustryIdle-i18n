export const ZH_CN = {
    ...
    SwissBoostDesc: "瑞士加成（Swiss Boost）只会影响您当前的游戏场景,如果你在一个新城市开始,它（Swiss Boost）将会重置",
    ProductionMultipliers: "生产乘数",
    MultiplierMapUniqueBonus: "地图加成",
    MultiplierSwissUpgrade: "瑞士升级（永久）",
    MultiplierSwissBoost: "瑞士加成（在这一次游玩）",
    SwissBoostCostDivider: "瑞士加成（Swiss Boost）加成成本除数",
    SwissBoostCostDividerDesc: "降低瑞士加成（Swiss Boost）的升级成本 - 仅适用于乘数/除数升级",
    ...
    HighSpeedWarehouseDesc: "仓库运输的容量是原来的2倍，进出运输的速度提高了50%，但使用了2倍的电力",
    ...
    RandomIsland: "随机岛屿",
    RandomIslandBonus:
        "<li>地图将会在每次游戏开始前随机生成</li><li>地图大小，网格类型， 资源矿床与特殊加成均会被随机生成</li><li>重新生成有5分钟的冷却时间</li>",
    RandomIslandBonusDesc: "在随机岛屿的特殊加成将会在每次你重新生成地图时被重置",
    RandomIslandBonusCapacity: "%{building} has %{multiplier}x capacity",
    RandomIslandBonusProductivity: "%{building} 有 %{multiplier}倍的产能加成",
    RandomIslandBonusResources: "在本地图上的资源：%{deposits}",
    ValuationPerActiveMinute: "每在线分钟价值",
    Perth: "珀斯",
    GV: "地热喷口",
    GeothermalPowerPlant: "地热发电站",
    ...
    FactoryMining: "工厂采矿",
    FactoryMiningDesc: "工厂可以直接在矿场地块上采矿，前提是工厂消耗与该地块相同的矿藏资源（免费政策）",
    FactoryMiningBanner: "这个建筑正在从此地格采集 %{resource}",
    ...
    StreamingMakeMeDiscoverable: "允许其他人观看我的游玩。",
    StreamingMakeMeDiscoverableDesc:
        "允许其他玩家观看你游玩。这将会允许其他通过点对点链接观看你的游戏实况。我们不会使用你的麦克风与摄像头。",
    StreamAutoApprove: "公开流",
    StreamAutoApproveDesc: "允许玩家加入你的流，但需要批准",
    StreamingWatch: "观看",
    StreamingStop: "停止",
    StreamingPlayerDisconnected: "%{player} 停止观看你的直播",
    StreamingPlayerRejected: "%{player} 拒绝了你的观看请求",
    StreamingPlayerRequested: "%{player} 请求观看您的游戏实况，前往总部来通过（或拒绝）",
    StreamingSettings: "直播设置",
    StreamingAvailableStreams: "可以观看的直播",
    StreamingAudience: "观众数量",
    StreamingStopStream: "Stop Streaming For This Viewer",
    StreamingAcceptStream: "同意",
    StreamingRejectStream: "拒绝",
    StreamingStopStreamDesc: "Stop Streaming For This Viewer",
    StreamingConnectionFailed:
        "无法连接到此玩家，这可能是由于你的网络并不支持P2P链接",
    Pizza: "披萨",
    ...
    StreamingRecordingReady: "录制完成",
    StreamingRecordingReadyDesc: "你可以保存你的录像，并在视频播放器中播放",
    ...
    BatchModeCluster: "相连",
    BatchUpgradeToLevelX: "升到 %{level} 级",
    ApplyToBatch: "应用于%{batch}",
    BatteryRecycler: "电池回收站",
    BatteryShell: "电池壳",
    StartInANewCity: "从新城市开始",
    StartInANewCityFinePrint: "（或者在你现在的城市重新开始游戏）",
    ...
    KansasCityBonus:
        "<li>农田与温室将能产出两倍的玉米</li><li>玉米运输免费</li><li>每个级别,大坝均会为附近的农田提供可叠加的5%的加成</li><li>每有两个农田，将会获得一个免费的建筑许可</li><li>日不落政策会使农田不间断工作（包括离线）</li><li>在交易作物时将会获得两倍的玩家交易配额</li><li>食品加工厂已提前解锁</li>",
    KansasCityHydroDamBoost: "堪萨斯特殊加成：水电大坝将会为附近的农田提供 %{boost} 的加成",
    PerthGeothermalPowerPlantBoost:
        "珀斯独特加成：地热发电站将会为附近生产钢的建筑提供 %{boost} 的加成",
    PerthBonus:
    ...
    Wormhole: "虫洞",
    WavesSurvived: "已存活波数",
    NumberOfWormholes: "地图上的虫洞数量",
    NextWave: "下一波",
    NextWaveUnitHP: "单位血量",
    NextWaveTotalCount: "单位数量",
    NextWaveTotalCountDesc: "会从虫洞中生成的单位数量",
    NextWaveSpeed: "移动速度",
    NextWaveSpawnDelay: "生成频率",
