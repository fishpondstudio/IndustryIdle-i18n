export const KR = {
    ...
    PledgeSuccessful: "이 크라우드 펀딩에 %{amount}를 약속하셨습니다",
    CrowdfundingClaimSuccessful: "%{amount} 현금을 청구했습니다",
    CrowdfundingAlreadyPledged: "당신은 이미 약속했습니다",
    CrowdfundingAlreadyPledgedDesc:
        "더 많은 지원을 약속할 수 있고, 총 담보된 가치(및 잠재적 수익)가 증가하지만 크라우드 펀딩 목표에는 포함되지 않습니다",
    ...
    PanelPositionLeft: "왼쪽 (클릭시에만)",
    PanelPositionLeftFloat: "왼쪽 (항상)",
    PanelPositionRight: "오른쪽 (클릭시에만)",
    PanelPositionRightFloat: "오른쪽 (항상)",
