export const KR = {
    ...
    SanJose: "San Jose",
    SanJoseBonus:
        "<li>고유 빌딩: 칩 공장</li><li>고유 빌딩: 페이스앱 주식회사</li><li>고유 빌딩: 비트코인 광부</li><li>규소를 소비하는 모든 건물은 최대 타일 보정을 받습니다</li><li>태양광 패널 용량 2배</li><li>규소 광산 용량 2배</li>",
    RotterdamBonusV2:
        "<li>제철소 용량 2배</li><li>스테인리스 공장 용량 2배</li><li>무료 철 수송</li><li>강철 수송 연료비 50% 절감</li><li>자동 판매 용량 2배로 시작</li><li>지구는 평평하다 정책 무료</li>",
    ChipManufacturer: "칩 공장",
    SnapTokInc: "SnapTok Inc",
    FaceAppInc: "페이스앱 주식회사",
    BitcoinMiner: "비트코인 광부",
