export const KR = {
    ...
    RandomIsland: "랜덤 섬",
    RandomIslandBonus:
        "<li>이 지도는 시작할 때마다 무작위로 변경됩니다</li><li>지도 크기, 그리드 유형, 자원 매장층과 특별 보너스는 모두 무작위 생성됩니다</li><li>5분 쿨타임이 있습니다 - 재생성은 최소 5분의 간격을 두고 일어납니다</li>",
    RandomIslandBonusDesc: "랜덤 섬의 특별 보너스는 새로 시작할 때마다 매번 재생성됩니다",
    RandomIslandBonusCapacity: "%{building} 용량 %{multiplier}배",
    RandomIslandBonusProductivity: "%{building} 생산량 %{multiplier}배",
    RandomIslandBonusResources: "이 지도의 자원 매장층: %{deposits}",
    ValuationPerActiveMinute: "액티브 플레이 시간(분)당 평가",
    Perth: "퍼스",
    GV: "지열 분출구",
