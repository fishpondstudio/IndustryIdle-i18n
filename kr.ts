export const KR = {
  ...
  NoLiquidityTurnOffAutoSell:
    "시장에 %{res}에 대한 유동성이 충분하지 않습니다. 자동 판매가 꺼졌습니다.",
  Multiplier: "승수",
  ...
  BuildingLocked:
    "해당 건물을 아직 사용할 수 없습니다. 먼저 연구소에서 잠금을 해제해야 합니다.",
  MaxBuilders: "건축업자 수",
  ...
  SolarPanel: "태양광 패널",
  SolarPanelDesc:
    "💡 태양광 패널은 10초 중 5초만 작동합니다 - 모든 동작 주기가 동일합니다",
  WindTurbineDesc:
    "💡 풍력 발전소는 10초 중 8초만 작동합니다 - 동작 주기가 제각각입니다",
  Movie: "영화",
  MovieStudio: "영화 스튜디오",
  Sitcom: "시트콤",
  TVStudio: "TV 스튜디오",
  ...
  ResourceChange: "변동",
  ResourceInOutDesc:
    "💡 해당 출력 및 입력 건물을 강조 표시하려면 위의 출력-입력 수치를 누르세요",
  ...
  AdjacentBonusDesc:
    "같은 유형의 인접한 모든 작업 건물에 대해 %{bonus}% 추가 용량을 얻습니다",
  ...
  AlwaysTransportInputDesc:
    "생산에 필요한 최소량을 초과하더라도 항상 입력 자원을 전송합니다",
  ...
  MaxInputDistanceDesc:
    "건물에서 입력 자원을 가져올 수 있는 최대 거리(타일 수)",
  ...
  Icons: "아이콘",
  MisplacedBuilding:
    "⛔ 이 %{building} 은 올바른 자원 매장층 위에 배치되지 않았습니다",
  ...
  CostSaverBuildingWarning:
    "비용 절약 정책이 활성화되어 있으며 생산을 수동으로 변경할 수 없습니다",
  GlassUseCoal: "검은 유리",
  GlassUseCoalDesc:
    "유리 공장은 석탄을 50% 더 많이 사용하고 규소를 50% 더 적게 사용합니다",
  ...
  IronMine2xOutputDesc:
    "철 광산은 2배의 철을 생산하지만 철 수송에 드는 연료는 2배가 됩니다",
  SolarPanelAlwaysWork: "태양은 결코 지지 않는다",
  SolarPanelAlwaysWorkDesc:
    "태양 전지판은 항상 작동하지만 전력을 60% 적게 생산합니다",
  ...
  CrAlloyUseFe: "철크롬",
  CrAlloyUseFeDesc:
    "크롬 합금 공장은 리튬을 사용하지 않고 대신 철을 2배로 사용합니다",
  ...
  RestoreFromBackupFail:
    "Steam 클라우드에서 백업을 복원하지 못했습니다 : 백업이 있습니까?",
  ...
  SaveName: "저장",
  NameValidationRule:
    "이름은 문자와 숫자만 포함해야하며 5-15자 사이여야 합니다",
  ...
  RequireAnyExpansionPackDesc:
    "이 기능을 사용하려면 확장팩 중 하나 이상을 소유해야합니다",
  ...
  RestartDesc:
    "💡 다시 시작 하시겠습니까? 위의 새로운 도시에서 시작을 누르고 현재 도시를 선택할 수 있습니다",
  PrestigeGoBack: "돌아가기",
  ProductionMultiplier: "생산 승수",
  ProductionMultiplierDesc:
    "모든 건물의 생산 능력 향상 (광산, 공장, 발전소, 과학 및 문화 건물 포함)",
  ...
  ExtraAdjacentBonusDesc:
    "같은 유형의 인접한 모든 동작중인 건물에 대한 추가 보너스 용량",
  ...
  LoadGameErrorDesc:
    "인터넷 연결을 확인하십시오. 문제가 지속되면 지원팀에 문의하십시오",
  ExpansionPackIncompatible:
    "확장팩이 있는 저장 파일을 가져오지만, 게임에 필요한 확장팩이 없습니다",
  CashIn: "청산한다",
  CurrentCity: "현재 도시",
  CashInDesc:
  ...
  AddTradeExceedMaximumTrade:
    "최대 %{number}개의 거래만 활성화 할 수 있습니다. 먼저 하나를 청구하거나 취소하십시오",
  ...
  PlayerTradeUnavailable:
    "사용자와 거래하기 전에 생산 및 보관에 최소한 하나의 자원이 있어야 합니다",
  PlayerTradeToClaim:
    "사용자 간 거래에서 청구할 새로운 거래가 %{num}개 있습니다",
  PowerBank: "보조 배터리",
  ...
  PowerBankMoreCapacityDesc:
    "보조 배터리는 50% 속도로 충전되지만 용량은 50% 더 많습니다",
  PowerBankNotWorking: "⛔ 보조 배터리는 발전소 옆에서만 작동합니다",
  ColorTheme: "게임 색상 테마",
  ColorThemeDesc:
    "게임 아이콘, 하이라이트, 그리드 및 배경에 대한 색상 테마. 다시 로드해야 합니다.",
  ...
  AlMine2xOutputDesc:
    "알루미늄 광산은 2배의 알루미늄을 생산하고 2배 더 많은 전력을 사용합니다",
  LoggingCamp2xOutput: "삼림 벌채",
  LoggingCamp2xOutputDesc:
    "벌목소는 2배의 나무를 생산하고 나무 운송 비용이 2배가 됩니다",
  PowerBankLeft: "보조 배터리",
  ColorThemeEditor: "색상 테마 편집기",
  ColorThemeEditorDesc:
    "현재 테마의 색상을 재정의 할 수 있습니다. 현재 %{num}개의 재정의가 있습니다",
  ...
  WindTurbineAlwaysWorkDesc:
    "풍력 터빈은 100% 동작하지만 30% 적은 전력을 생산합니다",
  ...
  HideChatDescV2:
    "하단 툴바에서 채팅 메시지를 숨깁니다. 채팅 메시지를 표시함으로써 동의합니다",
  ...
  ResourceExplorerDescLong:
    "💡 자원 탐색가는 인접 보너스가 없습니다. 전력 사용량은 자원마다 다릅니다.",
  ...
  PlayerTradeOptOut:
    "리더 보드를 탈퇴했습니다. 다른 플레이어와 거래할 수 없습니다",
  FirstTimeReadGuide:
    "💡 게임 방법에 대해 약간의 도움이 필요하십니까? 눌러서 초보자 가이드를 읽어보세요!",
  ReadSteamGuideV2: "게임 가이드",
  ReadSteamGuideV2Desc:
    "Steam에서 커뮤니티가 만든 가이드를 읽을 수 있으며 자신만의 가이드를 만들 수도 있습니다.",
  ...
  SteamLoginDesc:
    "Steam에서 확장팩을 소유하고 있다면 로그인 후 웹에서 확장팩으로 플레이할 수 있습니다",
  SteamLoginYes: "로그인",
  ...
  AchievementHamburg1000Desc:
    "함부르크에서 한 번의 실행으로 1000 스위스 돈 벌기",
  ...
  ElectricCar: "니콜라 테슬라",
  ElectricCarDesc:
    "자동차 공장은 휘발유 대신 배터리를 사용하며 50%의 양만 필요합니다",
  HongKongBonusV2:
  ...
  PlasticFiberDesc:
    "섬유 공장은 플라스틱을 50% 많게 유리는 50% 적게 사용합니다",
  NewsEffectx2: "기자 회견",
  ...
  PlayerTradeNowAllowedV2:
    "저장을 복원/가져오기 후 %{hour}시간 이내에는 플레이어 거래를 사용할 수 없습니다",
  ServerDisconnected:
  ...
  ResearchLabCultureInputDesc:
    "연구소의 용량이 2배가 되지만, 문화를 추가로 사용합니다",
  GasPumpx2Output: "고압 가스 펌프",
  GasPumpx2OutputDesc:
    "천연가스 펌프의 생산량이 2배지만 전력도 2배로 사용합니다",
  ...
  MapExtraPermitDesc:
    "지도의 고유 보너스로 %{number}개의 무료 건축 허가를 받습니다",
  OsloBonusV3:
  ...
  ResourceBoosterPercentageV2:
    "💡 여기에는 인접한 자원 촉진기의 %{percent} 촉진효과가 포함됩니다",
  MapleSyrup: "메이플 시럽",
  MapleSyrupFactory: "메이플 시럽 공장",
  SyrupPlastic: "시럽 플라스틱",
  SyrupPlasticDesc:
    "플라스틱이 들어가는 모든 건물은 메이플 시럽을 대신 사용합니다",
  ...
  ProductionDiversificationDesc:
    "각자 다른 유형의 건물은 모든 건물에 1% 추가 용량을 제공합니다",
  ExtraPolicyPointsDescV2:
    "정책 센터는 2 배의 정책 포인트 전환 능력을 가지고 있습니다",
  PowerRequired: "전력 필요",
  ...
  AchievementVancouver1000Desc:
    "밴쿠버에서 한 번의 실행으로 1000 스위스 돈 벌기",
  BarbariansAtTheGate: "문 앞의 야만인들",
  BarbariansAtTheGateDesc:
    "시장 업데이트 사이에 1T 상당의 플레이어 거래 한도 사용",
  ...
  IndustryZone: "산업 구역",
  IndustryZoneDesc:
    "공급체인을 형성하는 인접 건물들을 결합하고 건축 허가를 절약합니다",
  ...
  IndustryZoneNoAdjacentBonus:
    "산업 구역에 포함된 건물은 인접 보너스를 받지 못합니다",
  ...
  SwissUpgradeDesc:
    "스위스 업그레이드는 영구적이며 새로운 도시에서도 지속됩니다",
  SwissBoost: "스위스 부스트",
  SwissBoostDesc:
    "스위스 부스트는 현재 도시에서만 유효하며, 새로운 도시에서는 사라집니다",
  ...
  GreenPeacekeeperDesc:
    "재생 가능한 발전소(풍력/태양광)만으로 육군, 해군, 공군 또는 우주군 만들기",
  ...
  OfflineEarningDescV2:
    "오프라인 수익은 현재 연구, 생산 및 자동판매에 영향받습니다",
  HighSpeedWarehouse: "고속창고",
  HighSpeedWarehouseDesc:
    "고속창고는 2배의 용량과 50% 더 빠른 입출력 속도를 갖는 대신 2배의 전기를 소모합니다",
  ...
  IndustryZoneBuildingPermitDesc:
    "산업 구역이 총 N티어의 생산단계를 포함하면, N-2개의 무료 건축 허가를 제공합니다",
  ...
  PumpkinBatteryDesc:
    "배터리를 소비하는 모든 건물은 호박을 대신 사용합니다 (무료 정책)",
  PumpkinSteel: "호박 강철",
  PumpkinSteelDesc:
    "강철을 소비하는 모든 건물은 호박을 대신 사용합니다 (무료 정책)",
  ...
  ReindeerSiliconDesc:
    "규소를 소비하는 모든 건물은 순록을 대신 사용합니다 (무료 정책)",
  ReindeerAluminum: "순록 알루미늄",
  ReindeerAluminumDesc:
    "알루미늄을 소비하는 모든 건물은 순록을 대신 사용합니다 (무료 정책)",
