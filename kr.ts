export const KR = {
    ...
    TileModifierOutputOnlyDesc:
        "타일 보정은 입력과 출력이 아닌 출력에만 영향을 주지만 50% 만 효과적입니다",
    ...
    FPS30: "에너지 절약",
    OfflineModeDesc:
        "서버에 연결할 수 없습니다 : 오프라인 수입이 생성되지 않습니다. 인터넷 연결을 확인하십시오",
    OptOut: "옵트 아웃",
    OptIn: "재설정 및 활성화",
    ...
    BuildingInProgressCannotPrestige:
        "건물 공사가 진행 중입니다. 완료될 때까지 새로운 도시에서 시작할 수 없습니다",
    ...
    HideResourceMovementDesc:
        "기본적으로 자원 이동(작은 점)을 숨기고 건물을 선택할 때만 이동을 표시합니다",
