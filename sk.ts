export const SK = {
  ...
  "BuildingPermitDesc": "You have permits for %{amount} buildings, you have already built %{amountBuilt} and have %{amountLeft} left",
  ...
  "ProductionCycleLengthDesc": "Duration of one production cycle, measured in seconds. Lengthening the cycle will increase the input/output per cycle accordingly thus lowering its priority when fetching input resources",
  "MaxInputDistance": "Max Input Distance",
  "MaxInputDistanceDesc": "The maximum distance this building can fetch input resources from, measured in number of tiles",
  ...
  "MaxAutoSellConcurrencyReached": "You have reached maximum auto sell concurrency, turn off another auto sell to enable this one",
  ...
  "StockRatingDesc": "Stock rating consensus from Wall Street analysts, which affects your market cap and is updated together with the market",
  ...
  "TurnOffProductionDesc": "Turn off the building's production. The building will no longer transport resources and use power",
  ...
  "RejectOrder": "Pass",
  "WholesaleCenterLocked": "You need at least %{required} different resources to unlock Wholesale Center. You only have %{current} resources",
  ...
  "CostSaverBuildingDesc": "Cost Saver policy is active, production will turn on/off automatically based on its profitability",
  ...
  "AdjacentBonusOnlyOutputDesc": "Adjacent bonus does not require more input but uses more power and is only 50% as effective",
  ...
  "ShoppingSpreeDesc": "If a resource's output capacity falls short, buy the shortage amount from Trade Center automatically (If the resource has auto sell on, it will be ignored)",
  "ShoppingSpreeTradeCenterDesc": "💡 Shopping Spree policy is on, Trade Center will automatically buy resources in shortage",
  ...
  "FPS30Desc": "Turning on energy saving mode will run the game at 30FPS instead of 60FPS. This will make your battery last longer",
  ...
  "CashInDesc": "You will get this amount to your Swiss bank account if you start in a new city. It is based on your company's market cap and it must reach %{amount} before you can earn Swiss Money",
  "CitySize": "Map Size",
  "GridType": "Grid Type",
  ...
  "Detroit": "Detroit",
  "Boston": "Boston",
  "BostonBonus": "<li>Start with level 5 research lab</li><li>Polytechnics are unlocked</li><li>Polytechnics have 2x capacity</li><li>Schools have 2x capacity</li><li>Universities have 2x productivity</li>",
  ...
  "AddTradeExceedMaximumTrade": "You can only have maximum %{number} active trades, please claim or cancel one of them first",
  ...
  "PlayerTradeUnavailable": "You need to have at least one resource in production and in storage before you can trade with players",
  ...
  "TaiChi10xCultureDescV2": "Free Kung-fu and Tai-chi transportation. Movie studios have 2x capacity but use 50% more power",
  ...
  "AutoSellResourceWarningDesc": "You are auto selling this resource, the amount stored in the Trade Center cannot be used here",
  ...
  "SellBuildingDescV2": "Selling a building will refund you %{percent} of your investment and %{percent} of the resources will be transported to the Trade Center",
  ...
  "WholesaleCenterProducingOnlyDesc": "Wholesale center orders only contain resources that are from the top-half of your most-advanced researched products (which has to satisfy the minimum resources requirement)",
  ...
  "IndustryZoneNotWorkingDesc": "All of its adjacent buildings should form a supply chain, are max Level %{level} and are not part of other industry zones",
