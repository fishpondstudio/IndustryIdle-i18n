export const ZH_HK = {
  ...
  StockRatingDesc:
    "嚟自華爾街分析師嘅股票評級共識，佢會影響您嘅市值而且一齊同市場更新",
  OfflineEarning: "離線收入",
  PerMin: "%{amount}/分鐘",
  ...
  MusicDesc:
    "打開音樂: Shane Ivers (https://www.silvermansound.com)嘅《It's Not Over 'Til The Bossa Nova》",
  Credits: "鳴謝",
  Icons: "圖標",
  ...
  WholesaleCenterLocked:
    "您至少要%{required}種唔同嘅資源嚟解鎖批發所。您得%{current}種資源",
  ...
  ShoppingSpree: "瘋狂買嘢",
  ShoppingSpreeDesc:
    "如果資源唔夠輸出量，就喺交易所度自動買入缺嘅 (如果嗰啲資源有開自動賣出，就會被忽略)",
  ...
  RestoreFromBackupDesc:
    "通常您都唔使喺雲端備份度還原，除非唔見咗本機存檔。雲端備份會舊過本機存檔少少",
  ChangeName: "改名",
  SaveName: "儲存",
  ...
  FPS30Desc:
    "打開慳電模式會令遊戲用30FPS代替60FPS嘅更新率嚟郁。會令您用耐啲電池",
  ...
  HideRewardAd: "收埋獎勵廣告",
  HideRewardAdDesc:
    "全部喺遊戲入面嘅廣告都係有得揀嘅獎勵廣告。呢個會喺遊戲度收埋晒佢哋嘅選項。",
  ...
  ProductionMultiplierDesc:
    "提高您全部建築嘅產量 (包括礦場、工廠、發電廠、科學同文化建築)",
  ...
  PrestigeAlertContent:
    "您嘅公司會被清算。您會有 %{amount}瑞士錢而且喺 %{city}成立新公司",
  PrestigeCurrencyDesc:
    "呢個係您喺秘密瑞士銀行帳戶嘅錢，您可以帶埋佢喺一個新城市重新嚟過",
  Prestige: "過數",
  Cancel: "取消",
  ...
  AddTradeExceedMaximumTrade:
    "您最多淨係可以有 %{number}單交易緊，攞或者取消其中一個先",
  ...
  ReadSteamGuideV2Desc:
    "您可以喺Steam度睇社群創建嘅指南 — 而且您都可以創建您自己嘅",
  ...
  SteamLoginDesc:
    "如果您喺Steam度有擴展包，登入咗之後您就可以喺Web度同擴展包玩",
  SteamLoginYes: "登入",
  SteamLoginNo: "刪&重新嚟過",
  KungFuDojo: "功夫館",
  KungFu: "功夫",
  ...
  ChatForceScroll: "強制轆",
  ChatForceScrollDesc:
    "如果開咗強制轆，聊天室喺有新訊息嗰陣都會轆。唔係嘅話淨係喺您已經喺底嗰陣佢先會轆",
  ...
  SellBuildingDescV2:
    "賣建築物會退返您投資嘅%{percent}同%{percent}資源會被送到交易所",
  ...
  AchievementSoftwareGiantDesc:
    "起10級軟件公司、10級操作系統公司、10級數據庫公司同10級網頁瀏覽器喺同一張地圖",
  AchievementSpaceRace: "太空競賽",
  AchievementSpaceRaceDesc:
    "起10級火箭工廠、10級衛星工廠、10級太空船工廠同10級太空站工廠喺同一張地圖",
  AchievementToTheMoon: "去月球",
  AchievementToTheMoonDesc:
    "起40級比特幣農場同40級狗狗幣農場。有1B比特幣同1B狗狗幣",
  ItsAllGreen: "都係綠色",
  ...
  LogoutDescV2:
    "您喺另一個設備度登入咗，呢個設備登出咗。您可以登入返但其他設備會被登出",
  LogBackIn: "登入返",
  ...
  GPUIsBusy: "您嘅GPU忙緊",
  GPUIsBusyDesc:
    "您嘅操作系統停咗遊戲畫面因為GPU忙/亡喺其他程序。您可以重新入過遊戲嚟繼續。如果冇用就重新開過",
  ...
  NoTileModifierDesc:
    "全部板塊加成係0%。呢個政策會停大自然嘅力量同板塊加成+政策",
  DoubleTileModifierDescV2:
    "全部板塊加成效果2倍 — 好同唔好。呢個政策會停地球係平嘅政策",
  TileModifierOutputOnlyDescV2:
    "板塊加成淨係影響輸出取代輸出同輸入但係得50%效果。呢個政策會停地球係平嘅政策",
  QuickLinks: "快速鏈接",
  GetHelp: "搵幫手",
  ...
  TotalPledgedValueDesc:
    "您嘅第一單贊助計入眾籌目標。之後嘅贊助加落總贊助值但唔會計入眾籌目標。",
  ReturnOnPledge: "贊助報酬",
  ...
  WholesaleCenterProducingOnlyDesc:
    "批發所訂單淨係包含研究過頭半先進嘅產品 (有滿足最少要求量嘅資源)",
  ...
  ResourceBoosterBannerDescV2:
    "💡 您而家有 %{number}座資源加速器 — 每個科學輸入跟您而家有資源加速器嘅量",
  ...
  IndustryZoneNotWorkingDesc:
    "全部喺佢隔離嘅建築應該整條供應鏈，都係最高級 %{level}，而且都唔包喺其他工業區入面",
  ...
  GreenPeacekeeperDesc:
    "俾陸軍、海軍、空軍或者太空軍得可再生發電廠(風力/太陽能) 用",
  DotComTycoon: "互聯網(DotCom)大亨",
  DotComTycoonDesc:
    "起10級社交網絡公司、10級搜索引擎公司、10級 SkyNet 公司同10級 Musify 公司喺同一張地圖",
