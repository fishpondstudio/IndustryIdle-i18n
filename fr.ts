export const FR = {
    ...
    LiionBatteryFactory: "Usine de batterie Li-ion",
    ...
    PlayerTrade: "Échange de Resources En Ligne",
    ...
    LoadTradeFail: "Échec du chargement des échanges de joueurs, veuillez réessayer plus tard",
    ClaimTradeFail: "Échec de la récuperation de cette transaction, veuillez réessayer plus tard",
    ...
    CancelTradeFail: "Échec de l'annulation de cet échange, veuillez réessayer plus tard",
    AcceptTradeSuccess: "Ce échange a été accepté par vous: %{resource} a été ajouté à votre centre d'échange",
    ...
    PlayerTradeToClaim: "Vous avez %{num} nouveau(s) commerce(s) à réclamer dans le centre d'échange",
    PowerBank: "Batterie",
    ...
    PowerBankNotWorking: "⛔ Les batteries fonctionnent qu'à côté d'une centrale électrique",
    ExcludeBuildingsShutdown: "Exclure les bâtiments qui sont fermés",
    ColorTheme: "Thème de couleur du jeu",
    ColorThemeDesc: "Thème de couleur pour les icônes de jeu, la mise en évidence, la grille et l'arrière-plan. REQUIERT UN REDEMARAGE",
    WarehouseBuildDesc: "le transport et le stockage de toutes les ressources coute moins de carburant",
};
