export const FR = {
  ...
  MaxBuildersDesc:
    "Nombre de bâtiments que vous pouvez construire en même temps",
  Silicon: "Silicium",
  ...
  AdjacentBonusDesc:
    "Vous obtenez %{bonus}% capacité supplémentaire pour chaque bâtiment adjacent du même type",
  ...
  AutoSellConcurrencyDesc:
    "Nombre maximum de ressources que la vente automatique peut gérer en même temps",
  ...
  BuildingValuationDesc:
    "Valeur totale de vos bâtiments, y compris les permis de construire et les améliorations",
  ...
  OfflineEarningTimeDesc:
    "Vous gagnerez des revenus hors ligne jusqu'à avoir atteind ce seuil",
  ...
  Icons: "Icônes",
  MisplacedBuilding:
    "⛔ Le %{building} n'est pas placé au-dessus du bon gisement de ressources",
  ...
  HighlightMaxInputDistanceNotDefault:
    "...qui ont une distance d'entrée maximale < ∞",
  ...
  InputStrategyCloseDesc:
    "Préférez l'entrepôt le plus proche qui dispose de suffisamment de ressources",
  InputStrategyFar: "Le plus loin",
  InputStrategyFarDesc:
    "Préférez l'entrepôt le plus éloigné qui dispose de suffisamment de ressources",
  ...
  Screen: "Écran",
  JoinDiscord:
    "Rejoignez notre serveur Discord pour les dernières mises à jour, conseils et discussions",
  ...
  EffectiveTimeDesc:
    "La durée effective de vos gains hors connexion est plafonnée à %{time}min.",
  BuildSearchPlaceholder: "🔎 Rechercher le bâtiment",
  MineOverlayWarning:
    "%{building} n'est pas affecté par le modificateur de tuile",
  ...
  PolicyPointDesc:
    "💡 Plus les stratégies sont actives, plus le coût de chaque stratégie est élevé",
  ...
  NewOrder:
    "Une nouvelle commande de %{from} est arrivée, veuillez vous enregistrer dans ",
  Policies: "Stratégies",
  PolicyNotEnoughTime:
    "Vous ne disposez pas de suffisamment de points de stratégie pour cette stratégie",
  ...
  PolicyOilWellPowerx2Desc:
    "Les puits de pétrole produisent 2x de pétrole et utilisent 2x de courant",
  HalfTransportSpeed: "Ralentissez pour économiser",
  HalfTransportSpeedDesc:
    "La vitesse de transport est ralentie de 25% et le coût du carburant est réduit de 25%",
  RefineryMoreOil: "Plus d'essence, moins de problèmes",
  RefineryMoreOilDesc:
    "Les raffineries de pétrole produisent 50% plus d'essence et 50% moins de plastique",
  RefineryMorePlastic: "Plus de plastique, moins de problèmes",
  RefineryMorePlasticDesc:
    "Les raffineries de pétrole produisent 50% moins d'essence et 50% plus de plastique",
  ...
  SuperSteelMillDesc:
    "Les aciéries utilisent 50% moins de charbon et 25% plus de fer et 25% plus d'énergie",
  AlSemiconductor: "Circuit AI",
  AlSemiconductorDesc:
    "Les fonderies de circuits utilisent de l'aluminium au lieu du cuivre",
  CostSaver: "Économiseur de coûts",
  CostSaverDesc:
    "Si les intrants d'un bâtiment coûtent plus cher que sa production, arrêtez la production",
  ...
  GlassUseCoalDesc:
    "Les usines de verre utilisent 50% plus de charbon et 50% moins de silicium",
  ...
  SolarPanelAlwaysWorkDesc:
    "Le panneau solaire fonctionne 100% du temps mais produit 60% moins d'énergie",
  SteelScience: "La connaissance à travers l'acier",
  SteelScienceDesc:
    "Les aciéries utilisent 2x intrants et produisent des données scientifiques supplémentaires",
  ...
  CrAlloyUseFeDesc:
    "Les usines d'alliage de chrome n'utilisent pas de lithium mais utilisent plutôt 2x fer",
  ...
  GasPlantPetrolDesc:
    "Les centrales au gaz utilisent du gaz supplémentaire pour produire de l'essence",
  CoalPlantFuel: "Charbon liquide",
  CoalPlantFuelDesc:
    "Les centrales au charbon utilisent du charbon supplémentaire pour produire de l'essence",
  Welcome: "Bienvenue",
  ...
  ChatMessageRateLimit:
    "Vous ne pouvez envoyer un nouveau message de discussion que toutes les 10 secondes",
  NameSaved: "Votre nom a été modifié avec succès",
  NoMessages: "Aucun nouveau message",
  Leaderboard: "Classement",
  Name: "Nom",
  Tips1:
    "Les notations des actions ont 5 niveaux: acheter, sur-performer, conserver, sous-performer et vendre",
  Tips2:
  ...
  SwissMoney: "%{money} 💵",
  PrestigeDesc:
    "Si vous commencez dans une nouvelle ville, vous obtiendrez %{money} 💵",
  ...
  RequireExpansionPack1Desc:
    "Ceci n'est disponible que pour le pack d'extension 1",
  RequireAnyExpansionPack: "Packs d'extension exclusifs",
  RequireAnyExpansionPackDesc:
    "Cette fonctionnalité vous oblige à posséder au moins un des packs d'extension",
  ...
  HideDiscordBannerDesc:
    "Masquer Discord et la bannière de la vitrine dans le siège social",
  ...
  FuelCostDiscountDesc:
    "Donne une réduction sur le coût du carburant lors du transport des ressources",
  ...
  BuildingPermitCostDividerDesc:
    "Divisez le coût du permis de construire par ce diviseur",
  ...
  ClaimTradeFail:
    "Échec de la récupération de cet échange, veuillez réessayer plus tard",
  CancelTradeSuccess: "Votre transaction a été annulée avec succès",
  CancelTradeFail:
    "Échec de l'annulation de cette transaction, veuillez réessayer plus tard",
  AcceptTradeFail:
    "Échec de l'acceptation de cet échange, veuillez réessayer plus tard",
  ...
  FailedToImportSaveDesc:
    "Votre fichier de sauvegarde est incompatible ou corrompu: %{error}",
  SaveCopiedToClipboard:
    "Vos données de sauvegarde ont été copiées dans votre presse-papiers",
  CancelActiveTradeFirst:
    "Vous avez des échanges actifs, veuillez d'abord les annuler / les réclamer",
  ...
  PlayerTradeToClaim:
    "Vous avez %{num} nouveau(x) commerce(s) à réclamer dans le centre d'échange",
  PowerBank: "Batterie",
  PowerBankBuildDesc:
    "Stockez l'énergie en trop et fournissez de l'électricité en cas de pénurie",
  WarehouseBuildDesc:
    "le transport et le stockage de toutes les ressources coûte moins de carburant",
  ...
  PowerBankMoreCapacityDesc:
    "Les batteries se chargent à une vitesse de 50% mais ont 50% de capacité en plus",
  PowerBankNotWorking:
    "⛔ Les batteries ne fonctionnent qu'à côté d'une centrale électrique",
  ...
  AlMine2xOutputDesc:
    "Les mines d'aluminium produisent 2x aluminium mais utilisent 2x plus d'électricité",
  LoggingCamp2xOutput: "Chantier forestier",
  LoggingCamp2xOutputDesc:
    "Les camps forestiers produisent 2x bois mais utilisent 2x plus de carburant",
  ...
  HideChatMentionsDesc:
    "Masquer la bulle de notification et rendre muet lorsqu'un message du chat me mentionne",
  AcceptTradeFailRateLimit:
    "Vous pouvez seulement accepter un échange toutes les %{time} secondes",
  ...
  WarehouseAddRouteFail:
    "Échec de l'ajout de l'itinéraire: la case sélectionnée n'est pas une source valide",
  LevelN: "Niveau %{level}",
  Surplus: "Surplus",
  Production: "Production",
  Consumption: "Consommation",
  WarehouseInputCapacityDescV2:
    "Capacité totale de transport entrant, répartie également entre tous les itinéraires",
  ...
  WindTurbineAlwaysWorkDesc:
    "Les éoliennes fonctionnent 100% du temps mais produisent 30% d'énergie en moins",
  BookPublisherScience: "Littérature scientifique",
  BookPublisherScienceDesc:
    "Les éditeurs de livres produisent de la science au lieu de la culture",
  BatteryFuelEconomy: "Batterie rechargeable",
  BatteryFuelEconomyDesc:
    "Le carburant via les batteries s'améliore de 100% (soit 50% du coût du carburant)",
  ShowTheoreticalInputOutputCapacity:
    "Afficher la capacité d'entrée/sortie théorique",
  ...
  ClaimTradeSuccessV2:
    "Votre transaction a été réalisée avec succès : %{cashOrResource}",
  AcceptTradeSuccessV2:
    "Cet échange a été accepté par vous : %{cashOrResource}",
  ResourceExplorer: "Explorateur de ressources",
  ResourceExplorerDesc:
    "Permet d'extraire des ressources d'un carreau de carte vide.",
  ...
  PlayerTradeAmountNotValidV2:
    "Le montant minimum de transaction autorisé est de 1",
  PlayerTradeOptOut:
  ...
  ChatMessageTooLong:
    "Votre message de chat a dépassé le nombre maximal de caractères autorisé",
  ...
  AchievementsToast:
    "Vous avez atteint %{name}, réclamez votre récompense au quartier général",
  AchievementStockholm100: "Viking débutant",
  AchievementStockholm100Desc:
    "Gagner 100 Franc Suisse à Stockholm en une seule partie",
  AchievementStockholm500: "Viking diplômé",
  AchievementStockholm500Desc:
    "Gagner 500 Franc Suisse à Stockholm en une seule partie",
  AchievementStockholm1000: "Viking expérimenté",
  AchievementStockholm1000Desc:
    "Gagnez 1000 Franc Suisse à Stockholm en une seule partie",
  ...
  SettingsFullScreenDesc:
    "Exécutez le jeu en mode plein écran. Disponible uniquement pour la version Steam",
  ...
  PlayerTradePriceNotValidV2:
    "Le prix de la transaction doit être compris entre %{min} et %{max}.",
  ...
  PlasticFiberDesc:
    "Les usines de fibres utilisent 50 % de plastique en plus, mais 50 % de verre en moins.",
  NewsEffectx2: "Conférence de presse",
  NewsEffectx2Desc:
    "L'effet des nouvelles du marché double, tant positif que négatif",
  ...
  BuilderMoveSpeedDesc:
    "La vitesse à laquelle les constructeurs se déplacent pour construire des bâtiments",
  ...
  BuildWarningTitleDesc:
    "%{reason}. Vous êtes sûr de vouloir construire sur cette tuile?",
  BuildWarningBuildAnyway: "Construire quand même",
  ResourceBoosterNotWorking:
    "⛔ Les boosters de ressources ne fonctionnent qu'à côté des mines de dépôt",
  ...
  BuildingUpgradeCostDivider:
    "Diviseur de coûts pour l'amélioration des bâtiments",
  ...
  ItsAllGreenDesc:
    "Disposer de 50 lignes de production et d'aucun déficit de production",
  DeepInRed: "Rouge profond",
  DeepInRedDesc:
    "Avoir 50 lignes de production qui ont un déficit de production",
  UseScientificNotation: "Utiliser la notation scientifique",
  UseScientificNotationDesc:
    "Utiliser la notation scientifique (notation e) pour les nombres supérieurs à 999,9T",
  LogoutDescV2:
  ...
  BuildingUpgradeCostDividerDescV2:
    "Divisez le coût d'amélioration du bâtiment par ce diviseur",
  ...
  ChangeNameCooldown:
    "Vous ne pouvez changer votre nom qu'une fois toutes les %{hour} heures",
  ...
  FuelDynamiteDesc:
    "Les usines de dynamite utilisent votre carburant actuel au lieu du pétrole.",
  StPetersburgBonusV2:
  ...
  BuildingPermitsNeededDesc:
    "Ce bâtiment ne fonctionne pas car vous n'avez pas assez de permis de construire.",
