export const DE = {
  ...
  ScienceFromPowerDesc:
    "Stormerzeuger produzieren eine kleine Menege Wissenschaftspunkte, falls sie Strom erzeugen",
  Culture: "Kultur",
  School: "Schule",
  ...
  BuildingLocked:
    "Das Gebäude ist noch nicht verfügbar, du musst es zuerst im Forschungslabor freischalten",
  ...
  SolarPanelDesc:
    "💡 Solarmodule arbeiten nur 5 von 10 Sekunden - alle Kreisläufe sind verbunden",
  WindTurbineDesc:
  ...
  AlwaysTransportInputDesc:
    "Transportiere benötigte Ware immer, auch wenn es mehr ist als benötigt",
  ...
  AutoSellCapacityDesc:
    "Maximale Anzahl an Ressourcen die automatisch verkauft werden können pro Sekunde/Ressource",
  ...
  AutoSellConcurrencyDesc:
    "Maximale Anzahl der Ressourcen die gleichzeit automatisch verkauft werden können",
  ...
  BuildingValuationDesc:
    "Gesamtwert deiner Gebäude, inklusive Baugenehmigungen und Aufwertungen",
  ...
  OfflineEarningTimeDesc:
    "Du erhältst Offline Einkommen bis zu diesem Schwellenwert",
  ...
  AutoHighlightDesc:
    "Markieren Sie automatisch Gebäude desselben Typs, wenn Sie ein Gebäude auswählen",
  MusicDesc:
    "Musik einschalten: It's Not Over 'Til The Bossa Nova by Shane Ivers (https://www.silvermansound.com)",
  Credits: "Credits",
  Icons: "Symbole",
  MisplacedBuilding:
    "⛔ Das %{building} wird nicht auf die richtige Ressource gelegt",
  ...
  HighlightMaxInputDistanceNotDefault:
    "...haben die maximale Eingangsentfernung < ∞",
  ...
  InputStrategyCloseDesc:
    "Bevorzugen Sie das nächstgelegene Lager mit genügend Ressourcen",
  InputStrategyFar: "Weiter",
  InputStrategyFarDesc:
    "Bevorzugen Sie das am weitesten entfernte Lager mit genügend Ressourcen",
  ...
  Screen: "Bildschirm",
  JoinDiscord:
    "Besuchen Sie unseren Discord-Server, um die neuesten Updates, Tipps und Diskussionen zu erhalten",
  ...
  EffectiveTimeDesc:
    "Ihre effektive Offline-Verdienstzeit ist begrenzt %{time}min.",
  BuildSearchPlaceholder: "Geben Sie Gebäude oder Ressource für die Suche ein",
  MineOverlayWarning:
    "%{building} wird vom Zellenmodifikator nicht beeinflusst",
  ...
  PolicyPointDesc:
    "💡 Je mehr Richtlinien aktiv sind, desto höher sind die Kosten für jede Richtlinie",
  ...
  NewOrder:
    "Eine neue Bestellung von %{from} ist angekommen, nachzusehen im  Großhandelszentrum",
  Policies: "Richtlinien",
  PolicyNotEnoughTime:
    "Sie haben nicht genügend Richtlinienpunkte für diese Richtlinie",
  ...
  PolicyOilWellPowerx2Desc:
    "Ölquellen produzieren 2x Öl und 2x verbrauchen Strom",
  ...
  RefineryMoreOilDesc:
    "Ölraffinerien produzieren 50% mehr Benzin und 50% weniger Kunststoff",
  RefineryMorePlastic: "Mehr Plastic Mehr Probleme",
  RefineryMorePlasticDesc:
    "Ölraffinerien produzieren 50% weniger Benzin und 50% mehr Kunststoff",
  FreeOilTransportDesc:
    "Der Öltransport kostet keinen Kraftstoff, aber Ölquellen verbrauchen 2x Strom",
  SuperSteelMill: "Herzen aus Eisen",
  SuperSteelMillDesc:
    "Stahlwerke verbrauchen 50% weniger Kohle, aber 25% mehr Eisen und Strom",
  AlSemiconductor: "Al Schaltkreis",
  AlSemiconductorDesc:
    "Schaltungsgießereien verwenden Aluminium anstelle von Kupfer",
  CostSaver: "Kostenersparnis",
  CostSaverDesc:
    "Wenn der Eintrag eines Gebäudes mehr kostet als der Austrag, stellen Sie die Produktion ein",
  ...
  GlassUseCoalDesc:
    "Glasfabriken verbrauchen 50% mehr Kohle und 50% weniger Silizium",
  ...
  IronMine2xOutputDesc:
    "Eisenminen produzieren 2x Eisen, aber der Eisentransport kostet 2x Kraftstoff",
  SolarPanelAlwaysWork: "Die Sonne geht nie unter",
  SolarPanelAlwaysWorkDesc:
    "Solarzellen arbeiten 100% der Zeit, produzieren aber 60% weniger Strom",
  SteelScience: "Wissen durch Stahl",
  SteelScienceDesc:
    "Stahlwerke verbrauchen 2x Ressourcen und produzieren zusätzlich Wissenschaftspunkte",
  ...
  CrAlloyUseFeDesc:
    "Chromlegierungsanlagen verwenden kein Lithium, sondern 2x Eisen",
  DoubleTileModifier: "Die Kraft der Natur",
  TileModifierOutputOnly: "Zellenmodifikator Plus",
  GasPlantPetrol: "Gasliquidator",
  GasPlantPetrolDesc:
    "Gaskraftwerke verwenden zusätzliches Gas zur Herstellung von Benzin",
  CoalPlantFuel: "Kohle Liquidator",
  CoalPlantFuelDesc:
    "Kohlekraftwerke verwenden zusätzliche Kohle zur Herstellung von Kraftstoff",
  Welcome: "Willkommen",
  ...
  SaveName: "Speichern",
  NameValidationRule:
    "Ihr Name sollte nur Buchstaben und Zahlen enthalten und zwischen 5 und 15 Zeichen liegen",
  NameValidationRuleProfanity: "Ihr Name sollte keine Obszönitäten enthalten",
  ChatMessageRateLimit:
    "Sie können nur alle 10 Sekunden eine neue Chat-Nachricht senden",
  NameSaved: "Ihr Name wurde erfolgreich geändert",
  NoMessages: "Keine neue Nachrichten",
  Leaderboard: "Bestenliste",
  Name: "Name",
  Tips1:
    "Aktienbewertungen haben 5 Kriterien: Kaufen, Überperformance, Halten, Underperformance und Verkaufen",
  Tips2:
  ...
  SwissMoney: "%{money} 💵",
  PrestigeDesc:
    "Wenn Sie in einer neuen Stadt beginnen, erhalten Sie %{money} 💵",
  ...
  RequireExpansionPack1Desc:
    "Dies ist nur für das Erweiterungspaket 1 verfügbar",
  RequireAnyExpansionPack: "Erweiterungspakete exklusiv",
  RequireAnyExpansionPackDesc:
    "Für diese Funktion müssen Sie mindestens eines der Erweiterungspakete besitzen",
  ...
  HideDiscordBannerDesc:
    "Ausblenden des Discord und Storefront-Banner im Hauptquartier",
  ...
  FuelCostDiscountDesc:
    "Gibt einen Rabatt auf die Kraftstoffkosten beim Transport von Ressourcen",
  AutoSellCapacityMultiplier:
    "Multiplikator für die automatische Verkaufskapazität",
  ...
  BuildingPermitCostDividerDesc:
    "Teilen Sie die Baugenehmigungskosten durch diesen Teiler",
  ExtraAdjacentBonus: "Zusätzlicher Benachbarungsbonus",
  ExtraAdjacentBonusDesc:
    "Zusätzliche Bonuskapazität für jedes benachbarte Arbeitsgebäude des gleichen Typs",
  ...
  ClaimTradeFail:
    "Wenn Sie diesen Handel nicht beanspruchen konnten, versuchen Sie es später erneut",
  CancelTradeSuccess: "Ihr Handel wurde erfolgreich abgebrochen",
  CancelTradeFail:
    "Dieser Handel konnte nicht abgebrochen werden. Bitte versuchen Sie es später erneut",
  AcceptTradeFail:
    "Dieser Handel wurde nicht akzeptiert. Bitte versuchen Sie es später erneut",
  ...
  FailedToImportSaveDesc:
    "Ihre Sicherungsdatei ist nicht kompatibel oder beschädigt: %{error}",
  SaveCopiedToClipboard:
    "Ihre gespeicherten Daten wurden in Ihre Zwischenablage kopiert",
  CancelActiveTradeFirst:
    "Sie haben aktive Spieler-Handel, bitte stornieren / beanspruchen Sie diese zuerst",
  ...
  PlayerTradeToClaim:
    "Sie haben %{num} neue Handel zum abholen im Spielerhandel",
  PowerBank: "Stromspeicher",
  PowerBankBuildDesc:
    "Speichern Sie überschüssigen Strom und sorgen Sie für Stromversorgung bei Engpässen",
  WarehouseBuildDesc:
    "Transportieren und lagern Sie alle Ressourcen mit geringeren Kraftstoffkosten",
  ...
  PowerBankMoreCapacityDesc:
    "Stromspeicher laden mit 50% Geschwindigkeit auf, haben aber 50% mehr Kapazität",
  PowerBankNotWorking: "⛔ Stromspeicher arbeiten nur neben einem Kraftwerk",
  ColorTheme: "Spielfarbthema",
  ColorThemeDesc:
    "Farbthema für Spielesymbole, Hervorhebung, Gitter und Hintergrund. ERFORDERT EINEN NEUSTART",
  ...
  AlMine2xOutputDesc:
    "Aluminumminem produzieren 2x soviel Aluminium und verbrauchen 2x soviel Strom.",
  LoggingCamp2xOutput: "Abholzung",
  LoggingCamp2xOutputDesc:
    "Forstbetriebe produzieren 2x soviel Holz und die Transportkosten werden verdoppelt.",
  PowerBankLeft: "Energiespeicher",
  ColorThemeEditor: "Farbschemen Editor",
  ColorThemeEditorDesc:
    "Du kannst im aktuellen Schema Farben überschreiben. Du hast aktuell %{num} überschrieben.",
  ...
  AcceptTradeFailRateLimit:
    "Sie können nur einen Trade alle %{time} Sekunden akzeptieren",
  ...
  WarehouseAddRouteFail:
    "Route konnte nicht hinzugefügt werden: Die ausgewählte Kachel ist keine gültige Quelle",
  LevelN: "Level %{level}",
  Surplus: "Überschuss",
  Production: "Produktion",
  Consumption: "Verbrauch",
  WarehouseInputCapacityDescV2:
    "Gesamtkapazität des Eingangsstransports, gleichmäßig auf alle Strecken verteilt",
  ...
  WindTurbineAlwaysWorkDesc:
    "Windkraftanlagen arbeiten 100% der Zeit, produzieren aber 30% weniger Strom",
  ...
  ShowTheoreticalInputOutputCapacity:
    "Zeigen Sie die theoretische Eingangs- / Ausgabekapazität an",
  ...
  ClaimTradeSuccessV2:
    "Ihr Handel wurde erfolgreich angenommen: %{cashOrResource}",
  AcceptTradeSuccessV2:
    "Dieser Handel wurde von dir abgeschlossen: %{cashOrResource}",
  ResourceExplorer: "Ressourcen-Explorer",
  ResourceExplorerDesc:
    "Ermöglicht das Extrahieren von Ressourcen aus einer leeren Kartenkachel",
  ...
  PlayerTradeOptOut:
    "Sie haben sich von der Rangliste abgemeldet und können nicht mit anderen Spielern handeln",
  FirstTimeReadGuide:
  ...
  ChatMessageTooLong:
    "Ihre Chat-Nachricht hat die maximal zulässigen Zeichen überschritten",
  ...
  AchievementsRewardToast:
    "Sie haben die Belohnung beansprucht:  Schweizer Franken +%{swiss}",
  AchievementsClaim: "Einsammeln",
  AchievementsToast:
    "Du hast %{name} erreicht, fordern Sie Ihre Belohnung im Hauptquartier an",
  AchievementStockholm100: "Freshman Viking",
  AchievementStockholm100Desc:
    "Verdiene 100 Schweizer Franken in Stockholm in einem einzigen Druchlauf",
  AchievementStockholm500: "Graduate Viking",
  AchievementStockholm500Desc:
    "Verdiene 500 Schweizer Franken in Stockholm in einem einzigen Druchlauf",
  AchievementStockholm1000: "Experienced Viking",
  AchievementStockholm1000Desc:
    "Verdiene 1000 Schweizer Franken in Stockholm in einem einzigen Druchlauf",
  AchievementOslo100: "Norwegian Oil Hobbyist",
  AchievementOslo100Desc:
    "Verdiene 100 Schweizer Franken in Oslo in einem einzigen Druchlauf",
  AchievementOslo500: "Norwegian Oil Enthusiast",
  AchievementOslo500Desc:
    "Verdiene 500 Schweizer Franken in Oslo in einem einzigen Druchlauf",
  AchievementOslo1000: "Norwegian Oil Tycoon",
  AchievementOslo1000Desc:
    "Verdiene 1000 Schweizer Franken in Oslo in einem einzigen Druchlauf",
  AchievementRotterdam100: "Pinwheel Owner",
  AchievementRotterdam100Desc:
    "Verdiene 100 Schweizer Franken in Rotterdam in einem einzigen Druchlauf",
  AchievementRotterdam500: "Wind Mill Owner",
  AchievementRotterdam500Desc:
    "Verdiene 500 Schweizer Franken in Rotterdam in einem einzigen Druchlauf",
  AchievementRotterdam1000: "Wind Turbine Owner",
  AchievementRotterdam1000Desc:
    "Verdiene 1000 Schweizer Franken in Rotterdam in einem einzigen Druchlauf",
  AchievementDetroit100: "Local Car Dealer",
  AchievementDetroit100Desc:
    "Verdiene 100 Schweizer Franken in Detroit in einem einzigen Druchlauf",
  AchievementDetroit500: "Regional Car Distributor",
  AchievementDetroit500Desc:
    "Verdiene 500 Schweizer Franken in Detroit in einem einzigen Druchlauf",
  AchievementDetroit1000: "National Car Monopoly",
  AchievementDetroit1000Desc:
    "Verdiene 1000 Schweizer Franken in Detroit in einem einzigen Druchlauf",
  AchievementBoston100: "Bachelor of Earning Money",
  AchievementBoston100Desc:
    "Verdiene 100 Schweizer Franken in Boston in einem einzigen Druchlauf",
  AchievementBoston500: "Master of Gaining Money",
  AchievementBoston500Desc:
    "Verdiene 500 Schweizer Franken in Boston in einem einzigen Druchlauf",
  AchievementBoston1000: "Ph.D in Printing Money",
  AchievementBoston1000Desc:
    "Verdiene 1000 Schweizer Franken in Boston in einem einzigen Druchlauf",
  AchievementRome100: "Diocletian",
  AchievementRome100Desc:
    "Verdiene 100 Schweizer Franken in Rom in einem einzigen Druchlauf",
  AchievementRome500: "Constantine the Great",
  AchievementRome500Desc:
    "Verdiene 500 Schweizer Franken in Rom in einem einzigen Druchlauf",
  AchievementRome1000: "Caesar Augustus",
  AchievementRome1000Desc:
    "Verdiene 1000 Schweizer Franken in Rom in einem einzigen Druchlauf",
  AchievementHamburg100: "Deutschland",
  AchievementHamburg100Desc:
    "Verdiene 100 Schweizer Franken in Hamburg in einem einzigen Druchlauf",
  AchievementHamburg500: "Vaterland",
  AchievementHamburg500Desc:
    "Verdiene 500 Schweizer Franken in Hamburg in einem einzigen Druchlauf",
  AchievementHamburg1000: "Graf Zeppelin",
  AchievementHamburg1000Desc:
    "Verdiene 1000 Schweizer Franken in Hamburg in einem einzigen Druchlauf",
  AchievementToulouse100: "Jetliner A310",
  AchievementToulouse100Desc:
    "Verdiene 100 Schweizer Franken in Toulouse in einem einzigen Druchlauf",
  AchievementToulouse500: "Jetliner A330",
  AchievementToulouse500Desc:
    "Verdiene 500 Schweizer Franken in Toulouse in einem einzigen Druchlauf",
  AchievementToulouse1000: "Jetliner A380",
  AchievementToulouse1000Desc:
    "Verdiene 1000 Schweizer Franken in Toulouse in einem einzigen Druchlauf",
  AchievementHongKong100: "Hobbyist Trader",
  AchievementHongKong100Desc:
    "Verdiene 100 Schweizer Franken in Hong Kong in einem einzigen Druchlauf",
  AchievementHongKong500: "Professional Broker",
  AchievementHongKong500Desc:
    "Verdiene 500 Schweizer Franken in Hong Kong in einem einzigen Druchlauf",
  AchievementHongKong1000: "Hedge Fund Manager",
  AchievementHongKong1000Desc:
    "Verdiene 1000 Schweizer Franken in Hong Kong in einem einzigen Druchlauf",
  AchievementStPetersburg100: "The Grand Duke",
  AchievementStPetersburg100Desc:
    "Verdiene 100 Schweizer Franken in St. Petersburg in einem einzigen Druchlauf",
  AchievementStPetersburg500: "The Tsesarevich",
  AchievementStPetersburg500Desc:
    "Verdiene 500 Schweizer Franken in St. Petersburg in einem einzigen Druchlauf",
  AchievementStPetersburg1000: "The Tsar of All Russia",
  AchievementStPetersburg1000Desc:
    "Verdiene 1000 Schweizer Franken in St. Petersburg in einem einzigen Druchlauf",
  AchievementOsaka100: "Danshaku",
  AchievementOsaka100Desc:
    "Verdiene 100 Schweizer Franken in Osaka in einem einzigen Druchlauf",
  AchievementOsaka500: "Hakushaku",
  AchievementOsaka500Desc:
    "Verdiene 500 Schweizer Franken in Osaka in einem einzigen Druchlauf",
  AchievementOsaka1000: "Kōshaku",
  AchievementOsaka1000Desc:
    "Verdiene 1000 Schweizer Franken in Osaka in einem einzigen Druchlauf",
  SteamAutoCloudBackup: "Steam Cloud Auto Sicherung",
  SteamAutoCloudBackupFailed:
    "Steam Cloud Auto Backup fehlgeschlagen: %{error}",
  ...
  ElectricCarDesc:
    "Autofabriken verwenden Batterien anstelle von Benzin und benötigen nur 50% der Menge",
  HongKongBonusV2:
  ...
  SettingsFullScreenDesc:
    "Führen Sie das Spiel im Vollbildmodus aus. Nur für die Steam-Version verfügbar",
  ...
  PlayerTradePriceNotValidV2:
    "Der Handelspreis muss zwischen %{min} und %{max} liegen",
  ...
  PlasticFiberDesc:
    "Glasfaserfabriken verwenden 50% mehr Kunststoff, aber 50% weniger Glas",
  NewsEffectx2: "Pressekonferenz",
  NewsEffectx2Desc:
    "Der Effekt von Marktnachrichten verdoppelt sich sowohl positiv als auch negativ",
  ...
  BuilderMoveSpeedDesc:
    "Die Geschwindigkeit, mit der sich Bauherren bewegen, um Gebäude zu bauen",
  EBookInc: "eBook Inc.",
  ResourceBooster: "Ressourcen-Verstärker",
  BuildWarningTitle: "Gebäude funktioniert möglicherweise nicht",
  BuildWarningTitleDesc:
    "%{reason}. Sind Sie sicher, dass Sie auf dieser Zelle bauen wollen?",
  BuildWarningBuildAnyway: "Trotzdem bauen",
  ResourceBoosterNotWorking:
    "⛔ Ressourcen-Verstärker funktionieren nur in der Nähe von Lagerstätten",
  ...
  ItsAllGreenDesc:
    "Haben Sie 50 Produktionslinien und überhaupt kein Produktionsdefizit",
  DeepInRed: "Tiefrot",
  ...
  BuildingUpgradeCostDividerDescV2:
    "Teilen Sie die Kosten für die Gebäudeerweiterung durch diesen Teiler",
  ...
  FuelDynamiteDesc:
    "Dynamitfabriken verwenden Ihren aktuellen Kraftstoff anstelle von Öl",
  StPetersburgBonusV2:
  ...
  BuildingPermitsNeededDesc:
    "Dieses Gebäude funktioniert nicht, weil Sie nicht genügend Baugenehmigungen haben",
  ...
  ResearchLabCultureInputDesc:
    "Das Forschungslabor hat die doppelte Kapazität, verbraucht aber zusätzlich Kultur",
  GasPumpx2Output: "Hochdruck-Gaspumpe",
  GasPumpx2OutputDesc:
    "Erdgaspumpen haben 2x Leistung, verbrauchen aber 2x Strom",
  LeaderboardValuationPerHour: "Gesamtwert pro Stunde",
  LeaderboardValuationPerHourPerSwiss:
    "Gesamtwert pro Stunde pro Schweizer Franken",
  LeaderboardValuationPerHourNewPlayers:
    "Gesamtwert pro Stunde (< 1000 Schweizer Franken)",
  ...
  MapExtraPermitDesc:
    "Du erhältst %{number} kostenlose Baugenehmigungen durch den einzigartigen Bonus der Karte",
  OsloBonusV3:
  ...
  ResourceBoosterPercentageV2:
    "💡 Dieser Betrag beinhaltet %{percent} Boost von benachbarten Ressourcenverstärkern",
  MapleSyrup: "Ahornsirup",
  MapleSyrupFactory: "Ahornsirupfabrik",
  SyrupPlastic: "Sirup Kunststoff",
  SyrupPlasticDesc:
    "Alle Gebäude, die Kunststoff verwenden, verwenden stattdessen Ahornsirup",
  ...
  ProductionDiversificationDesc:
    "Jeder Gebäudetyp gibt allen Gebäuden 1% zusätzliche Kapazität",
  ...
  AchievementVancouver100Desc:
    "Verdiene 100 Schweizer Franken in Vancouver in einem Durchgang",
  AchievementVancouver500: "Sirup Vertiebler",
  AchievementVancouver500Desc:
    "Verdiene 500 Schweizer Franken in Vancouver in einem Durchgang",
  AchievementVancouver1000: "Canuck-Eroberer",
  AchievementVancouver1000Desc:
    "Verdiene 1000 Schweizer Franken in Vancouver in einem Durchgang",
  BarbariansAtTheGate: "Barbaren am Tor",
  BarbariansAtTheGateDesc:
    "Nutze zwischen den Marktaktualisierungen eine Handelsquote von 1T zwischen Spielern",
  DiversifiedProductions: "Diversifizierte Produktionen",
  DiversifiedProductionsDesc:
    "Baue 100 verschiedene Gebäudetypen auf einer einzigen Karte",
  ...
  HighPowerPriorityDesc:
    "Wenn du das einschaltest, zieht das Gebäude Strom von anderen Gebäuden",
  ...
  IndustryZoneNoAdjacentBonus:
    "Dieses Gebäude ist Teil einer Industriezone und hat keinen angrenzenden Bonus",
  ...
  WarehouseBuildingPermitSaveDesc:
    "Alle zwei Lagerhäuser bieten eine kostenlose Baugenehmigung",
  PolicySearchPlaceholder:
    "Geben Sie den Namen der zu durchsuchenden Richtlinie ein",
  SwissUpgrade: "Schweizer Upgrade",
  SwissUpgradeDesc:
    "Schweizer Upgrades sind permanent und werden in die neue Stadt übertragen",
