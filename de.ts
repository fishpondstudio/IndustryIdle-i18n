export const DE = {
    ...
    PermanentUpgradeDesc: "Diese Verbesserung bleibt bestehen, wenn Sie in einer neuen Stadt starten",
    ...
    MapProductionBonusDesc:
        "Dieses Gebäude bekommt %{percent} zusätzliche Kapazität durch den einzigartigen Kartenbonus",
    ...
    CrowdfundingCashInWarning: "Du hast ausstehende Crowdfunding-Beiträge – wenn du in einer neuen Stadt beginnst, verfallen sie",
    ...
    HighPowerPriorityDesc: "Wenn du das einschaltest, zieht das Gebäude Strom vor anderen Gebäuden",
    IndustryZone: "Industrie Zone",
    IndustryZoneDesc: "Kombinieren Sie angrenzende Gebäude, die eine Lieferkette bilden und sparen Sie Baugenehmigungen",
