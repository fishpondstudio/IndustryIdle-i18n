export const DE = {
    ...
    ResourceExplorerDescLong: "💡 Ressourcen-Entdecker haben keinen Benachbarungsbonus. Der Stromverbrauch ist je nach Ressource unterschiedlich",
    ResourceExplorerSelectResource: "Erkunden",
    ProductionSettings: "Produktionseinstellungen",
    PlayerTradeQuotaDesc: "💡 Die Handelsquote der Spieler beträgt %{percent} Ihres Marktkapitals. Sie wird zurückgesetzt, wenn der Markt aktualisiert wird",
    ...
    FirstTimeReadGuide: "💡 Benötigen Sie ein bisschen Hilfe beim Spielen? Tippen Sie hier, um den Anfängerleitfaden zu lesen!",
    ReadSteamGuideV2: "Spielanleitungen",
    ReadSteamGuideV2Desc: "Sie können von der Community erstellte Anleitungen auf Steam lesen - und Sie können auch Ihre eigenen erstellen",
    ...
    SteamLoginDesc: "Wenn Sie Erweiterungspakete bei Steam besitzen, können Sie nach der Anmeldung mit Erweiterungspaketen im Web spielen",
