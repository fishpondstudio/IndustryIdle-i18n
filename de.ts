export const DE = {
    ...
    BuildingPermitDesc:
        "Du hast Baugenehmigungen für %{amount} Gebäude, davon hast du bereits %{amountBuilt} genutzt und %{amountLeft} sind noch übrig",
    ...
    ResourceInOutDesc:
        "💡 Klicke oben auf die Out-In-Nummern, um die entsprechenden Ein- und Ausgangsgebäude zu markieren",
    ...
    AlwaysTransportInputDesc: "Transportiere benötigte Ware immer, auch wenn es mehr als benötigt ist",
    ...
    MaxInputDistanceDesc:
        "Die maximale Distanz eines Gebäudes, aus dem Rohstoffe bezogen werden, gemessen in Zellenanzahlen",
    ...
    LiionBatteryFactory: "Lithium-Ionen-Batteriefabrik",
    ...
    Credits: "Credits",
    Icons: "Symbole",
    MisplacedBuilding: "⛔ Das %{building} wird nicht auf die richtige Ressource gebaut",
    ...
    TurnOffProductionDesc:
        "Stellt die Produktion des Gebäudes ab. Das Gebäude wird keine Ressourcen mehr transportieren und keinen Strom verbrauchen",
    ...
    NumberOfBuildings: "Anzahl der Gebäude, die du besitzt",
    ...
    InputStrategyCloseDesc: "Bevorzugt das nächstgelegene Lager mit genügend Ressourcen",
    InputStrategyFar: "Weiter",
    InputStrategyFarDesc: "Bevorzugt das am weitesten entfernte Lager mit genügend Ressourcen",
    InputStrategyAmount: "Menge",
    InputStrategyAmountDesc:
        "Bevorzuget das Lager mit der größten Menge an Ressourcen, unabhängig von der Entfernung",
    ...
    ClaimOfflineEarning: "Offlineeinnahmen abholen",
    ...
    CostSaverDesc: "Wenn der Input eines Gebäudes mehr kostet als der Ertrag, stellt die Produktion sich automatisch ein",
    ...
    RestoreFromBackupDesc:
        "Normalerweise brauchst du keine Wiederherstellungen aus der Cloud-Sicherung durchführen, es sei denn, deine lokalen Daten geht verloren. Cloud-Backups sind etwas älter als deine lokalen Speicherstände",
    ChangeName: "Ändern",
    SaveName: "Speichern",
    ...
    Tips10: "Unterschiedliche Ressourcen werden auf dem Markt unterschiedlich bewertet - sei immer auf Marktvschwankungen vorbereitet",
    ...
    SwissMoney: "%{money} 💵",
    PrestigeDesc: "Wenn du in einer neuen Stadt beginnen, erhaltst du %{money} 💵",
