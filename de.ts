export const DE = {
    ...
    Rocket: "Rakete",
    RocketFactory: "Raketenkonstrukteur",
    ...
    NotEnoughCash: "Nicht genügend Geld für diese Aktion",
    NotEnoughSwissMoney: "Nicht genügend Schweizer Franken für diese Aktion",
    ...
    Coal: "Kohle",
    Video: "Video",
    ClothingFactory: "Bekleidungsfabrik",
    Clothes: "Kleidung",
    Fashion: "Mode",
    ...
    ResourceChange: "Difference",
    ResourceInOutDesc:
        "💡 Klicke oben auf die Aus-Ein-Nummern, um die entsprechenden Ein- und Ausgangsgebäude zu markieren",
    MarketUpdateIn: "Marktpreisaktualisierung in %{time}",
    Semiconductor: "Halbleiter",
    SemiconductorFactory: "Schaltungsgießereien",
    Steel: "Stahl",
    Bitcoin: "Bitcoin",
    ...
    Drum: "Schlagzeug",
    DrumFactory: "Schlagzeughersteller",
    ...
    ProductionCycleLengthDesc:
        "Dauer eines Produktionszyklus in Sekunden. Eine Verlängerung des Zyklus erhöht entsprechend die benötigten und hergestellten Waren",
    MaxInputDistance: "Max. Importdistanz",
    ...
    AutoSellConcurrencyDesc: "Maximale Anzahl an Ressourcen, die gleichzeit automatisch verkauft werden können",
    MaxAutoSellConcurrencyReached:
        "Du hast die maximale automatische Verkaufsanzahl erreicht, schalte einen anderen Verkauf ab um diesen zu aktivieren",
    ...
    Battery: "Batterie",
    BatteryFactory: "Batteriezellenwerk",
    RatingBuy: "Kaufen",
    ...
    Sound: "Soundeffekte",
    SoundDesc: "Aktiviere/ Deaktiviere Soundeffekte wie Klicktöne oder Fehlerbenachrichtigungen",
    ...
    HighlightNotMakingProfit: "... die keinen Gewinn erzielen",
    NBuildingsAreHighlighted: "%{n} Gebäude sind hervorgehoben",
    TurnOffProduction: "Stilllegen",
    TurnOffProductionDesc:
        "Stelle die Produktion des Gebäudes ein. Das Gebäude wird keine Ressourcen mehr transportieren und keinen Strom verbrauchen",
    ...
    NumberOfBuildings: "Anzahl der Gebäude, die du gebaut hast",
    ShowContent: "Zusatzinhalte anzeigen",
    HideContent: "Zusatzinhalte ausblenden",
    ...
    InputStrategyAmountDesc:
        "Bevorzugt das Lager mit der größten Menge an Ressourcen, unabhängig von der Entfernung",
    ...
    Screen: "Bildschirm",
    JoinDiscord: "Besuche unseren Discord-Server, um die neuesten Updates, Tipps und Diskussionen zu erhalten",
    ...
    EffectiveTimeDesc: "Ihre effektive Offline-Verdienstzeit ist auf %{time}min begrenzt.",
    BuildSearchPlaceholder: "Gib ein Gebäude oder eine Ressource für die Suche ein",
    ...
    FillOrder: "Bestellung abliefern",
    ...
    NewOrder: "Eine neue Bestellung von %{from} ist angekommen, einzusehen im  Großhandelszentrum",
    ...
    HalfTransportSpeedDesc:
        "Die Transportgeschwindigkeit wird um 25% verlangsamt und die Kraftstoffkosten werden um 25% gesenkt.",
    ...
    CostSaverDesc: "Wenn der Eintrag eines Gebäudes mehr kostet als der Austrag wir die Produktion eingestellt",
    ...
    AdjacentBonusOnlyOutput: "Nachbarschaftsbonus Plus",
    ...
    ShoppingSpreeDesc:
        "Wenn die Produktion einer Ressource nicht ausreicht, wird der Mangelbetrag automatisch am Marktplatz eingekauft (wenn die Ressource automatisch weiterverkauft wird, wird Sie ignoriert).",
    ...
    NextTutorial: "weiter",
    Tutorial1:
        "Industry Idle ist ein <em> Ressourcenmanagement </em> -Spiel, in dem du Fabriken baust🏭, Waren produzierst📦 und Geld verdienst💸.<br><br>Lass uns einige Grundlagen durchgehen, um dir den Einstieg zu erleichtern - es dauert nicht lange, versprochen.",
    Tutorial2:
        "Alle Gebäude benötigen Strom⚡, du hast ein <em>Windrad</em>, welches Strom erzeugt. Du kannst deine aktuelle Netzversorgung auf der linken Seite der oberen Leiste sehen.<br><br> Möglicherweise hast du bemerkt, dass Windkraftanlagen nur <em>80%</em> der Zeit arbeiten. Du kannst auch andere Kraftwerkstypen bauen, die dauerhaft Strom erzeugen.",
    Tutorial3:
        "Du hast viele <em> Rohstoffdepots </em> auf der Karte. Um Ressourcen zu gewinnen, musst du Minen <em> auf </em> dem entsprechenden Rohstofffeld errichten. <br> <br> Zum Beispiel habst du eine <em> Ölquelle🛢️ </em>, die Öl </em> aus einem Ölvorkommen <em extrahiert >. <br><br>  Rohstoffvorkommen sind unbegrenzt - Du musst dir also keine Sorgen machen, dass sie aufgebraucht werden. Abgesehen von Minen können andere Gebäude auf jeder leeren Kachel gebaut werden.",
    Tutorial5:
        "Um Geld zu verdienen, kannst du deine Ressourcen über das Handelszentrum verkaufen. Aktiviere dazu einfach <em> den automatischen Verkauf </em> für diese Ressource. <br><br>  Du kannst Ressourcen auch auf dem Marktplatz kaufen. Denke aber daran, <em> dass ,wenn du eine Ressource kaufst, sich ihr Preis erhöht </em> und wenn du eine Ressource verkaufst, senkst du den Preis. <br> <br> Der Markt ist <em> unbeständig </ em > und der Preis 📈 ändert sich regelmäßig.",
    Tutorial6:
        "Um neue Gebäude zu bauen, musst du diese zuerst im <em> Forschungslabor🧪 </em> freischalten. Das Forschungslabor wandelt auch Wissenschaft in Forschungspunkte um. <br> <br> Deine Windkraftanlage (und andere Kraftwerke) produziert beim Betrieb eine kleine Menge Wissenschaft. Später kannst du eine Schule und andere spezielle Gebäude bauen, um die Wissenschaft anzukurbeln. <br> <br> Jetzt hast du alle Grundlagen gelernt und kannst beginnen deine Wirtschaft aufzubauen! Hier sind einige <em> Geldmittel💸 </em> und <em> Benzin </em>, um dir eine Starthilfe zu geben.",
    WelcomePlay: "Spielen",
    ...
    NameValidationRuleProfanity: "Dein Name sollte keine Schimpfwörter enthalten",
    ChatMessageRateLimit: "Du kannst nur alle 10 Sekunden eine neue Chat-Nachricht senden",
