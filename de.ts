export const DE = {
    ...
    PlayerTradeFilterResources: "Filter Ressourcen",
    ...
    SaveVersionTooNew:
        "Dein Speicherstand ist von %{saveVersion}, auf dein Spiel ist auf %{gameVersion}. Aktualisiere zuerst dein Spiel",
    ...
    StreamingAcceptStream: "Akzeptieren",
    ...
    CristoRedentorDesc: "Verbraucht Kultur und verbessert jegliche angrenzende Gebäude",
    Istanbul: "Istanbul",
    Wormhole: "Wurmloch",
    ...
    RightToTradeInvalidDesc:
        "Dein Handelsrecht wurde auf einen anderen Speicherstand übertragen - Du musst den Speicherstand importieren, um dein Handelsrecht wiederherzustellen. Falls du deinen Speicherstand verloren hast kannst du das Handelsrecht wiederherstellen, aber du kannst erst nach einem Cooldown wieder handeln und dein anderer Speicherstand verliert sein Handelsrecht.",
    ForceRestoreRightToTrade: "Erwinge Wiederherstellung (%{cooldown}-hour cooldown)",
