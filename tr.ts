export const TR = {
    ...
    BuildQueueDesc: "Şu anda kuyrukta olan bina sayısı",
    ...
    Resources: "Kaynaklar",
    NotEnoughPower: "💡 Yeterli güç yok, güç kaynağını artırmayı düşünün",
    NotEnoughFuel: "Bu işlem için yeterli %{fuel} yok",
    ...
    RecommendedBuilding: "💡 Bu döşemede %{resource} rezervi var",
    ...
    PerCycle: "%{amount}/devir",
    PolicyPoint: "Politika Puanı",
    PolicyPointPerMinute: "Üretim Hızı",
    ...
    StickyInputDesc:
        "Buildings will prefer to transport from previous source, instead of searching for the best source every cycle (BEDAVA POLİTİKA)",
    ...
    TotalInput: "Toplam Üretim",
    TotalOutput: "Toplam Tüketim",
    ...
    InAmount: "Gelen: %{number}",
    OutAmount: "Giden: %{number}",
    ...
    MoveToNewMap: "Yeni Şehirde Başla",
    CityName: "Şehir",
