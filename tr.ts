export const TR = {
  ...
  "ProductionCycleLengthDesc": "Saniye cinsinden ölçülen bir üretim döngüsünün süresi. Döngünün uzatılması, döngü başına girdi/çıktıyı buna göre artıracak ve böylece girdi kaynaklarını alırken önceliğini azaltacaktır.",
  ...
  "AdjacentBonusOnlyOutputDesc": "Adjacent bonus does not require more input but uses more power and is only 50% effective",
  ...
  "Detroit": "Detroit",
  "Boston": "Boston",
  "BostonBonus": "<li>Start with level 5 research lab</li><li>Polytechnics are unlocked</li><li>Polytechnics have 2x capacity</li><li>Schools have 2x capacity</li><li>University have 2x productivity</li>",
  ...
  "DetroitBonusV3": "<li>Motor fabrikaları açıldı,</li><li>Engine factories have 2x productivity</li><li>Car factories have 2x capacity</li><li>Car factories use gas instead of petrol</li><li>Free car transportation</li><li>Nikola Tesla policy is free</li><li>Train factories have 2x capacity</li>",
  ...
  "PolicyBlueprintDesc": "Construction of a building will not automatically start - it has to be started manually (BEDAVA POLİTİKA)",
  ...
  "WholesaleCenterProducingOnlyDesc": "Wholesale center orders only contain resources that are currently being produced (you also need to be producing the number of required resources to unlock wholesale center)",
  ...
  "ResourceBoosterBannerDescV2": "💡 Şuan  %{number} kadar  kaynak yükselticin var- the science input of each is scaled to the number of resource boosters you currently have",
