export const RU = {
    ...
    ResourceBoosterPercentage: "💡 Это здание получает %{percent} прироста производительности от соседних ускорителей ресурсов",
    ...
    ItsAllGreenDesc: "Владеть 50 производственными линиями и полное отсутствие дифицита производства",
