export const RU = {
    ...
    WholesaleCenterProducingOnlyDesc:
        "Заказы оптового центра содержат только те ресурсы, относятся к верхней половине наиболее продвинутых исследованных вами продуктов. (вам также необходимо производить необходимое количество ресурсов, чтобы разблокировать Центр оптовых продаж)",
