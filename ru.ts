export const RU = {
    ...
    CropOutputx2Desc: "Сельскохозяйственные угодья и теплицы производят 2x урожая, но транспортировка урожая требует 2x топлива",
    MeatProductionx2: "Стероиды для скота",
    MeatProductionx2Desc:
        "Куриные фермы, свинофермы, коровьи фермы, рыбные пруды и кормовые заводы имеют 2x мощности, но потребляют 2x энергии",
