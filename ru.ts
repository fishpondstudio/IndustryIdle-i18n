export const RU = {
    ...
    MetaRebranding: "Ребрендинг Корпопации 'Мета'",
    MetaRebrandingDesc:
        "Корпорация 'Социальная сеть' переименовывается в Корпопацию 'Мета' и потребляет Интернет, Игры, Супер компьютер, Биткоин и Догикоин",
    MetaInc: "Корпопация 'Мета'",
};
