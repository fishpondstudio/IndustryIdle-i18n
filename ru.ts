export const RU = {
  ...
  "BuildingPermitDesc": "Приобретено %{amount} разрешения(й) на строительство зданий. Использовано %{amountBuilt} разрешения(й). Осталось %{amountLeft} разрешения(й)",
  ...
  "AdjacentBonusDesc": "Вы получаете %{bonus}% дополнительной мощности за каждое рабочее здание того же типа находящееся рядом",
  ...
  "AlwaysTransportInputDesc": "Всегда перевозить входные ресурсы, даже если они превышают минимальную потребность производства",
  "ProductionCycleLength": "Производственный Цикл",
  "ProductionCycleLengthDesc": "Продолжительность одного производственного цикла, измеряется в секундах. Удлинение цикла увеличит вход/выход за цикл, и, как результат, снизит его приоритет при получении входных ресурсов",
  "MaxInputDistance": "Максимальное входное расстояние",
  "MaxInputDistanceDesc": "Максимальное расстояние, на котором это здание может получить входные ресурсы, измеряется в количестве плиток",
  ...
  "MaxAutoSellConcurrencyReached": "Вы достигли максимального количества автоматических продаж, отключите другую автоматическую продажу, чтобы включить эту",
  ...
  "StockRatingDesc": "Согласование рейтинга акций от аналитиков Уолл-стрит, который влияет на вашу рыночную капитализацию и обновляется вместе с рынком",
  ...
  "TurnOffProductionDesc": "Выключить производство в здании. Здание больше не будет транспортировать ресурсы и использовать энергию",
  ...
  "FuelCostSaveDescV2": "Склады экономят определенный процент топлива для перевозки ресурсов по сравнению с другими постройками, чем выше уровень, тем больше экономия",
  ...
  "WholesaleCenterLocked": "Чтобы разблокировать Центр оптовых продаж, вам необходимо иметь не менее %{required} различных ресурсов. В наличии только %{current} ресурсов",
  ...
  "WholesaleCenterOrderFasterDesc": "Центр оптовых продаж получает заказы в 2 раза быстрее и размер заказов в 2 раза больше",
  ...
  "SuperSteelMillDesc": "Сталелитейные заводы используют на 50% меньше угля, на 25% больше железа и на 25% больше энергии",
  ...
  "CostSaverBuildingDesc": "Политика экономии затрат активна, производство будет включаться/выключаться автоматически в зависимости от его рентабельности",
  ...
  "AdjacentBonusOnlyOutputDesc": "Смежный бонус не требует большего ввода, но использует больше энергии и эффективен только на 50%",
  ...
  "ShoppingSpreeDesc": "Если ресурса не хватает, автоматически покупается недостающее количество в Торговом центре (если включена автоматическая продажа такого ресурса, она покупка будет проигнорирована).",
  "ShoppingSpreeTradeCenterDesc": "💡 Политика шопинга включена, Торговый центр будет автоматически закупать ресурсы в условиях дефицита",
  ...
  "NextTutorial": "Далее",
  "Tutorial1": "Industry Idle это игра по <em>управлению ресурсами</em> в которой вы строите фабрики🏭, производите товары📦 и зарабатываете деньги💸.<br><br>Давайте рассмотрим некоторые основные понятия, чтобы вы могли начать - это не займет много времени, я обещаю.",
  "Tutorial2": "Все здания нуждаются в электроэнергии⚡, у Вас есть <em>ветрогенератор</em> он генерирует энергию. Вы можете увидеть свой текущий запас энергии в левой части верхней панели.<br><br>Вы, наверное, заметили, что ветрогенераторы работают только <em>80%</em> времени. Вы можете рассмотреть возможность строительства других типов электростанций, которые генерируют постоянную энергию.",
  "Tutorial3": "У Вас есть много <em>месторождений ресурсов</em> на карте. Чтобы добывать ресурсы, вы должны строить шахты⛏️ <em>на вершине</em> соответствующего месторождения.<br><br>Например, у вас есть <em>нефтяная скважина🛢️</em> которая добывает <em>нефть</em> из нефтяного месторождения.<br></br>Запасы ресурсов неограниченны - не нужно беспокоиться о том, что они иссякнут. Помимо шахт, на любой пустой клетке можно построить и другие здания.",
  "Tutorial5": "Чтобы заработать деньги, вам нужно экспортировать свои ресурсы через Торговый центр. Для этого просто включите <em>автопродажу</em> для этого ресурса.<br></br>Вы также можете покупать ресурсы в Торговом центре. Помните <em>если вы покупаете ресурс, вы повышаете цену</em> и если вы продаете ресурс, вы понижаете цену.<br><br>Рынок <em>волатилен (изменчив)</em> и цены📈 регулярно меняются",
  "Tutorial6": "Чтобы построить новые здания, вам нужно сначала разблокировать их в <em>исследовательской лаборатории🧪</em>. Исследовательская лаборатория также преобразует науку в исследовательские единицы.<br><br>Ваш ветрогенератор (и другие электростанции) производит небольшое количество науки во время работы. И вы можете построить школу🏫 и другие специальные здания, чтобы впоследствии стимулировать науку.<br><br>Теперь, когда вы изучили все основы, начинайте строить свою экономику! Вот немного <em>денег💸</em> и <em>бензина⛽</em> для хорошего старта.",
  "WelcomePlay": "Воспроизвести",
  "WelcomePlayMuted": "Воспроизвести (🔇Музыка)",
  "Chat": "Чат",
  "RestoreFromBackup": "Восстановление из резервной копии",
  "RestoreFromBackupFail": "Не удалось восстановить резервную копию из облака Steam: вы уверены, что резервная копия существует?",
  "RestoreFromBackupTitle": "Вы уверены?",
  "RestoreFromBackupDesc": "Обычно восстановление из облачной резервной копии не требуется, если только не потеряно локальное сохранение. Облачные резервные копии немного старше локального сохранения",
  "ChangeName": "Изменить",
  "SaveName": "Сохранить",
  ...
  "OfflineModeDesc": "Не удается подключиться к серверу: оффлайн-заработок генерироваться не будет. Пожалуйста, проверьте свое подключение к Интернету",
  "OptOut": "Отказ",
  "OptIn": "Сброс и включение",
  "LeaderboardOptOut": "Отказ от участия в рейтинге",
  "LeaderboardOptIn": "Сброс и включение Таблицы лидеров",
  "LeaderboardOptInDesc": "Ваши данные должны быть сброшены, прежде чем вы сможете снова включить Таблицу лидеров, вы уверены??",
  "RewardAdsFailed": "Видео с вознаграждением не было завершено",
  "OfflineEarningDoubleSuccess": "Вы удвоили свой оффлайн заработок",
  "FPS30Desc": "Включение режима энергосбережения позволит запускать игру с частотой 30FPS вместо 60FPS. Это позволит вашему аккумулятору работать дольше",
  ...
  "HideRewardAdDesc": "Вся внутриигровая реклама с вознаграждением является необязательной. Это позволит скрыть все варианты рекламы из игры.",
  ...
  "ProductionMultiplierDesc": "Повышение производственных мощностей всех ваших зданий (включая шахты, заводы, электростанции, научные и культурные здания).",
  ...
  "PrestigeAlertContent": "Ваша компания будет ликвидирована. Вы получите наличными %{amount} Индустриальных кредитов и начнете новую компанию в %{city}",
  "PrestigeCurrencyDesc": "Это деньги на вашем секретном счете в Швейцарском банке, которые вы можете взять с собой, когда начинаете работать в новом городе",
  "Prestige": "Наличные",
  "Cancel": "Отменить",
  ...
  "LoadGameErrorDesc": "Пожалуйста, проверьте подключение к Интернету. Если проблема сохраняется, обратитесь в службу поддержки",
  "ExpansionPackIncompatible": "Вы импортируете сохранение с пакетом расширения, но в вашей игре нет необходимых пакетов расширения",
  "CashIn": "Наличные",
  "CurrentCity": "Текущий город",
  "CashInDesc": "Вы получите эту сумму на свой счет в Швейцарском банке, если начнете работать в новом городе. Она основана на рыночной стоимости Вашей компании и должна достичь %{amount} прежде, чем вы сможете заработать Индустриальные кредиты",
  ...
  "Hamburg": "Гамбург",
  "HamburgBonus": "<li>Завод дирижаблей разблокирован</li><li>Полупроводниковые заводы имеют производительность 2Х</li><li>Верфи имеют мощность 2Х</li><li>Автомобильные заводы имеют мощность 2Х</li><li>Завод литий-ионных аккумуляторов разблокирован</li>",
  "Toulouse": "Тулуза",
  "Rome": "Рим",
  "RomeBonus": "<li>Колизей разблокирован</li><li>Колизеи имеют производительность 2Х</li><li>Политический центр 5 уровня</li><li>Оперные театры имеют мощность 2Х</li><li>Студии звукозаписи также производят культуру</li>",
  "Detroit": "Детройт",
  "Boston": "Бостон",
  "BostonBonus": "<li>Исследовательская лаборатория 5 уровня</li><li>Политехнический институт разблокирован</li><li>Политехнические институты имеют мощность 2Х</li><li>Школы имеют мощность 2Х</li><li>Университеты имеют производительность 2Х</li>",
  ...
  "AddTradeExceedMaximumTrade": "У вас может быть максимум %{number} активных сделок, пожалуйста, сперва завершите или отмените одну из них",
  ...
  "PlayerTradeUnavailable": "Вам необходимо иметь хотя бы один ресурс в производстве и на складе, прежде чем вы сможете торговать с игроками",
  ...
  "SiliconMine2xOutputDesc": "Кремниевые шахты производят 2Х кремния, но потребляют на 50% больше энергии и на 50% больше топлива при перевозке",
  "CoalMine2xOutput": "Промышленная революция",
  "CoalMine2xOutputDesc": "Угольные шахты производят 2Х угля, но потребляют на 50% больше энергии и на 50% больше топлива при перевозке",
  ...
  "WarehouseInputCapacityDescV2": "Общая пропускная способность входящих перевозок, распределена равномерно между всеми маршрутами",
  ...
  "Osaka": "Осака",
  "OsakaBonus": "<li>Ресурсы имеют тенденцию появляться в кластерах</li><li>Склад обеспечивает на 50% больше экономии топлива</li><li>Уникальное здание: Издательство Манги</li><li>Уникальное здание: Аниме-студия</li><li>Заводы полупроводников имеют производительность 2x</li><li>Заводы литий-ионных аккумуляторов имеют мощность 2x</li><li>Аккумуляторный завод разблокирован</li><li>Аккумуляторные заводы имеют мощность 2х</li><li>Экономия заряда аккумулятора улучшается на 100%</li><li>Аккумуляторный завод не требуют угля</li><li>100К аккумуляторов со старта</li>",
  "HideChatDescV2": "Скрыть сообщение чата с нижней панели инструментов. Показывая сообщения чата, вы соглашаетесь с нашими ",
  ...
  "ResourceExplorerDescLong": "💡 Исследователи ресурсов не имеют смежного бонуса. Расход энергии для каждого ресурса индивидуален",
  ...
  "SteamLoginDialogDesc": "В вашем локальном сохранении включен пакет расширения, чтобы продолжить игру, вам нужно войти в систему через Steam. Или вы можете СТЕРЕТЬ СВОЕ ЛОКАЛЬНОЕ СОХРАНЕНИЕ и начать заново",
  "SteamLoginDesc": "Если у вас есть пакеты расширения в Steam, вы можете играть с пакетами расширения в веб-версии после входа в систему",
  "SteamLoginYes": "Войти",
  ...
  "FreeTransportToTradeCenterDesc": "Перевозка в Торговый центр бесплатная, но перевозка из Торгового центра на 50% дороже",
  ...
  "DetroitBonusV3": "<li>Заводы двигателей разблокированы</li><li>Заводы двигателей имеют производительность 2Х</li><li>Заводы автомобилей имеют мощность 2Х</li><li>Заводы автомобилей используют газ вместо бензина</li><li>Бесплатная перевозка автомобилей</li><li>Политика Никола Тесла бесплатная</li><li>Заводы поездов имеют мощность 2Х</li>",
  "SaveAndExit": "Сохранить и выйти из игры",
  "SaveAndExitDesc": "Сохранить и выйти из игры. Доступно только для Steam версии и делает то же самое, что и кнопка закрытия на панели окна",
  "AutoSellResourceWarningShortLabel": "💡Автопродажа",
  "AutoSellResourceWarningDesc": "Вы автоматически продаете этот ресурс, запас, находящийся в Торговом центре, не может быть использован для продажи",
  "PlayerTradeLocalPrice": "Текущая цена: %{price}",
  "ChatForceScroll": "Принудительная прокрутка",
  "ChatForceScrollDesc": "Если включена принудительная прокрутка, чат будет прокручиваться при каждом новом сообщении. В противном случае он будет прокручиваться только тогда, когда вы находитесь на самом последнем сообщении.",
  "ResourceExplorer2": "Исследователь ресурсов 2.0",
  "ConstructionCancel": "Отменить строительство",
  "PolicyBlueprint": "Чертеж",
  "PolicyBlueprintDesc": "Строительство здания не запустится автоматически - его нужно запускать вручную (БЕСПЛАТНАЯ ПОЛИТИКА)",
  ...
  "SellRefundPercentageDesc": "Процент денежных средств и ресурсов, которые вам будут компенсированы, в случае продажи или понижения уровень здания",
  "SellBuildingDescV2": "При продаже здания вам будет возвращено %{percent} Ваших вложений и %{percent} ресурсов будет перевезено в Торговый центр",
  ...
  "AchievementSoftwareGiantDesc": "Постройте на одной карте Компанию по разработке ПО 10 уровня, Компанию по разработке ОС 10 уровня, Компанию 'База данных' 10 уровня и Веб-браузер 10 уровня",
  "AchievementSpaceRace": "Космическая гонка",
  "AchievementSpaceRaceDesc": "Постройте на одной карте Ракетный завод 10 уровня, Завод спутников 10 уровня, Завод космических кораблей 10 уровня и Завод космических станций 10 уровня",
  "AchievementToTheMoon": "На Луну",
  "AchievementToTheMoonDesc": "Постройте ферму Биткоинов 40 уровня и ферму Догекоинов 40 уровня. Получите 1B Биткоинов и 1B Догекоинов",
  ...
  "LogoutDescV2": "Вы вошли в систему на другом устройстве. Данное устройство отключено от системы. Вы можете снова войти в систему, но другое устройство будет отключено от системы",
  ...
  "BlockUserChatDesc": "Блок будет действовать в течение этой игровой сессии. Вы не сможете отменить его, пока не перезапустите игру",
  ...
  "ResourceBoosterSquareDesc": "Ускорители ресурсов дают на 25% больше усиления, но их научные затраты и потребление энергии также увеличиваются на 25%",
  "SteelMillx2": "Модернизация сталеплавильной печи",
  "SteelMillx2Desc": "Сталелитейные заводы и заводы нержавеющей стали имеют в 2 раза большую мощность, но потребляют в 2 раза больше энергии",
  "FuelDynamite": "Топливный динамит",
  "FuelDynamiteDesc": "Динамитные фабрики используют ваше текущее топливо вместо нефти",
  "StPetersburgBonusV2": "<li>Урановые шахты имеют 2Х производительность</li><li>Заводы по обогащению урана имеют 2Х мощность</li><li>Перевозка урана стоит на 50% дешевле</li><li>Бесплатная перевозка оружия</li><li>Проект 'Восток' имеет 2Х мощность</li>",
  ...
  "GPUIsBusyDesc": "Ваша операционная система приостановила графику игры, потому что графический процессор занят другими задачами. Вы можете перезагрузить игру, чтобы продолжить. Если это не сработает, попробуйте перезапустить игру",
  ...
  "ResourceBoosterSupplyChainDesc": "Ускоритель ресурсов использует 2Х энергии и науки, но за каждую работающую шахту, которую усиливает ускоритель ресурсов, он также дает прирост мощности соседним фабрикам, которые потребляют продукцию шахты (Фабрика должна потреблять только ресурсы из месторождения)",
  ...
  "ResourceExplorer2DescV2": "Исследователи ресурсов производят в 2 раза больше продукции, но потребляют в 2 раза больше энергии. Исследователи ресурсов могут быть усилены ускорителями ресурсов, если активна политика Усилитель цепочки поставок и у ускорителя есть соседняя шахта с таким же добываемым ресурсом",
  "NoTileModifier": "Плоская Земля",
  "NoTileModifierDesc": "Все модификаторы плитки равны нулю. Эта политика деактивирует политики Сила природы и Модификатор плитки Плюс",
  "DoubleTileModifierDescV2": "Эффект всех модификаторов плитки 2Х - как положительный, так и отрицательный. Эта политика деактивирует политику Плоская Земля",
  "TileModifierOutputOnlyDescV2": "Модификаторы плитки влияют только на выход, а не на вход и выход, но их эффективность составляет всего 50%. Эта политика деактивирует политику Плоская Земля",
  ...
  "TotalPledgedValueDesc": "Ваш первый залог учитывается при достижении цели Совместное финансирование. Последующие взносы увеличивают общую объявленную стоимость, но не учитываются при достижении цели",
  ...
  "CrowdfundingAlreadyPledgedDesc": "Вы можете заложить больше ресурсов, что увеличит вашу общую заложенную стоимость (и потенциальную прибыль), но не будет засчитано для достижения цели Совместного финансирования",
  "WholesaleCenterProducingOnly": "Оптовые партнеры",
  "WholesaleCenterProducingOnlyDesc": "Заказы оптового центра содержат только те ресурсы, которые относятся к верхней половине наиболее продвинутых исследованных вами продуктов (вам также необходимо производить необходимое количество ресурсов, чтобы разблокировать Центр оптовых продаж)",
  ...
  "ResourceMovementDesc": "Вы можете выбрать, когда показывать движение ресурсов (точки). Скрытие может улучшить производительность ",
  "CrowdfundingCashInWarning": "У вас есть невыполненные обязательства по совместному финансированию - при старте в новом городе они будут аннулированы",
  "ResourceBoosterBannerDescV2": "💡 В настоящее время у вас есть %{number} ресурсных ускорителей - научный вклад каждого из них увеличивается в соответствии с количеством ресурсных ускорителей, которые у вас есть в настоящее время",
  ...
  "IndustryZoneNotWorkingDesc": "Все соседние здания должны образовывать цепочку поставок, иметь максимальный уровень %{level} и не являться частью других промышленных зон",
  ...
  "SwissBoostCostDividerDesc": "Уменьшите стоимость Усиление за кредиты на этот коэффициент - применяется только к обновлениям с множителями/делителями",
  ...
  "GreenPeacekeeperDesc": "Создайте армию, флот, воздушные или космические силы, используя только возобновляемые источники энергии (ветряки/солнечные панели)",
  "DotComTycoon": "DotCom магнат",
  "DotComTycoonDesc": "Постройте здания 10 уровня на одной карте: Корпорация 'Социальная сеть', Компания 'Поисковая система', Корпорация 'СкайНет'и Корпорация 'Musify'",
  ...
  "HighSpeedWarehouseDesc": "Склады имеют 2-х кратную вместимость и на 50% более высокую скорость транспортировки на/со склада, но потребляют в 2 раза больше энергии",
  ...
  "OfflineResearchSwissBoostDesc": "Очки исследований накапливаются, пока вы находитесь не в сети (в соответствии с уровнем вашей исследовательской лаборатории, наукой на вашем складе и временем заработка в офлайне)",
  "SanJose": "Сан-Хосе",
  "SanJoseBonus": "<li>Уникальное здание: Производитель Микросхем</li><li>Уникальное здание: Корпорация FaceApp</li><li>Уникальное здание: Майнер Биткоинов</li><li>Все здания, потребляющие кремний, имеют максимальный модификатор плитки</li><li>Солнечные панель генерируют 2x энергии</li><li>Кремнивые шахты имеют 2x производительности</li>",
  "RotterdamBonusV2": "<li>Сталелитейные заводы имеют 2Х мощность; </li><li>Заводы нержавеющей стали имеют 2Х мощность; </li><li>Бесплатная транспортировка железа; </li><li>Транспортировка стали стоит на 50% меньше топлива; </li><li>Начните с 2х мощности автопродаж; </li><li>Бесплатная политика Плоская Земля</li>",
  ...
  "IndustryZoneMultiplierSwissBoostDescV2": "Каждый уровень производственной цепочки внутри промышленной зоны обеспечивает такое увеличение мощности для всех зданий в той же зоне",
  "IndustryZoneBuildingPermitDesc": "Если в промышленной зоне имеется N уровней производств, то она будет бесплатно выдавать N-2 разрешений на строительство",
  ...
  "ReturnOnPledgeDescV2": "Ваш общий доход равен общей заложенной стоимости, умноженной на коэффициент доходности всех ресурсов. Чем больше спонсоров у ресурса, тем выше его доходность",
  ...
  "ResourceExplorerAllDesc": "Исследователи ресурсов могут производить все ресурсы, включая те, которых нет на карте (это НЕ открывает соответствующие технологии)",
  "ShowResourceInTopBar": "Показать в верхней панели",
  "LeaderboardOptOutDescV2": "Вы больше не будете отображаться в таблице лидеров. Это также отключит торговлю игроками. ПОЖАЛУЙСТА, ОБРАТИТЕ ВНИМАНИЕ: если вы хотите включить таблицу лидеров позже, ваши данные должны быть сброшены",
  "PolicyPointNoCopperDesc": "💡 На этой карте нет месторождений меди, вы можете активировать политику Алюминий в микросхемах, чтобы разблокировать дополнительные технологии",
  "Pumpkin": "Тыквы",
  ...
  "ReindeerSiliconDesc": "Все здания, потребляющие Кремний, используют вместо него Северных оленей (БЕСПЛАТНАЯ ПОЛИТИКА)",
  "ReindeerAluminum": "Алюминий для Северных оленей",
  "ReindeerAluminumDesc": "Все здания, потребляющие Алюминий, используют вместо него Северных оленей (БЕСПЛАТНАЯ ПОЛИТИКА)",
  "SantaClauseIsComing": "Санта Клаус идет",
  "SantaClauseIsComingDesc": "Фабрики Санты-Клауса потребляют Северных оленей и Игрушки, а производят Санта-Клауса, Науку и Культуру. Фабрики Санта-Клауса имеют максимальный модификатор плитки. Фабрики игрушек производят Северных оленей в дополнение к Игрушкам (БЕСПЛАТНАЯ ПОЛИТИКА)",
  "MetaRebranding": "Ребрендинг Корпорации 'Мета'",
  "MetaRebrandingDesc": "Корпорация 'Социальная сеть' переименовывается в Корпорацию 'Мета' и потребляет Интернет, Игры, Супер компьютер, Биткоин и Догикоин",
  "MetaInc": "Корпорация 'Мета'",
  "ImportSave": "Импорт сохранения",
  "ClearMyTrades": "Очистить мои сделки",
  "SaveVersionTooNew": "Ваше сохранение - для версии %{saveVersion}, но версия вашей игры %{gameVersion}. Пожалуйста, сначала обновите свою игру",
  ...
  "CrowdfundingTotalPledgdeValueTooLarge": "Ваша общая залоговая стоимость для финансирования не может превышать вашу текущую рыночную стоимость",
  ...
  "BuildingSourceFallbackDesc": "Как здание должно транспортировать вводные ресурсы, если источник, назначенный вручную, не справляется? Пропустить - не транспортировать; Изъять - транспортировать то, что осталось; Новый - применить автоматический выбор источника для нахождения нового",
  ...
  "BuildingSourceFallbackMarkerDesc": "Источник, назначенный вручную, не имеет достаточного количества ресурсов, активирован резервный вариант",
  ...
  "RandomIslandBonus": "<li>Карта случайная каждый раз, когда вы начинаете</li><li>Размер карты, тип сетки, состав и расположение ресурсов, уникальные бонусы выпадают случайным образом</li><li>Существует 5-минутная задержка - повторная генерация происходит только с минимальной разницей в 5 минут</li>",
  ...
  "AdjacentExplorerDesc": "Исследователь ресурсов производит в 2 раза больше продукции, если он прилегает к добываемому ресурсу (БЕСПЛАТНАЯ ПОЛИТИКА)",
  "FactoryMining": "Добывающая фабрика",
  "FactoryMiningDesc": "Фабрика может добывать ресурс непосредственно из плитки, если она потребляет тот же ресурс (БЕСПЛАТНАЯ ПОЛИТИКА)",
  ...
  "YAxisStartsFromZeroDesc": "На всех графиках вертикальная ось всегда будет начинаться с нуля вместо автоматической настройки",
  ...
  "MultipleSourcesDesc": "Позволяет зданию потенциально транспортировать ресурсы из нескольких источников в течение производственного цикла",
  "Water": "Вода",
  ...
  "FarmlandOfflineFarmingDesc": "Фермы, построенные на естественных водных источниках, продолжают выработку продукции даже когда вы в оффлайне. Подпадают под ограничения на продолжительность оффлайн-заработка, а также под влияние усовершенствований Индустриальных кредитов",
  ...
  "WaterEntityLevelTooHighDesc": "Уровень вашего здания выше, чем уровень соседней гидроплотины. Пожалуйста, повысьте уровень вашей гидроплотины",
  ...
  "ShowSupplyChainDesc": "При выделении здания, вам покажет всю цепочку поставок от всех зданий, расположенных выше и ниже по производству",
  "Cake": "Торт",
  ...
  "StandbyModeDesc": "Симуляция игры будет продолжать работать в фоновом режиме, но графика не будет отображаться. Это должно значительно снизить нагрузку на GPU и умеренно снизить нагрузку на CPU",
  ...
  "Sausage": "Колбаса",
  "Hotdog": "Хотдог",
  "BatchOperationDesc": "Это будет применено к %{number} зданию(-ям). Примерная стоимость составляет $%{cost}. Вы хотите продолжить?",
  "BatchOperationResult": "Результат групповой операции: успешно: %{success}, неудачно: %{fail}, общая стоимость: $%{cost}",
  "StreamingMakeMeDiscoverable": "Сделать меня видимым",
  "StreamingMakeMeDiscoverableDesc": "Позволяет другим игрокам наблюдать за вашим игровым процессом. Соединение является P2P и транслируется только ваш игровой процесс. Доступ к микрофону или веб-камере не предоставляется",
  "StreamAutoApprove": "Публичная трансляция",
  "StreamAutoApproveDesc": "Позволяет игрокам присоединяться к вашему потоку без необходимости одобрения индивидуального запроса",
  ...
  "StreamingPlayerRequested": "%{player} запросил просмотр вашей трансляции, перейдите в центральный офис, чтобы принять или отклонить запрос",
  ...
  "StreamingConnectionFailed": "Не удалось установить соединение - вполне вероятно, что ваша сеть не поддерживает P2P-соединение",
  "Pizza": "Пицца",
  "StreamingStartRecord": "Начать запись",
  "StreamingRecordCamera": "Запись режиссерской версии",
  "StreamingRecordCameraDesc": "Записать 10-секундный сфокусированный фрагмент - камера будет установлена на максимальное приближение и будет медленно отъезжать назад",
  "StreamingStopRecord": "Остановить запись",
  "StreamingRecordingReady": "Запись готова",
  "StreamingRecordingReadyDesc": "Вы можете сохранить файл записи и воспроизвести его с помощью совместимого видеоплеера",
  "StreamingRecordingSave": "Сохранить как...",
  "Lantern": "Фонарик",
  "LunarNewYear22": "Год Тигра",
  "LunarNewYear22Desc": "Все здания, потребляющие бумагу, будут использовать вместо нее фонарь и будут иметь 2x мощность. Бумажные фабрики становятся Бумажной Академией и производят культуру вместо бумаги",
  ...
  "BatteryFuelDesc": "💡 После использования аккумуляторов как топлива, они будут превращаться в корпус аккумулятора. Вы можете построить переработчик аккумуляторов для их переработки или перезарядки",
  ...
  "PathBlocked": "Вы не можете строить на этой плитке, так как она блокирует все возможные пути от червоточин к вашему центральному офису.",
  "WaveInProgressBuildRemoveDisabled": "Вы не можете строить здания на пути или продавать здания, когда идет волна вторжения",
  "ExportSaveForTransfer": "Перенести своё сохранение",
  "ExportSaveForTransferDesc": "Выберите эту опцию, если вы хотите перенести своё сохранение на другое устройство. При этом ваше право на торговлю будет экспортировано в файл сохранения - вы сможете продолжить торговлю после импорта файла сохранения. Ваше текущее устройство не сможет торговать до истечения таймера ожидания",
  "ExportSaveForBackup": "Резервное копия вашего сохранения",
  "ExportSaveForBackupDesc": "Выберите этот вариант, если вы просто хотите сделать резервную копию своего прогресса. При этом ваше право на торговлю останется на текущем устройстве - импорт резервного файла сохранения не восстановит право на торговлю до истечения таймера ожидания",
  "RightToTradeValid": "Есть право на торговлю",
  "RightToTradeInvalid": "Нет права на торговлю",
  "RightToTradeInvalidDesc": "Это происходит потому, что ваше право на торговлю было экспортировано в другой файл сохранения - вам следует импортировать этот файл сохранения, чтобы восстановить право на торговлю. Если вы потеряли этот файл сохранения, вы можете принудительно восстановить право на торговлю на этом сохранении, но на вас будет наложен таймера ожидания, а ваше другое сохранение потеряет право на торговлю.",
  ...
  "PathTemporarilyBlocked": "Вы не можете строить на этой плитке, так как идет волна. Проверьте еще раз после окончания волны",
  ...
  "SteamAutoCloudBackupDescV3": "Ваш последний прогресс сохраняется в Steam Cloud. Игра также создает резервные копии каждые 10 минут - вы можете принудительно создать резервную копию в любое время. Загрузка резервной копии приведет к потере права на торговлю и потребует принудительного восстановления (применится таймер ожидания).",
  ...
  "PanelPositionDescV2": "Показывать боковую панель слева, справа или автоматически (в зависимости от текущей выбранной плитки). Работает только в альбомном режиме",
  ...
  "AllowPortraitModeDesc": "Это позволит включить портретный режим (экспериментальный), экран будет поворачиваться в зависимости от датчика вашего телефона и настроек",
  "IndustryZoneProductivityBoostDesc": "Каждое здание в цепочке или каждый 10 уровень промышленной зоны дает 10% прибавку к производительности зданий в ней - требуется, чтобы все здания в зоне работали",
  "Auckland": "Окленд",
  "AucklandBonus": "<li>Все месторождения находятся в области в форме Новой Зеландии в центре карты</li><li>Уникальное здание: Гидроэлектростанция</li><li>Уникальная политика: Ускоритель для шахты</li><li>Уникальная политика: Электрический рыбный пруд</li><li>Рыбный пруд можно строить на любой плитке</li>",
  "MineBooster": "Ускоритель для шахты",
  "MineBoosterDesc": "Работающая шахта дает 100% прибавку к мощности соседним шахтам или фабрикам, которые потребляют месторождение",
  ...
  "MeatProductionx2Desc": "Птицефермы, свинофермы, коровники, рыбные пруды и кормовые заводы имеют 2x мощности, но потребляют 2x энергии",
  ...
  "ExtraTradeQuotaDesc": "Начальная квота на торговлю игроками составляет 1% от вашего рыночного капитала - это даст дополнительный процент",
  ...
  "ResearchAgreementDesc": "Заполнение каждой сделки с уникальным игроком дает 10 минут производства очков исследования",
  ...
  "AutoSellCapacityMultiplierDescV2": "Это даст дополнительную возможность автоматической продажи свыше существующей ёмкости.",
  "AutoSellCapacity": "Ёмкость автоматической продажи",
  "AutoSellCapacityDescV2": "Максимальное количество ресурсов, которое может обработать автопродажа в секунду, для каждого ресурса, измеряется как процент от общего производства данного ресурса",
  ...
  "ExternalManageYourSaveDesc": "В связи с техническими ограничениями, импорт и экспорт ваших сохранений должен осуществляться с официального сайта игры",
  "MREPlant": "Завод блюд, готовых к употреблению",
  "PlayerTradeTaxCreditProduction": "Налоговый кредит: Производство",
  "PlayerTradeTaxCreditProductionDescV2": "Этот налоговый кредит основан на количестве %{res}, которое вы произвели с момента последнего обновления рынка. Вы произвели %{produced} и торговали %{used}",
  "PlayerTradeTaxCreditMarketCap": "Налоговый кредит: Рыночная кпитализация",
  "PlayerTradeTaxCreditMarketCapDesc": "Этот налоговый кредит %{percentage} от вашей рыночной капитализации, может быть улучшен через Усиление/Улучшение за кредиты. Общая сумма кредита составляет %{total} и вы использовали %{used}",
  ...
  "PlayerTradeTaxRateDesc": "Налоговая ставка основана на разнице цен между вашей местной ценой и данной торговой ценой - налоговая ставка является прогрессивной. 0% ~ 50%: 0.5% за каждый 1% разницы; 50% ~ 75%: 1% за каждый 1% разницы; 75% ~ 100%: 2% за каждый 1% разницы",
