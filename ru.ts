export const RU = {
    ...
    SteamAutoCloudBackupDesc:
        "Игра автоматически сохраняется на Вашем компьютере. Сохранения синхронизируется с облаком Steam каждые 10 минут. Вы можете вручную сохраниться в облаке Steam в любое время.",
