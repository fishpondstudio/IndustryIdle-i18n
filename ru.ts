export const RU = {
    ...
    OperatingSystemCompany: "Корпорация 'Операционная Система'",
    ...
    SanJose: "San Jose",
    SanJoseBonus:
        "<li>Unique building: Производитель Микросхем</li><li>Уникальное здание: FaceApp Inc</li><li>Уникальное здание: Майнер Биткоинов</li><li>Все здания, потребляющие кремний, имеют максимальный модификатор плитки</li><li>Солнечные панель генерируют 2x энергии</li><li>Кремнивые шахты имеют 2x производительности</li>",
    RotterdamBonusV2:
    ...
    PlayerTradeQuotaDescV2:
        "💡 Квота - это количество ресурса, которым вы можете торговать. Денежная стоимость равна %{percent} от вашего рыночного капитала и обнуляется при обновлении рынка. Чем больше цена вашей сделки отклоняется от цены в торговом центре, тем больше квоты вам нужно",
    ...
    PolicyPointNoCopperDesc:
        "💡 На этой карте нет месторождений меди, вы можете активировать политику Переработка Аллюминия, чтобы разблокировать дополнительные технологии",
    Pumpkin: "Тыквы",
