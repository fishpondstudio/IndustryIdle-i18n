export const RU = {
    ...
    IronSteelZone: "Сталелитейная зона",
    IronSteelZoneDesc:
        "Ресурсный усилитель обеспечивает бонус в %{percent} к производительности соседних сталелитейных заводов или заводов нержавеющей стали за каждую работающую железную шахту, которую он усиливает",
