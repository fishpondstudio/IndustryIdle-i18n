export const RU = {
  ...
  AlSemiconductorDesc:
    "Заводы интегральных микросхем используют алюминий вместо меди",
  ...
  SolarPanelAlwaysWorkDesc:
    "Солнечные панели работают 100% времени, но производят на 60% меньше энергии",
  ...
  AdjacentBonusSquareDesc:
    "Смежный бонус на 50% эффективнее, но модификаторы плитки изменяются от -15% до +15%",
  ...
  CornSyrupDesc:
    "Сахарные заводы производят рафинированный сахар из кукурузы вместо сахарного тростника",
  Crop: "Культура",
  SaoPaulo: "Сан-Паулу",
