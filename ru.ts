export const RU = {
  ...
  SolarPanelDesc:
    "💡 Солнечные панели работают только 5 секунд из каждых 10 секунд - все циклы синхронизированы",
  WindTurbineDesc:
    "💡 Ветрогенераторы работают только 8 секунд из каждых 10 секунд - циклы не синхронизированы",
  Movie: "Фильм",
  ...
  AlSemiconductorDesc: "Завод интегральных микросхем используют алюминий вместо меди",
  ...
  CancelActiveTradeFirst:
    "У вас есть активные сделки с игроками, пожалуйста, сначала отмените/завершите их",
  ...
  PlayerTradeToClaim:
    "У Вас есть %{num} новая(ые) сделка(и), которую(ые) вы можете завершить в торговле с игроками",
  ...
  AcceptTradeFailRateLimit:
    "Вы можете совершить только одну сделку каждые %{time} секунд",
  ...
  ResourceBoosterPercentageV2:
    "💡 В эту сумму включено %{percent} прибавки от соседних Ускорителей ресурсов",
  ...
  SwissUpgradeDesc:
    "Улучшение за кредиты сохраняются и переносятся, если вы начинаете в новом городе",
  SwissBoost: "Усиление за кредиты",
  SwissBoostDesc:
    "Усиление за кредиты действуют только в текущем городе и обнуляются при старте в новом городе",
  ProductionMultipliers: "Производственные множители",
  MultiplierMapUniqueBonus: "Уникальный бонус карты",
  MultiplierSwissUpgrade:
    "Улучшение за кредиты (Постоянно)",
  ...
  RandomIslandBonusResources:
    "Месторождения на этой карте: %{deposits}",
  ...
  FarmlandProductionDesc:
    "💡 Фермы работают только 5 секунд из каждых 10 секунд - все циклы синхронизированы",
