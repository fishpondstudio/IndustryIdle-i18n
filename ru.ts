export const RU = {
    ...
    PowerBank: "Аккумуляторная Батарея",
    ...
    PowerBankMoreCapacityDesc: "Аккумуляторная Батарея заряжается на 50% медленнее, но имеет на 50% большую емкость",
    PowerBankNotWorking: "⛔ Аккумуляторная Батарея работает только рядом с электростанцией",
    ...
    SanJose: "Сан-Хосе",
    SanJoseBonus:
        "<li>Unique building: Производитель Микросхем</li><li>Уникальное здание: Корпорация FaceApp</li><li>Уникальное здание: Майнер Биткоинов</li><li>Все здания, потребляющие кремний, имеют максимальный модификатор плитки</li><li>Солнечные панель генерируют 2x энергии</li><li>Кремнивые шахты имеют 2x производительности</li>",
    RotterdamBonusV2:
