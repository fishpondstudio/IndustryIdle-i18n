export const RU = {
  ...
  "AlwaysTransportInputTradeCenterDesc": "Всегда перевозить ресурсы в Торговый центр, даже если для этого ресурса не включена автопродажа",
  ...
  "InterestRateDesc": "Проценты, которые вы зарабатываете на своей рыночной капитализации, пока вы находитесь в оффлайне",
  ...
  "NotEnoughBuildingPermit": "Недостаточно разрешений на строительство. Пожалуйста, купите больше для строительства новых зданий",
  ...
  "AllowZoomDesc": "Включите поддержку масштабирования. Используйте колесо мыши, чтобы увеличить масштаб. Текущий масштаб %{zoom}",
  "AllowZoomMobileDesc": "Включите поддержку масштабирования. Вы можете нажать, чтобы увеличить масштаб. Текущий масштаб %{zoom}",
  "Settings": "Настройки",
  ...
  "FuelCostSaveDesc": "Склады экономят определенный процент топлива для перевозки входных ресурсов по сравнению с другими зданиями, чем выше уровень, тем больше экономия",
  ...
  "TurnOnAllProductionsDesc": "Включить производство во всех зданиях, нельзя использовать при активной политике Экономия затрат",
  ...
  "StickyInputDesc": "Здания предпочтут осуществлять перевозки из предыдущего источника, вместо того чтобы каждый цикл искать лучший источник (БЕСПЛАТНАЯ ПОЛИТИКА)",
  ...
  "AdjacentBonusOnlyOutputDesc": "Бонус соседства не требует большего ввода, но использует больше энергии и эффективен только на 50%",
  ...
  "ShoppingSpreeDesc": "Если ресурса не хватает, автоматически покупается недостающее количество в Торговом центре (если включена автоматическая продажа такого ресурса, она будет проигнорирована).",
  ...
  "RestoreFromBackupFail": "Не удалось восстановить резервную копию из облака Steam: ты уверен, что резервная копия существует?",
  ...
  "FuelRunOutWarning": "💡 Потребление топлива превышает его производство. Когда топливо закончится, ваши перевозки приостановятся.",
  ...
  "AutoSellCapacityMultiplierDesc": "Множитель, который применяется к вашему количеству автопродаж, независимо от текущего количества автопродаж",
  ...
  "CheatDetected": "Ваше старое сохранение не прошло проверку сервера и не может быть прочитано. Вы начнете с нового сохранения",
  ...
  "Hamburg": "Гамбург",
  "HamburgBonus": "<li>Завод дирижаблей разблокирован</li><li>Полупроводниковые заводы имеют производительность 2Х</li><li>Верфи имеют мощность 2Х</li><li>Автомобильные заводы имеют мощность 2Х</li><li>Фабрика литий-ионных аккумуляторов разблокирована</li>",
  "Toulouse": "Тулуза",
  "Rome": "Рим",
  ...
  "AddTradeExceedMaximumTrade": "У вас может быть максимум %{number} активных сделок, пожалуйста, сперва запросите или отмените одну из них",
  ...
  "WarehouseOutwardFuelSaveDesc": "Склады обеспечивают такую же экономию топлива и при перевозке в обратном направлении",
  "ImportSaveVersionTooNew": "Вы импортируете сохранение с %{saveVersion}, но ваша игра имеет версию %{gameVersion}. Пожалуйста, сначала обновите игру",
  ...
  "CancelTradeConfirmDialogDescV2": "Отмена этой сделки вернет %{percent} ресурсов/денег. Ресурсы будут возвращены на склад Торгового центра",
  ...
  "AchievementSoftwareGiantDesc": "Постройте на одной карте Компанию 'Программное обеспечение' 10 уровня, Компанию 'Операционная система' 10 уровня, Компанию 'База данных' 10 уровня и Веб-браузер 10 уровня",
  ...
  "PlayerTradeNowAllowedV2": "Торговля между игроками недоступна в течение %{hour} часов после восстановления/импорта сохранения",
  ...
  "SteamAutoCloudBackupDescV2": "Ваш последний прогресс сохраняется в облаке Steam и синхронизируется на всех устройствах. Игра также автоматически создает резервные копии ваших сохранений в облаке Steam каждые 10 минут. Вы можете принудительно создать резервную копию в любое время",
  ...
  "ResourceBoosterSquareDesc": "Ресурсные усилители дают на 25% больше усиления, но их научные затраты и потребление энергии также увеличиваются на 25%",
  ...
  "ResourceBoosterSupplyChainDesc": "Ресурсные усилители используют 2Х энергии и науки, но за каждую работающую шахту, которую усиливает ресурсный усилитель, он также дает прирост мощности соседним фабрикам, которые потребляют продукцию шахты (фабрика должна потреблять только месторождения)",
  ...
  "ResourceExplorer2DescV2": "Исследователи ресурсов производят в 2 раза больше продукции, но потребляют в 2 раза больше энергии. Исследователи ресурсов могут быть усилены усилителями ресурсов, если активна политика Усилитель цепочки поставок и у усилителя есть соседняя шахта с такой же производительностью",
  ...
  "WholesaleCenterProducingOnlyDesc": "Заказы оптового центра содержат только те ресурсы, которые производятся в данный момент (вам также необходимо производить необходимое количество ресурсов, чтобы разблокировать Центр оптовых продаж)",
  ...
  "IndustryZoneNotWorkingDesc": "Все соседние здания должны образовывать цепочку поставок и не являться частью других промышленных зон",
  ...
  "PlayerTradeQuotaDescV2": "💡 Квота - это количество ресурса, которым вы можете торговать. Денежная стоимость равна %{percent} от вашего рыночного капитала и обнуляется при обновлении рынка. Чем больше цена вашей сделки отклоняется от цены в торговом центре, тем больше квота",
