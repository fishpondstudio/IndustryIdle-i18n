export const PL = {
  ...
  FactoryMiningBanner:
    "Ten budynek jest górniczy %{resource} bezpośrednio z tego kafelka",
  ...
  FarmlandProductionDesc:
    "💡 Pola uprawne działają tylko 5 sekund na każde 10 sekund - wszystkie cykle są wyrównane",
  ...
  OfflineProductionDesc:
    "Transport kondensatorów do tego budynku pozwoli mu działać, gdy jesteś offline",
  Moderator: "Moderator",
  FlourMill: "Młyn",
  Flour: "Mąka",
