export const PL = {
  ...
  "AlwaysTransportInputTradeCenterDesc": "Zawsze transportuj surowce do Rynku, nawet jeżeli autosprzedaż nie jest katywna dla danego surowca",
  ...
  "FuelCostSaveDesc": "Magazyny oszczędzają pewien procent paliwa na transport surowców do wewnątrz w porównaniu do innych budynków, im wyższy poziom, tym więcej oszczędności",
  ...
  "StickyInputDesc": "Buildings will prefer to transport from previous source, instead of searching for the best source every cycle (FREE POLICY)",
  ...
  "PlayerTradeBid": "Bid",
  "PlayerTradeAsk": "Ask",
  "CancelTradeConfirmDialogDescV2": "Cancelling this trade will refund %{percent} of the resource/cash. Resources will be refunded to the Trade Center warehouse",
